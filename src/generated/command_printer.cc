...
void CommandPrinter::PrintBeginCommandBufferArgs(std::ostream &os, const BeginCommandBufferArgs &args) {
    {
...
void CommandPrinter::PrintEndCommandBufferArgs(std::ostream &os, const EndCommandBufferArgs &args) {
    {
        os << "- # parameter:" << std::endl;
        ScopedOstream sop(os);
        os << "name:  commandBuffer" << std::endl;
...
void CommandPrinter::PrintResetCommandBufferArgs(std::ostream &os, const ResetCommandBufferArgs &args) {
    {
        os << "- # parameter:" << std::endl;
        ScopedOstream sop(os);
        os << "name:  commandBuffer" << std::endl;
...
void CommandPrinter::PrintCmdBindPipelineArgs(std::ostream &os, const CmdBindPipelineArgs &args) {
    {
        os << "- # parameter:" << std::endl;
        ScopedOstream sop(os);
        os << "name:  commandBuffer" << std::endl;
...
void CommandPrinter::PrintCmdSetViewportArgs(std::ostream &os, const CmdSetViewportArgs &args) {
    {
        os << "- # parameter:" << std::endl;
        ScopedOstream sop(os);
        os << "name:  commandBuffer" << std::endl;
...
void CommandPrinter::PrintCmdSetScissorArgs(std::ostream &os, const CmdSetScissorArgs &args) {
    {
        os << "- # parameter:" << std::endl;
        ScopedOstream sop(os);
        os << "name:  commandBuffer" << std::endl;
...
void CommandPrinter::PrintCmdSetLineWidthArgs(std::ostream &os, const CmdSetLineWidthArgs &args) {
    {
        os << "- # parameter:" << std::endl;
        ScopedOstream sop(os);
        os << "name:  commandBuffer" << std::endl;
...
void CommandPrinter::PrintCmdSetDepthBiasArgs(std::ostream &os, const CmdSetDepthBiasArgs &args) {
    {
        os << "- # parameter:" << std::endl;
        ScopedOstream sop(os);
        os << "name:  commandBuffer" << std::endl;
...
void CommandPrinter::PrintCmdSetBlendConstantsArgs(std::ostream &os, const CmdSetBlendConstantsArgs &args) {
    {
        os << "- # parameter:" << std::endl;
        ScopedOstream sop(os);
        os << "name:  commandBuffer" << std::endl;
...
void CommandPrinter::PrintCmdSetDepthBoundsArgs(std::ostream &os, const CmdSetDepthBoundsArgs &args) {
    {
        os << "- # parameter:" << std::endl;
        ScopedOstream sop(os);
        os << "name:  commandBuffer" << std::endl;
...
void CommandPrinter::PrintCmdSetStencilCompareMaskArgs(std::ostream &os, const CmdSetStencilCompareMaskArgs &args) {
    {
        os << "- # parameter:" << std::endl;
        ScopedOstream sop(os);
        os << "name:  commandBuffer" << std::endl;
...
void CommandPrinter::PrintCmdSetStencilWriteMaskArgs(std::ostream &os, const CmdSetStencilWriteMaskArgs &args) {
    {
        os << "- # parameter:" << std::endl;
        ScopedOstream sop(os);
        os << "name:  commandBuffer" << std::endl;
...
void CommandPrinter::PrintCmdSetStencilReferenceArgs(std::ostream &os, const CmdSetStencilReferenceArgs &args) {
    {
        os << "- # parameter:" << std::endl;
        ScopedOstream sop(os);
        os << "name:  commandBuffer" << std::endl;
...
void CommandPrinter::PrintCmdBindDescriptorSetsArgs(std::ostream &os, const CmdBindDescriptorSetsArgs &args) {
    {
        os << "- # parameter:" << std::endl;
        ScopedOstream sop(os);
        os << "name:  commandBuffer" << std::endl;
...
void CommandPrinter::PrintCmdBindIndexBufferArgs(std::ostream &os, const CmdBindIndexBufferArgs &args) {
    {
        os << "- # parameter:" << std::endl;
        ScopedOstream sop(os);
        os << "name:  commandBuffer" << std::endl;
...
void CommandPrinter::PrintCmdBindVertexBuffersArgs(std::ostream &os, const CmdBindVertexBuffersArgs &args) {
    {
        os << "- # parameter:" << std::endl;
        ScopedOstream sop(os);
        os << "name:  commandBuffer" << std::endl;
...
void CommandPrinter::PrintCmdDrawArgs(std::ostream &os, const CmdDrawArgs &args) {
    {
        os << "- # parameter:" << std::endl;
        ScopedOstream sop(os);
        os << "name:  commandBuffer" << std::endl;
...
void CommandPrinter::PrintCmdDrawIndexedArgs(std::ostream &os, const CmdDrawIndexedArgs &args) {
    {
        os << "- # parameter:" << std::endl;
        ScopedOstream sop(os);
        os << "name:  commandBuffer" << std::endl;
...
void CommandPrinter::PrintCmdDrawIndirectArgs(std::ostream &os, const CmdDrawIndirectArgs &args) {
    {
        os << "- # parameter:" << std::endl;
        ScopedOstream sop(os);
        os << "name:  commandBuffer" << std::endl;
...
void CommandPrinter::PrintCmdDrawIndexedIndirectArgs(std::ostream &os, const CmdDrawIndexedIndirectArgs &args) {
    {
        os << "- # parameter:" << std::endl;
        ScopedOstream sop(os);
        os << "name:  commandBuffer" << std::endl;
...
void CommandPrinter::PrintCmdDispatchArgs(std::ostream &os, const CmdDispatchArgs &args) {
    {
        os << "- # parameter:" << std::endl;
        ScopedOstream sop(os);
        os << "name:  commandBuffer" << std::endl;
...
void CommandPrinter::PrintCmdDispatchIndirectArgs(std::ostream &os, const CmdDispatchIndirectArgs &args) {
    {
        os << "- # parameter:" << std::endl;
        ScopedOstream sop(os);
        os << "name:  commandBuffer" << std::endl;
...
void CommandPrinter::PrintCmdCopyBufferArgs(std::ostream &os, const CmdCopyBufferArgs &args) {
    {
        os << "- # parameter:" << std::endl;
        ScopedOstream sop(os);
        os << "name:  commandBuffer" << std::endl;
...
void CommandPrinter::PrintCmdCopyImageArgs(std::ostream &os, const CmdCopyImageArgs &args) {
    {
        os << "- # parameter:" << std::endl;
        ScopedOstream sop(os);
        os << "name:  commandBuffer" << std::endl;
...
void CommandPrinter::PrintCmdBlitImageArgs(std::ostream &os, const CmdBlitImageArgs &args) {
    {
        os << "- # parameter:" << std::endl;
        ScopedOstream sop(os);
        os << "name:  commandBuffer" << std::endl;
...
void CommandPrinter::PrintCmdCopyBufferToImageArgs(std::ostream &os, const CmdCopyBufferToImageArgs &args) {
    {
        os << "- # parameter:" << std::endl;
        ScopedOstream sop(os);
        os << "name:  commandBuffer" << std::endl;
...
void CommandPrinter::PrintCmdCopyImageToBufferArgs(std::ostream &os, const CmdCopyImageToBufferArgs &args) {
    {
        os << "- # parameter:" << std::endl;
        ScopedOstream sop(os);
        os << "name:  commandBuffer" << std::endl;
...
void CommandPrinter::PrintCmdUpdateBufferArgs(std::ostream &os, const CmdUpdateBufferArgs &args) {
    {
        os << "- # parameter:" << std::endl;
        ScopedOstream sop(os);
        os << "name:  commandBuffer" << std::endl;
...
void CommandPrinter::PrintCmdFillBufferArgs(std::ostream &os, const CmdFillBufferArgs &args) {
    {
        os << "- # parameter:" << std::endl;
        ScopedOstream sop(os);
        os << "name:  commandBuffer" << std::endl;
...
void CommandPrinter::PrintCmdClearColorImageArgs(std::ostream &os, const CmdClearColorImageArgs &args) {
    {
        os << "- # parameter:" << std::endl;
        ScopedOstream sop(os);
        os << "name:  commandBuffer" << std::endl;
...
void CommandPrinter::PrintCmdClearDepthStencilImageArgs(std::ostream &os, const CmdClearDepthStencilImageArgs &args) {
    {
        os << "- # parameter:" << std::endl;
        ScopedOstream sop(os);
        os << "name:  commandBuffer" << std::endl;
...
void CommandPrinter::PrintCmdClearAttachmentsArgs(std::ostream &os, const CmdClearAttachmentsArgs &args) {
    {
        os << "- # parameter:" << std::endl;
        ScopedOstream sop(os);
        os << "name:  commandBuffer" << std::endl;
...
void CommandPrinter::PrintCmdResolveImageArgs(std::ostream &os, const CmdResolveImageArgs &args) {
    {
        os << "- # parameter:" << std::endl;
        ScopedOstream sop(os);
        os << "name:  commandBuffer" << std::endl;
...
void CommandPrinter::PrintCmdSetEventArgs(std::ostream &os, const CmdSetEventArgs &args) {
    {
        os << "- # parameter:" << std::endl;
        ScopedOstream sop(os);
        os << "name:  commandBuffer" << std::endl;
...
void CommandPrinter::PrintCmdResetEventArgs(std::ostream &os, const CmdResetEventArgs &args) {
    {
        os << "- # parameter:" << std::endl;
        ScopedOstream sop(os);
        os << "name:  commandBuffer" << std::endl;
...
void CommandPrinter::PrintCmdWaitEventsArgs(std::ostream &os, const CmdWaitEventsArgs &args) {
    {
        os << "- # parameter:" << std::endl;
        ScopedOstream sop(os);
        os << "name:  commandBuffer" << std::endl;
...
void CommandPrinter::PrintCmdPipelineBarrierArgs(std::ostream &os, const CmdPipelineBarrierArgs &args) {
    {
        os << "- # parameter:" << std::endl;
        ScopedOstream sop(os);
        os << "name:  commandBuffer" << std::endl;
...
void CommandPrinter::PrintCmdBeginQueryArgs(std::ostream &os, const CmdBeginQueryArgs &args) {
    {
        os << "- # parameter:" << std::endl;
        ScopedOstream sop(os);
        os << "name:  commandBuffer" << std::endl;
...
void CommandPrinter::PrintCmdEndQueryArgs(std::ostream &os, const CmdEndQueryArgs &args) {
    {
        os << "- # parameter:" << std::endl;
        ScopedOstream sop(os);
        os << "name:  commandBuffer" << std::endl;
...
void CommandPrinter::PrintCmdResetQueryPoolArgs(std::ostream &os, const CmdResetQueryPoolArgs &args) {
    {
        os << "- # parameter:" << std::endl;
        ScopedOstream sop(os);
        os << "name:  commandBuffer" << std::endl;
...
void CommandPrinter::PrintCmdWriteTimestampArgs(std::ostream &os, const CmdWriteTimestampArgs &args) {
    {
        os << "- # parameter:" << std::endl;
        ScopedOstream sop(os);
        os << "name:  commandBuffer" << std::endl;
...
void CommandPrinter::PrintCmdCopyQueryPoolResultsArgs(std::ostream &os, const CmdCopyQueryPoolResultsArgs &args) {
    {
        os << "- # parameter:" << std::endl;
        ScopedOstream sop(os);
        os << "name:  commandBuffer" << std::endl;
...
void CommandPrinter::PrintCmdPushConstantsArgs(std::ostream &os, const CmdPushConstantsArgs &args) {
    {
        os << "- # parameter:" << std::endl;
        ScopedOstream sop(os);
        os << "name:  commandBuffer" << std::endl;
...
void CommandPrinter::PrintCmdBeginRenderPassArgs(std::ostream &os, const CmdBeginRenderPassArgs &args) {
    {
        os << "- # parameter:" << std::endl;
        ScopedOstream sop(os);
        os << "name:  commandBuffer" << std::endl;
...
void CommandPrinter::PrintCmdNextSubpassArgs(std::ostream &os, const CmdNextSubpassArgs &args) {
    {
        os << "- # parameter:" << std::endl;
        ScopedOstream sop(os);
        os << "name:  commandBuffer" << std::endl;
...
void CommandPrinter::PrintCmdEndRenderPassArgs(std::ostream &os, const CmdEndRenderPassArgs &args) {
    {
        os << "- # parameter:" << std::endl;
        ScopedOstream sop(os);
        os << "name:  commandBuffer" << std::endl;
...
void CommandPrinter::PrintCmdExecuteCommandsArgs(std::ostream &os, const CmdExecuteCommandsArgs &args) {
    {
        os << "- # parameter:" << std::endl;
        ScopedOstream sop(os);
        os << "name:  commandBuffer" << std::endl;
...
void CommandPrinter::PrintCmdSetDeviceMaskArgs(std::ostream &os, const CmdSetDeviceMaskArgs &args) {
    {
        os << "- # parameter:" << std::endl;
        ScopedOstream sop(os);
        os << "name:  commandBuffer" << std::endl;
...
void CommandPrinter::PrintCmdDispatchBaseArgs(std::ostream &os, const CmdDispatchBaseArgs &args) {
    {
        os << "- # parameter:" << std::endl;
        ScopedOstream sop(os);
        os << "name:  commandBuffer" << std::endl;
...
void CommandPrinter::PrintCmdDrawIndirectCountArgs(std::ostream &os, const CmdDrawIndirectCountArgs &args) {
    {
        os << "- # parameter:" << std::endl;
        ScopedOstream sop(os);
        os << "name:  commandBuffer" << std::endl;
...
void CommandPrinter::PrintCmdDrawIndexedIndirectCountArgs(std::ostream &os,
...
void CommandPrinter::PrintCmdBeginRenderPass2Args(std::ostream &os, const CmdBeginRenderPass2Args &args) {
    {
        os << "- # parameter:" << std::endl;
        ScopedOstream sop(os);
        os << "name:  commandBuffer" << std::endl;
...
void CommandPrinter::PrintCmdNextSubpass2Args(std::ostream &os, const CmdNextSubpass2Args &args) {
    {
        os << "- # parameter:" << std::endl;
        ScopedOstream sop(os);
        os << "name:  commandBuffer" << std::endl;
...
void CommandPrinter::PrintCmdEndRenderPass2Args(std::ostream &os, const CmdEndRenderPass2Args &args) {
    {
        os << "- # parameter:" << std::endl;
        ScopedOstream sop(os);
        os << "name:  commandBuffer" << std::endl;
...
void CommandPrinter::PrintCmdSetEvent2Args(std::ostream &os, const CmdSetEvent2Args &args) {
    {
        os << "- # parameter:" << std::endl;
        ScopedOstream sop(os);
        os << "name:  commandBuffer" << std::endl;
...
void CommandPrinter::PrintCmdResetEvent2Args(std::ostream &os, const CmdResetEvent2Args &args) {
    {
        os << "- # parameter:" << std::endl;
        ScopedOstream sop(os);
        os << "name:  commandBuffer" << std::endl;
...
void CommandPrinter::PrintCmdWaitEvents2Args(std::ostream &os, const CmdWaitEvents2Args &args) {
    {
        os << "- # parameter:" << std::endl;
        ScopedOstream sop(os);
        os << "name:  commandBuffer" << std::endl;
...
void CommandPrinter::PrintCmdPipelineBarrier2Args(std::ostream &os, const CmdPipelineBarrier2Args &args) {
    {
        os << "- # parameter:" << std::endl;
        ScopedOstream sop(os);
        os << "name:  commandBuffer" << std::endl;
...
void CommandPrinter::PrintCmdWriteTimestamp2Args(std::ostream &os, const CmdWriteTimestamp2Args &args) {
    {
        os << "- # parameter:" << std::endl;
        ScopedOstream sop(os);
        os << "name:  commandBuffer" << std::endl;
...
void CommandPrinter::PrintCmdCopyBuffer2Args(std::ostream &os, const CmdCopyBuffer2Args &args) {
    {
        os << "- # parameter:" << std::endl;
        ScopedOstream sop(os);
        os << "name:  commandBuffer" << std::endl;
...
void CommandPrinter::PrintCmdCopyImage2Args(std::ostream &os, const CmdCopyImage2Args &args) {
    {
        os << "- # parameter:" << std::endl;
        ScopedOstream sop(os);
        os << "name:  commandBuffer" << std::endl;
...
void CommandPrinter::PrintCmdCopyBufferToImage2Args(std::ostream &os, const CmdCopyBufferToImage2Args &args) {
    {
        os << "- # parameter:" << std::endl;
        ScopedOstream sop(os);
        os << "name:  commandBuffer" << std::endl;
...
void CommandPrinter::PrintCmdCopyImageToBuffer2Args(std::ostream &os, const CmdCopyImageToBuffer2Args &args) {
    {
        os << "- # parameter:" << std::endl;
        ScopedOstream sop(os);
        os << "name:  commandBuffer" << std::endl;
...
void CommandPrinter::PrintCmdBlitImage2Args(std::ostream &os, const CmdBlitImage2Args &args) {
    {
        os << "- # parameter:" << std::endl;
        ScopedOstream sop(os);
        os << "name:  commandBuffer" << std::endl;
...
void CommandPrinter::PrintCmdResolveImage2Args(std::ostream &os, const CmdResolveImage2Args &args) {
    {
        os << "- # parameter:" << std::endl;
        ScopedOstream sop(os);
        os << "name:  commandBuffer" << std::endl;
...
void CommandPrinter::PrintCmdBeginRenderingArgs(std::ostream &os, const CmdBeginRenderingArgs &args) {
    {
        os << "- # parameter:" << std::endl;
        ScopedOstream sop(os);
        os << "name:  commandBuffer" << std::endl;
...
void CommandPrinter::PrintCmdEndRenderingArgs(std::ostream &os, const CmdEndRenderingArgs &args) {
    {
        os << "- # parameter:" << std::endl;
        ScopedOstream sop(os);
        os << "name:  commandBuffer" << std::endl;
...
void CommandPrinter::PrintCmdSetCullModeArgs(std::ostream &os, const CmdSetCullModeArgs &args) {
    {
        os << "- # parameter:" << std::endl;
        ScopedOstream sop(os);
        os << "name:  commandBuffer" << std::endl;
...
void CommandPrinter::PrintCmdSetFrontFaceArgs(std::ostream &os, const CmdSetFrontFaceArgs &args) {
    {
        os << "- # parameter:" << std::endl;
        ScopedOstream sop(os);
        os << "name:  commandBuffer" << std::endl;
...
void CommandPrinter::PrintCmdSetPrimitiveTopologyArgs(std::ostream &os, const CmdSetPrimitiveTopologyArgs &args) {
    {
        os << "- # parameter:" << std::endl;
        ScopedOstream sop(os);
        os << "name:  commandBuffer" << std::endl;
...
void CommandPrinter::PrintCmdSetViewportWithCountArgs(std::ostream &os, const CmdSetViewportWithCountArgs &args) {
    {
        os << "- # parameter:" << std::endl;
        ScopedOstream sop(os);
        os << "name:  commandBuffer" << std::endl;
...
void CommandPrinter::PrintCmdSetScissorWithCountArgs(std::ostream &os, const CmdSetScissorWithCountArgs &args) {
    {
        os << "- # parameter:" << std::endl;
        ScopedOstream sop(os);
        os << "name:  commandBuffer" << std::endl;
...
void CommandPrinter::PrintCmdBindVertexBuffers2Args(std::ostream &os, const CmdBindVertexBuffers2Args &args) {
    {
        os << "- # parameter:" << std::endl;
        ScopedOstream sop(os);
        os << "name:  commandBuffer" << std::endl;
...
void CommandPrinter::PrintCmdSetDepthTestEnableArgs(std::ostream &os, const CmdSetDepthTestEnableArgs &args) {
    {
        os << "- # parameter:" << std::endl;
        ScopedOstream sop(os);
        os << "name:  commandBuffer" << std::endl;
...
void CommandPrinter::PrintCmdSetDepthWriteEnableArgs(std::ostream &os, const CmdSetDepthWriteEnableArgs &args) {
    {
        os << "- # parameter:" << std::endl;
        ScopedOstream sop(os);
        os << "name:  commandBuffer" << std::endl;
...
void CommandPrinter::PrintCmdSetDepthCompareOpArgs(std::ostream &os, const CmdSetDepthCompareOpArgs &args) {
    {
        os << "- # parameter:" << std::endl;
        ScopedOstream sop(os);
        os << "name:  commandBuffer" << std::endl;
...
void CommandPrinter::PrintCmdSetDepthBoundsTestEnableArgs(std::ostream &os,
...
void CommandPrinter::PrintCmdSetStencilTestEnableArgs(std::ostream &os, const CmdSetStencilTestEnableArgs &args) {
    {
        os << "- # parameter:" << std::endl;
        ScopedOstream sop(os);
        os << "name:  commandBuffer" << std::endl;
...
void CommandPrinter::PrintCmdSetStencilOpArgs(std::ostream &os, const CmdSetStencilOpArgs &args) {
    {
        os << "- # parameter:" << std::endl;
        ScopedOstream sop(os);
        os << "name:  commandBuffer" << std::endl;
...
void CommandPrinter::PrintCmdSetRasterizerDiscardEnableArgs(std::ostream &os,
...
void CommandPrinter::PrintCmdSetDepthBiasEnableArgs(std::ostream &os, const CmdSetDepthBiasEnableArgs &args) {
    {
        os << "- # parameter:" << std::endl;
        ScopedOstream sop(os);
        os << "name:  commandBuffer" << std::endl;
...
void CommandPrinter::PrintCmdSetPrimitiveRestartEnableArgs(std::ostream &os,
...
void CommandPrinter::PrintCmdBeginVideoCodingKHRArgs(std::ostream &os, const CmdBeginVideoCodingKHRArgs &args) {
    {
        os << "- # parameter:" << std::endl;
        ScopedOstream sop(os);
        os << "name:  commandBuffer" << std::endl;
...
void CommandPrinter::PrintCmdEndVideoCodingKHRArgs(std::ostream &os, const CmdEndVideoCodingKHRArgs &args) {
    {
        os << "- # parameter:" << std::endl;
        ScopedOstream sop(os);
        os << "name:  commandBuffer" << std::endl;
...
void CommandPrinter::PrintCmdControlVideoCodingKHRArgs(std::ostream &os, const CmdControlVideoCodingKHRArgs &args) {
    {
        os << "- # parameter:" << std::endl;
        ScopedOstream sop(os);
        os << "name:  commandBuffer" << std::endl;
...
void CommandPrinter::PrintCmdDecodeVideoKHRArgs(std::ostream &os, const CmdDecodeVideoKHRArgs &args) {
    {
        os << "- # parameter:" << std::endl;
        ScopedOstream sop(os);
        os << "name:  commandBuffer" << std::endl;
...
void CommandPrinter::PrintCmdBeginRenderingKHRArgs(std::ostream &os, const CmdBeginRenderingKHRArgs &args) {
    {
        os << "- # parameter:" << std::endl;
        ScopedOstream sop(os);
        os << "name:  commandBuffer" << std::endl;
...
void CommandPrinter::PrintCmdEndRenderingKHRArgs(std::ostream &os, const CmdEndRenderingKHRArgs &args) {
    {
        os << "- # parameter:" << std::endl;
        ScopedOstream sop(os);
        os << "name:  commandBuffer" << std::endl;
...
void CommandPrinter::PrintCmdSetDeviceMaskKHRArgs(std::ostream &os, const CmdSetDeviceMaskKHRArgs &args) {
    {
        os << "- # parameter:" << std::endl;
        ScopedOstream sop(os);
        os << "name:  commandBuffer" << std::endl;
...
void CommandPrinter::PrintCmdDispatchBaseKHRArgs(std::ostream &os, const CmdDispatchBaseKHRArgs &args) {
    {
        os << "- # parameter:" << std::endl;
        ScopedOstream sop(os);
        os << "name:  commandBuffer" << std::endl;
...
void CommandPrinter::PrintCmdPushDescriptorSetKHRArgs(std::ostream &os, const CmdPushDescriptorSetKHRArgs &args) {
    {
        os << "- # parameter:" << std::endl;
        ScopedOstream sop(os);
        os << "name:  commandBuffer" << std::endl;
...
void CommandPrinter::PrintCmdPushDescriptorSetWithTemplateKHRArgs(std::ostream &os,
...
void CommandPrinter::PrintCmdBeginRenderPass2KHRArgs(std::ostream &os, const CmdBeginRenderPass2KHRArgs &args) {
    {
        os << "- # parameter:" << std::endl;
        ScopedOstream sop(os);
        os << "name:  commandBuffer" << std::endl;
...
void CommandPrinter::PrintCmdNextSubpass2KHRArgs(std::ostream &os, const CmdNextSubpass2KHRArgs &args) {
    {
        os << "- # parameter:" << std::endl;
        ScopedOstream sop(os);
        os << "name:  commandBuffer" << std::endl;
...
void CommandPrinter::PrintCmdEndRenderPass2KHRArgs(std::ostream &os, const CmdEndRenderPass2KHRArgs &args) {
    {
        os << "- # parameter:" << std::endl;
        ScopedOstream sop(os);
        os << "name:  commandBuffer" << std::endl;
...
void CommandPrinter::PrintCmdDrawIndirectCountKHRArgs(std::ostream &os, const CmdDrawIndirectCountKHRArgs &args) {
    {
        os << "- # parameter:" << std::endl;
        ScopedOstream sop(os);
        os << "name:  commandBuffer" << std::endl;
...
void CommandPrinter::PrintCmdDrawIndexedIndirectCountKHRArgs(std::ostream &os,
...
void CommandPrinter::PrintCmdSetFragmentShadingRateKHRArgs(std::ostream &os,
...
void CommandPrinter::PrintCmdEncodeVideoKHRArgs(std::ostream &os, const CmdEncodeVideoKHRArgs &args) {
    {
        os << "- # parameter:" << std::endl;
        ScopedOstream sop(os);
        os << "name:  commandBuffer" << std::endl;
...
void CommandPrinter::PrintCmdSetEvent2KHRArgs(std::ostream &os, const CmdSetEvent2KHRArgs &args) {
    {
        os << "- # parameter:" << std::endl;
        ScopedOstream sop(os);
        os << "name:  commandBuffer" << std::endl;
...
void CommandPrinter::PrintCmdResetEvent2KHRArgs(std::ostream &os, const CmdResetEvent2KHRArgs &args) {
    {
        os << "- # parameter:" << std::endl;
        ScopedOstream sop(os);
        os << "name:  commandBuffer" << std::endl;
...
void CommandPrinter::PrintCmdWaitEvents2KHRArgs(std::ostream &os, const CmdWaitEvents2KHRArgs &args) {
    {
        os << "- # parameter:" << std::endl;
        ScopedOstream sop(os);
        os << "name:  commandBuffer" << std::endl;
...
void CommandPrinter::PrintCmdPipelineBarrier2KHRArgs(std::ostream &os, const CmdPipelineBarrier2KHRArgs &args) {
    {
        os << "- # parameter:" << std::endl;
        ScopedOstream sop(os);
        os << "name:  commandBuffer" << std::endl;
...
void CommandPrinter::PrintCmdWriteTimestamp2KHRArgs(std::ostream &os, const CmdWriteTimestamp2KHRArgs &args) {
    {
        os << "- # parameter:" << std::endl;
        ScopedOstream sop(os);
        os << "name:  commandBuffer" << std::endl;
...
void CommandPrinter::PrintCmdWriteBufferMarker2AMDArgs(std::ostream &os, const CmdWriteBufferMarker2AMDArgs &args) {
    {
        os << "- # parameter:" << std::endl;
        ScopedOstream sop(os);
        os << "name:  commandBuffer" << std::endl;
...
void CommandPrinter::PrintCmdCopyBuffer2KHRArgs(std::ostream &os, const CmdCopyBuffer2KHRArgs &args) {
    {
        os << "- # parameter:" << std::endl;
        ScopedOstream sop(os);
        os << "name:  commandBuffer" << std::endl;
...
void CommandPrinter::PrintCmdCopyImage2KHRArgs(std::ostream &os, const CmdCopyImage2KHRArgs &args) {
    {
        os << "- # parameter:" << std::endl;
        ScopedOstream sop(os);
        os << "name:  commandBuffer" << std::endl;
...
void CommandPrinter::PrintCmdCopyBufferToImage2KHRArgs(std::ostream &os, const CmdCopyBufferToImage2KHRArgs &args) {
    {
        os << "- # parameter:" << std::endl;
        ScopedOstream sop(os);
        os << "name:  commandBuffer" << std::endl;
...
void CommandPrinter::PrintCmdCopyImageToBuffer2KHRArgs(std::ostream &os, const CmdCopyImageToBuffer2KHRArgs &args) {
    {
        os << "- # parameter:" << std::endl;
        ScopedOstream sop(os);
        os << "name:  commandBuffer" << std::endl;
...
void CommandPrinter::PrintCmdBlitImage2KHRArgs(std::ostream &os, const CmdBlitImage2KHRArgs &args) {
    {
        os << "- # parameter:" << std::endl;
        ScopedOstream sop(os);
        os << "name:  commandBuffer" << std::endl;
...
void CommandPrinter::PrintCmdResolveImage2KHRArgs(std::ostream &os, const CmdResolveImage2KHRArgs &args) {
    {
        os << "- # parameter:" << std::endl;
        ScopedOstream sop(os);
        os << "name:  commandBuffer" << std::endl;
...
void CommandPrinter::PrintCmdTraceRaysIndirect2KHRArgs(std::ostream &os, const CmdTraceRaysIndirect2KHRArgs &args) {
    {
        os << "- # parameter:" << std::endl;
        ScopedOstream sop(os);
        os << "name:  commandBuffer" << std::endl;
...
void CommandPrinter::PrintCmdBindIndexBuffer2KHRArgs(std::ostream &os, const CmdBindIndexBuffer2KHRArgs &args) {
    {
        os << "- # parameter:" << std::endl;
        ScopedOstream sop(os);
        os << "name:  commandBuffer" << std::endl;
...
void CommandPrinter::PrintCmdSetLineStippleKHRArgs(std::ostream &os, const CmdSetLineStippleKHRArgs &args) {
    {
        os << "- # parameter:" << std::endl;
        ScopedOstream sop(os);
        os << "name:  commandBuffer" << std::endl;
...
void CommandPrinter::PrintCmdBindDescriptorSets2KHRArgs(std::ostream &os, const CmdBindDescriptorSets2KHRArgs &args) {
    {
        os << "- # parameter:" << std::endl;
        ScopedOstream sop(os);
        os << "name:  commandBuffer" << std::endl;
...
void CommandPrinter::PrintCmdPushConstants2KHRArgs(std::ostream &os, const CmdPushConstants2KHRArgs &args) {
    {
        os << "- # parameter:" << std::endl;
        ScopedOstream sop(os);
        os << "name:  commandBuffer" << std::endl;
...
void CommandPrinter::PrintCmdPushDescriptorSet2KHRArgs(std::ostream &os, const CmdPushDescriptorSet2KHRArgs &args) {
    {
        os << "- # parameter:" << std::endl;
        ScopedOstream sop(os);
        os << "name:  commandBuffer" << std::endl;
...
void CommandPrinter::PrintCmdSetDescriptorBufferOffsets2EXTArgs(std::ostream &os,
...
void CommandPrinter::PrintCmdDebugMarkerBeginEXTArgs(std::ostream &os, const CmdDebugMarkerBeginEXTArgs &args) {
    {
        os << "- # parameter:" << std::endl;
        ScopedOstream sop(os);
        os << "name:  commandBuffer" << std::endl;
...
void CommandPrinter::PrintCmdDebugMarkerEndEXTArgs(std::ostream &os, const CmdDebugMarkerEndEXTArgs &args) {
    {
        os << "- # parameter:" << std::endl;
        ScopedOstream sop(os);
        os << "name:  commandBuffer" << std::endl;
...
void CommandPrinter::PrintCmdDebugMarkerInsertEXTArgs(std::ostream &os, const CmdDebugMarkerInsertEXTArgs &args) {
    {
        os << "- # parameter:" << std::endl;
        ScopedOstream sop(os);
        os << "name:  commandBuffer" << std::endl;
...
void CommandPrinter::PrintCmdBindTransformFeedbackBuffersEXTArgs(std::ostream &os,
...
void CommandPrinter::PrintCmdBeginTransformFeedbackEXTArgs(std::ostream &os,
...
void CommandPrinter::PrintCmdEndTransformFeedbackEXTArgs(std::ostream &os, const CmdEndTransformFeedbackEXTArgs &args) {
    {
        os << "- # parameter:" << std::endl;
        ScopedOstream sop(os);
        os << "name:  commandBuffer" << std::endl;
...
void CommandPrinter::PrintCmdBeginQueryIndexedEXTArgs(std::ostream &os, const CmdBeginQueryIndexedEXTArgs &args) {
    {
        os << "- # parameter:" << std::endl;
        ScopedOstream sop(os);
        os << "name:  commandBuffer" << std::endl;
...
void CommandPrinter::PrintCmdEndQueryIndexedEXTArgs(std::ostream &os, const CmdEndQueryIndexedEXTArgs &args) {
    {
        os << "- # parameter:" << std::endl;
        ScopedOstream sop(os);
        os << "name:  commandBuffer" << std::endl;
...
void CommandPrinter::PrintCmdDrawIndirectByteCountEXTArgs(std::ostream &os,
...
void CommandPrinter::PrintCmdCuLaunchKernelNVXArgs(std::ostream &os, const CmdCuLaunchKernelNVXArgs &args) {
    {
        os << "- # parameter:" << std::endl;
        ScopedOstream sop(os);
        os << "name:  commandBuffer" << std::endl;
...
void CommandPrinter::PrintCmdDrawIndirectCountAMDArgs(std::ostream &os, const CmdDrawIndirectCountAMDArgs &args) {
    {
        os << "- # parameter:" << std::endl;
        ScopedOstream sop(os);
        os << "name:  commandBuffer" << std::endl;
...
void CommandPrinter::PrintCmdDrawIndexedIndirectCountAMDArgs(std::ostream &os,
...
void CommandPrinter::PrintCmdBeginConditionalRenderingEXTArgs(std::ostream &os,
...
void CommandPrinter::PrintCmdEndConditionalRenderingEXTArgs(std::ostream &os,
...
void CommandPrinter::PrintCmdSetViewportWScalingNVArgs(std::ostream &os, const CmdSetViewportWScalingNVArgs &args) {
    {
        os << "- # parameter:" << std::endl;
        ScopedOstream sop(os);
        os << "name:  commandBuffer" << std::endl;
...
void CommandPrinter::PrintCmdSetDiscardRectangleEXTArgs(std::ostream &os, const CmdSetDiscardRectangleEXTArgs &args) {
    {
        os << "- # parameter:" << std::endl;
        ScopedOstream sop(os);
        os << "name:  commandBuffer" << std::endl;
...
void CommandPrinter::PrintCmdSetDiscardRectangleEnableEXTArgs(std::ostream &os,
...
void CommandPrinter::PrintCmdSetDiscardRectangleModeEXTArgs(std::ostream &os,
...
void CommandPrinter::PrintCmdBeginDebugUtilsLabelEXTArgs(std::ostream &os, const CmdBeginDebugUtilsLabelEXTArgs &args) {
    {
        os << "- # parameter:" << std::endl;
        ScopedOstream sop(os);
        os << "name:  commandBuffer" << std::endl;
...
void CommandPrinter::PrintCmdEndDebugUtilsLabelEXTArgs(std::ostream &os, const CmdEndDebugUtilsLabelEXTArgs &args) {
    {
        os << "- # parameter:" << std::endl;
        ScopedOstream sop(os);
        os << "name:  commandBuffer" << std::endl;
...
void CommandPrinter::PrintCmdInsertDebugUtilsLabelEXTArgs(std::ostream &os,
...
void CommandPrinter::PrintCmdInitializeGraphScratchMemoryAMDXArgs(std::ostream &os,
...
#ifdef VK_ENABLE_BETA_EXTENSIONS
void CommandPrinter::PrintCmdDispatchGraphAMDXArgs(std::ostream &os, const CmdDispatchGraphAMDXArgs &args) {
    {
        os << "- # parameter:" << std::endl;
        ScopedOstream sop(os);
        os << "name:  commandBuffer" << std::endl;
...
#ifdef VK_ENABLE_BETA_EXTENSIONS
void CommandPrinter::PrintCmdDispatchGraphIndirectAMDXArgs(std::ostream &os,
...
#ifdef VK_ENABLE_BETA_EXTENSIONS
void CommandPrinter::PrintCmdDispatchGraphIndirectCountAMDXArgs(std::ostream &os,
...
void CommandPrinter::PrintCmdSetSampleLocationsEXTArgs(std::ostream &os, const CmdSetSampleLocationsEXTArgs &args) {
    {
        os << "- # parameter:" << std::endl;
        ScopedOstream sop(os);
        os << "name:  commandBuffer" << std::endl;
...
void CommandPrinter::PrintCmdBindShadingRateImageNVArgs(std::ostream &os, const CmdBindShadingRateImageNVArgs &args) {
    {
        os << "- # parameter:" << std::endl;
        ScopedOstream sop(os);
        os << "name:  commandBuffer" << std::endl;
...
void CommandPrinter::PrintCmdSetViewportShadingRatePaletteNVArgs(std::ostream &os,
...
void CommandPrinter::PrintCmdSetCoarseSampleOrderNVArgs(std::ostream &os, const CmdSetCoarseSampleOrderNVArgs &args) {
    {
        os << "- # parameter:" << std::endl;
        ScopedOstream sop(os);
        os << "name:  commandBuffer" << std::endl;
...
void CommandPrinter::PrintCmdBuildAccelerationStructureNVArgs(std::ostream &os,
...
void CommandPrinter::PrintCmdCopyAccelerationStructureNVArgs(std::ostream &os,
...
void CommandPrinter::PrintCmdTraceRaysNVArgs(std::ostream &os, const CmdTraceRaysNVArgs &args) {
    {
        os << "- # parameter:" << std::endl;
        ScopedOstream sop(os);
        os << "name:  commandBuffer" << std::endl;
...
void CommandPrinter::PrintCmdWriteBufferMarkerAMDArgs(std::ostream &os, const CmdWriteBufferMarkerAMDArgs &args) {
    {
        os << "- # parameter:" << std::endl;
        ScopedOstream sop(os);
        os << "name:  commandBuffer" << std::endl;
...
void CommandPrinter::PrintCmdDrawMeshTasksNVArgs(std::ostream &os, const CmdDrawMeshTasksNVArgs &args) {
    {
        os << "- # parameter:" << std::endl;
        ScopedOstream sop(os);
        os << "name:  commandBuffer" << std::endl;
...
void CommandPrinter::PrintCmdDrawMeshTasksIndirectNVArgs(std::ostream &os, const CmdDrawMeshTasksIndirectNVArgs &args) {
    {
        os << "- # parameter:" << std::endl;
        ScopedOstream sop(os);
        os << "name:  commandBuffer" << std::endl;
...
void CommandPrinter::PrintCmdDrawMeshTasksIndirectCountNVArgs(std::ostream &os,
...
void CommandPrinter::PrintCmdSetExclusiveScissorEnableNVArgs(std::ostream &os,
...
void CommandPrinter::PrintCmdSetExclusiveScissorNVArgs(std::ostream &os, const CmdSetExclusiveScissorNVArgs &args) {
    {
        os << "- # parameter:" << std::endl;
        ScopedOstream sop(os);
        os << "name:  commandBuffer" << std::endl;
...
void CommandPrinter::PrintCmdSetCheckpointNVArgs(std::ostream &os, const CmdSetCheckpointNVArgs &args) {
    {
        os << "- # parameter:" << std::endl;
        ScopedOstream sop(os);
        os << "name:  commandBuffer" << std::endl;
...
void CommandPrinter::PrintCmdSetPerformanceMarkerINTELArgs(std::ostream &os,
...
void CommandPrinter::PrintCmdSetPerformanceStreamMarkerINTELArgs(std::ostream &os,
...
void CommandPrinter::PrintCmdSetPerformanceOverrideINTELArgs(std::ostream &os,
...
void CommandPrinter::PrintCmdSetLineStippleEXTArgs(std::ostream &os, const CmdSetLineStippleEXTArgs &args) {
    {
        os << "- # parameter:" << std::endl;
        ScopedOstream sop(os);
        os << "name:  commandBuffer" << std::endl;
...
void CommandPrinter::PrintCmdSetCullModeEXTArgs(std::ostream &os, const CmdSetCullModeEXTArgs &args) {
    {
        os << "- # parameter:" << std::endl;
        ScopedOstream sop(os);
        os << "name:  commandBuffer" << std::endl;
...
void CommandPrinter::PrintCmdSetFrontFaceEXTArgs(std::ostream &os, const CmdSetFrontFaceEXTArgs &args) {
    {
        os << "- # parameter:" << std::endl;
        ScopedOstream sop(os);
        os << "name:  commandBuffer" << std::endl;
...
void CommandPrinter::PrintCmdSetPrimitiveTopologyEXTArgs(std::ostream &os, const CmdSetPrimitiveTopologyEXTArgs &args) {
    {
        os << "- # parameter:" << std::endl;
        ScopedOstream sop(os);
        os << "name:  commandBuffer" << std::endl;
...
void CommandPrinter::PrintCmdSetViewportWithCountEXTArgs(std::ostream &os, const CmdSetViewportWithCountEXTArgs &args) {
    {
        os << "- # parameter:" << std::endl;
        ScopedOstream sop(os);
        os << "name:  commandBuffer" << std::endl;
...
void CommandPrinter::PrintCmdSetScissorWithCountEXTArgs(std::ostream &os, const CmdSetScissorWithCountEXTArgs &args) {
    {
        os << "- # parameter:" << std::endl;
        ScopedOstream sop(os);
        os << "name:  commandBuffer" << std::endl;
...
void CommandPrinter::PrintCmdBindVertexBuffers2EXTArgs(std::ostream &os, const CmdBindVertexBuffers2EXTArgs &args) {
    {
        os << "- # parameter:" << std::endl;
        ScopedOstream sop(os);
        os << "name:  commandBuffer" << std::endl;
...
void CommandPrinter::PrintCmdSetDepthTestEnableEXTArgs(std::ostream &os, const CmdSetDepthTestEnableEXTArgs &args) {
    {
        os << "- # parameter:" << std::endl;
        ScopedOstream sop(os);
        os << "name:  commandBuffer" << std::endl;
...
void CommandPrinter::PrintCmdSetDepthWriteEnableEXTArgs(std::ostream &os, const CmdSetDepthWriteEnableEXTArgs &args) {
    {
        os << "- # parameter:" << std::endl;
        ScopedOstream sop(os);
        os << "name:  commandBuffer" << std::endl;
...
void CommandPrinter::PrintCmdSetDepthCompareOpEXTArgs(std::ostream &os, const CmdSetDepthCompareOpEXTArgs &args) {
    {
        os << "- # parameter:" << std::endl;
        ScopedOstream sop(os);
        os << "name:  commandBuffer" << std::endl;
...
void CommandPrinter::PrintCmdSetDepthBoundsTestEnableEXTArgs(std::ostream &os,
...
void CommandPrinter::PrintCmdSetStencilTestEnableEXTArgs(std::ostream &os, const CmdSetStencilTestEnableEXTArgs &args) {
    {
        os << "- # parameter:" << std::endl;
        ScopedOstream sop(os);
        os << "name:  commandBuffer" << std::endl;
...
void CommandPrinter::PrintCmdSetStencilOpEXTArgs(std::ostream &os, const CmdSetStencilOpEXTArgs &args) {
    {
        os << "- # parameter:" << std::endl;
        ScopedOstream sop(os);
        os << "name:  commandBuffer" << std::endl;
...
void CommandPrinter::PrintCmdPreprocessGeneratedCommandsNVArgs(std::ostream &os,
...
void CommandPrinter::PrintCmdExecuteGeneratedCommandsNVArgs(std::ostream &os,
...
void CommandPrinter::PrintCmdBindPipelineShaderGroupNVArgs(std::ostream &os,
...
void CommandPrinter::PrintCmdSetDepthBias2EXTArgs(std::ostream &os, const CmdSetDepthBias2EXTArgs &args) {
    {
        os << "- # parameter:" << std::endl;
        ScopedOstream sop(os);
        os << "name:  commandBuffer" << std::endl;
...
void CommandPrinter::PrintCmdCudaLaunchKernelNVArgs(std::ostream &os, const CmdCudaLaunchKernelNVArgs &args) {
    {
        os << "- # parameter:" << std::endl;
        ScopedOstream sop(os);
        os << "name:  commandBuffer" << std::endl;
...
void CommandPrinter::PrintCmdBindDescriptorBuffersEXTArgs(std::ostream &os,
...
void CommandPrinter::PrintCmdSetDescriptorBufferOffsetsEXTArgs(std::ostream &os,
...
void CommandPrinter::PrintCmdSetFragmentShadingRateEnumNVArgs(std::ostream &os,
...
void CommandPrinter::PrintCmdSetVertexInputEXTArgs(std::ostream &os, const CmdSetVertexInputEXTArgs &args) {
    {
        os << "- # parameter:" << std::endl;
        ScopedOstream sop(os);
        os << "name:  commandBuffer" << std::endl;
...
void CommandPrinter::PrintCmdSubpassShadingHUAWEIArgs(std::ostream &os, const CmdSubpassShadingHUAWEIArgs &args) {
    {
        os << "- # parameter:" << std::endl;
        ScopedOstream sop(os);
        os << "name:  commandBuffer" << std::endl;
...
void CommandPrinter::PrintCmdBindInvocationMaskHUAWEIArgs(std::ostream &os,
...
void CommandPrinter::PrintCmdSetPatchControlPointsEXTArgs(std::ostream &os,
...
void CommandPrinter::PrintCmdSetRasterizerDiscardEnableEXTArgs(std::ostream &os,
...
void CommandPrinter::PrintCmdSetDepthBiasEnableEXTArgs(std::ostream &os, const CmdSetDepthBiasEnableEXTArgs &args) {
    {
        os << "- # parameter:" << std::endl;
        ScopedOstream sop(os);
        os << "name:  commandBuffer" << std::endl;
...
void CommandPrinter::PrintCmdSetLogicOpEXTArgs(std::ostream &os, const CmdSetLogicOpEXTArgs &args) {
    {
        os << "- # parameter:" << std::endl;
        ScopedOstream sop(os);
        os << "name:  commandBuffer" << std::endl;
...
void CommandPrinter::PrintCmdSetPrimitiveRestartEnableEXTArgs(std::ostream &os,
...
void CommandPrinter::PrintCmdSetColorWriteEnableEXTArgs(std::ostream &os, const CmdSetColorWriteEnableEXTArgs &args) {
    {
        os << "- # parameter:" << std::endl;
        ScopedOstream sop(os);
        os << "name:  commandBuffer" << std::endl;
...
void CommandPrinter::PrintCmdDrawMultiEXTArgs(std::ostream &os, const CmdDrawMultiEXTArgs &args) {
    {
        os << "- # parameter:" << std::endl;
        ScopedOstream sop(os);
        os << "name:  commandBuffer" << std::endl;
...
void CommandPrinter::PrintCmdDrawMultiIndexedEXTArgs(std::ostream &os, const CmdDrawMultiIndexedEXTArgs &args) {
    {
        os << "- # parameter:" << std::endl;
        ScopedOstream sop(os);
        os << "name:  commandBuffer" << std::endl;
...
void CommandPrinter::PrintCmdBuildMicromapsEXTArgs(std::ostream &os, const CmdBuildMicromapsEXTArgs &args) {
    {
        os << "- # parameter:" << std::endl;
        ScopedOstream sop(os);
        os << "name:  commandBuffer" << std::endl;
...
void CommandPrinter::PrintCmdCopyMicromapEXTArgs(std::ostream &os, const CmdCopyMicromapEXTArgs &args) {
    {
        os << "- # parameter:" << std::endl;
        ScopedOstream sop(os);
        os << "name:  commandBuffer" << std::endl;
...
void CommandPrinter::PrintCmdCopyMicromapToMemoryEXTArgs(std::ostream &os, const CmdCopyMicromapToMemoryEXTArgs &args) {
    {
        os << "- # parameter:" << std::endl;
        ScopedOstream sop(os);
        os << "name:  commandBuffer" << std::endl;
...
void CommandPrinter::PrintCmdCopyMemoryToMicromapEXTArgs(std::ostream &os, const CmdCopyMemoryToMicromapEXTArgs &args) {
    {
        os << "- # parameter:" << std::endl;
        ScopedOstream sop(os);
        os << "name:  commandBuffer" << std::endl;
...
void CommandPrinter::PrintCmdWriteMicromapsPropertiesEXTArgs(std::ostream &os,
...
void CommandPrinter::PrintCmdDrawClusterHUAWEIArgs(std::ostream &os, const CmdDrawClusterHUAWEIArgs &args) {
    {
        os << "- # parameter:" << std::endl;
        ScopedOstream sop(os);
        os << "name:  commandBuffer" << std::endl;
...
void CommandPrinter::PrintCmdDrawClusterIndirectHUAWEIArgs(std::ostream &os,
...
void CommandPrinter::PrintCmdCopyMemoryIndirectNVArgs(std::ostream &os, const CmdCopyMemoryIndirectNVArgs &args) {
    {
        os << "- # parameter:" << std::endl;
        ScopedOstream sop(os);
        os << "name:  commandBuffer" << std::endl;
...
void CommandPrinter::PrintCmdCopyMemoryToImageIndirectNVArgs(std::ostream &os,
...
void CommandPrinter::PrintCmdDecompressMemoryNVArgs(std::ostream &os, const CmdDecompressMemoryNVArgs &args) {
    {
        os << "- # parameter:" << std::endl;
        ScopedOstream sop(os);
        os << "name:  commandBuffer" << std::endl;
...
void CommandPrinter::PrintCmdDecompressMemoryIndirectCountNVArgs(std::ostream &os,
...
void CommandPrinter::PrintCmdUpdatePipelineIndirectBufferNVArgs(std::ostream &os,
...
void CommandPrinter::PrintCmdSetDepthClampEnableEXTArgs(std::ostream &os, const CmdSetDepthClampEnableEXTArgs &args) {
    {
        os << "- # parameter:" << std::endl;
        ScopedOstream sop(os);
        os << "name:  commandBuffer" << std::endl;
...
void CommandPrinter::PrintCmdSetPolygonModeEXTArgs(std::ostream &os, const CmdSetPolygonModeEXTArgs &args) {
    {
        os << "- # parameter:" << std::endl;
        ScopedOstream sop(os);
        os << "name:  commandBuffer" << std::endl;
...
void CommandPrinter::PrintCmdSetRasterizationSamplesEXTArgs(std::ostream &os,
...
void CommandPrinter::PrintCmdSetSampleMaskEXTArgs(std::ostream &os, const CmdSetSampleMaskEXTArgs &args) {
    {
        os << "- # parameter:" << std::endl;
        ScopedOstream sop(os);
        os << "name:  commandBuffer" << std::endl;
...
void CommandPrinter::PrintCmdSetAlphaToCoverageEnableEXTArgs(std::ostream &os,
...
void CommandPrinter::PrintCmdSetAlphaToOneEnableEXTArgs(std::ostream &os, const CmdSetAlphaToOneEnableEXTArgs &args) {
    {
        os << "- # parameter:" << std::endl;
        ScopedOstream sop(os);
        os << "name:  commandBuffer" << std::endl;
...
void CommandPrinter::PrintCmdSetLogicOpEnableEXTArgs(std::ostream &os, const CmdSetLogicOpEnableEXTArgs &args) {
    {
        os << "- # parameter:" << std::endl;
        ScopedOstream sop(os);
        os << "name:  commandBuffer" << std::endl;
...
void CommandPrinter::PrintCmdSetColorBlendEnableEXTArgs(std::ostream &os, const CmdSetColorBlendEnableEXTArgs &args) {
    {
        os << "- # parameter:" << std::endl;
        ScopedOstream sop(os);
        os << "name:  commandBuffer" << std::endl;
...
void CommandPrinter::PrintCmdSetColorBlendEquationEXTArgs(std::ostream &os,
...
void CommandPrinter::PrintCmdSetColorWriteMaskEXTArgs(std::ostream &os, const CmdSetColorWriteMaskEXTArgs &args) {
    {
        os << "- # parameter:" << std::endl;
        ScopedOstream sop(os);
        os << "name:  commandBuffer" << std::endl;
...
void CommandPrinter::PrintCmdSetTessellationDomainOriginEXTArgs(std::ostream &os,
...
void CommandPrinter::PrintCmdSetRasterizationStreamEXTArgs(std::ostream &os,
...
void CommandPrinter::PrintCmdSetDepthClipEnableEXTArgs(std::ostream &os, const CmdSetDepthClipEnableEXTArgs &args) {
    {
        os << "- # parameter:" << std::endl;
        ScopedOstream sop(os);
        os << "name:  commandBuffer" << std::endl;
...
void CommandPrinter::PrintCmdSetSampleLocationsEnableEXTArgs(std::ostream &os,
...
void CommandPrinter::PrintCmdSetColorBlendAdvancedEXTArgs(std::ostream &os,
...
void CommandPrinter::PrintCmdSetProvokingVertexModeEXTArgs(std::ostream &os,
...
void CommandPrinter::PrintCmdSetLineRasterizationModeEXTArgs(std::ostream &os,
...
void CommandPrinter::PrintCmdSetLineStippleEnableEXTArgs(std::ostream &os, const CmdSetLineStippleEnableEXTArgs &args) {
    {
        os << "- # parameter:" << std::endl;
        ScopedOstream sop(os);
        os << "name:  commandBuffer" << std::endl;
...
void CommandPrinter::PrintCmdSetDepthClipNegativeOneToOneEXTArgs(std::ostream &os,
...
void CommandPrinter::PrintCmdSetViewportWScalingEnableNVArgs(std::ostream &os,
...
void CommandPrinter::PrintCmdSetViewportSwizzleNVArgs(std::ostream &os, const CmdSetViewportSwizzleNVArgs &args) {
    {
        os << "- # parameter:" << std::endl;
        ScopedOstream sop(os);
        os << "name:  commandBuffer" << std::endl;
...
void CommandPrinter::PrintCmdSetCoverageToColorEnableNVArgs(std::ostream &os,
...
void CommandPrinter::PrintCmdSetCoverageToColorLocationNVArgs(std::ostream &os,
...
void CommandPrinter::PrintCmdSetCoverageModulationModeNVArgs(std::ostream &os,
...
void CommandPrinter::PrintCmdSetCoverageModulationTableNVArgs(std::ostream &os,
...
void CommandPrinter::PrintCmdSetShadingRateImageEnableNVArgs(std::ostream &os,
...
void CommandPrinter::PrintCmdSetCoverageReductionModeNVArgs(std::ostream &os,
...
void CommandPrinter::PrintCmdOpticalFlowExecuteNVArgs(std::ostream &os, const CmdOpticalFlowExecuteNVArgs &args) {
    {
        os << "- # parameter:" << std::endl;
        ScopedOstream sop(os);
        os << "name:  commandBuffer" << std::endl;
...
void CommandPrinter::PrintCmdBindShadersEXTArgs(std::ostream &os, const CmdBindShadersEXTArgs &args) {
    {
        os << "- # parameter:" << std::endl;
        ScopedOstream sop(os);
        os << "name:  commandBuffer" << std::endl;
...
void CommandPrinter::PrintCmdBuildAccelerationStructuresKHRArgs(std::ostream &os,
...
void CommandPrinter::PrintCmdCopyAccelerationStructureKHRArgs(std::ostream &os,
...
void CommandPrinter::PrintCmdTraceRaysKHRArgs(std::ostream &os, const CmdTraceRaysKHRArgs &args) {
    {
        os << "- # parameter:" << std::endl;
        ScopedOstream sop(os);
        os << "name:  commandBuffer" << std::endl;
...
void CommandPrinter::PrintCmdTraceRaysIndirectKHRArgs(std::ostream &os, const CmdTraceRaysIndirectKHRArgs &args) {
    {
        os << "- # parameter:" << std::endl;
        ScopedOstream sop(os);
        os << "name:  commandBuffer" << std::endl;
...
void CommandPrinter::PrintCmdDrawMeshTasksEXTArgs(std::ostream &os, const CmdDrawMeshTasksEXTArgs &args) {
    {
        os << "- # parameter:" << std::endl;
        ScopedOstream sop(os);
        os << "name:  commandBuffer" << std::endl;
...
void CommandPrinter::PrintCmdDrawMeshTasksIndirectEXTArgs(std::ostream &os,
...
void CommandPrinter::PrintCmdDrawMeshTasksIndirectCountEXTArgs(std::ostream &os,
