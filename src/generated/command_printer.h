...
class ScopedOstream : public std::streambuf {
   public:
    explicit ScopedOstream(std::ostream &os, int indent = 4)
        : os_(&os), sb_(os_->rdbuf()), line_start_(true), indent_(indent) {
        os_->rdbuf(this);
    }

    virtual ~ScopedOstream() { os_->rdbuf(sb_); }
...
class CommandPrinter {
   public:
    ...
    void PrintCmdPushDescriptorSetWithTemplateKHRArgs(std::ostream &os,
    ...
    void PrintCmdSetRenderingAttachmentLocationsKHRArgs(std::ostream &os,
                                                        const CmdSetRenderingAttachmentLocationsKHRArgs &args);
    void PrintCmdSetRenderingInputAttachmentIndicesKHRArgs(std::ostream &os,
    ...
    void PrintCmdPushDescriptorSetWithTemplate2KHRArgs(std::ostream &os,
                                                       const CmdPushDescriptorSetWithTemplate2KHRArgs &args);
    void PrintCmdSetDescriptorBufferOffsets2EXTArgs(std::ostream &os,
    ...
    void PrintCmdBindTransformFeedbackBuffersEXTArgs(std::ostream &os,
...
#ifdef VK_ENABLE_BETA_EXTENSIONS
    void PrintCmdInitializeGraphScratchMemoryAMDXArgs(std::ostream &os,
...
#endif  // VK_ENABLE_BETA_EXTENSIONS
#ifdef VK_ENABLE_BETA_EXTENSIONS
    void PrintCmdDispatchGraphIndirectCountAMDXArgs(std::ostream &os,
    ...
    void PrintCmdSetViewportShadingRatePaletteNVArgs(std::ostream &os,
    ...
    void PrintCmdSetPerformanceStreamMarkerINTELArgs(std::ostream &os,
    ...
    void PrintCmdDecompressMemoryIndirectCountNVArgs(std::ostream &os,
                                                     const CmdDecompressMemoryIndirectCountNVArgs &args);
    void PrintCmdUpdatePipelineIndirectBufferNVArgs(std::ostream &os,
    ...
    void PrintCmdSetTessellationDomainOriginEXTArgs(std::ostream &os,
    ...
    void PrintCmdSetConservativeRasterizationModeEXTArgs(std::ostream &os,
                                                         const CmdSetConservativeRasterizationModeEXTArgs &args);
    void PrintCmdSetExtraPrimitiveOverestimationSizeEXTArgs(std::ostream &os,
    ...
    void PrintCmdSetDepthClipNegativeOneToOneEXTArgs(std::ostream &os,
    ...
    void PrintCmdSetCoverageModulationTableEnableNVArgs(std::ostream &os,
    ...
    void PrintCmdSetRepresentativeFragmentTestEnableNVArgs(std::ostream &os,
    ...
    void PrintCmdSetAttachmentFeedbackLoopEnableEXTArgs(std::ostream &os,
                                                        const CmdSetAttachmentFeedbackLoopEnableEXTArgs &args);
    void PrintCmdBuildAccelerationStructuresKHRArgs(std::ostream &os,
                                                    const CmdBuildAccelerationStructuresKHRArgs &args);
    void PrintCmdBuildAccelerationStructuresIndirectKHRArgs(std::ostream &os,
    ...
    void PrintCmdCopyAccelerationStructureToMemoryKHRArgs(std::ostream &os,
                                                          const CmdCopyAccelerationStructureToMemoryKHRArgs &args);
    void PrintCmdCopyMemoryToAccelerationStructureKHRArgs(std::ostream &os,
    ...
    void PrintCmdSetRayTracingPipelineStackSizeKHRArgs(std::ostream &os,
