...
void CommandTracker::TrackPreBeginCommandBuffer(
...
void CommandTracker::TrackPostBeginCommandBuffer(
    VkCommandBuffer                             commandBuffer,
    const VkCommandBufferBeginInfo*             pBeginInfo) {
  assert(commands_.back().type == Command::Type::kBeginCommandBuffer);
}

void CommandTracker::TrackPreEndCommandBuffer(
    VkCommandBuffer                             commandBuffer) {
  Command cmd {};
...
void CommandTracker::TrackPostEndCommandBuffer(
    VkCommandBuffer                             commandBuffer) {
  assert(commands_.back().type == Command::Type::kEndCommandBuffer);
}

void CommandTracker::TrackPreResetCommandBuffer(
    VkCommandBuffer                             commandBuffer,
...
void CommandTracker::TrackPostResetCommandBuffer(
    VkCommandBuffer                             commandBuffer,
    VkCommandBufferResetFlags                   flags) {
  assert(commands_.back().type == Command::Type::kResetCommandBuffer);
}

void CommandTracker::TrackPreCmdBindPipeline(
    VkCommandBuffer                             commandBuffer,
...
void CommandTracker::TrackPostCmdBindPipeline(
    VkCommandBuffer                             commandBuffer,
    VkPipelineBindPoint                         pipelineBindPoint,
    VkPipeline                                  pipeline) {
...
void CommandTracker::TrackPreCmdSetViewport(
    VkCommandBuffer                             commandBuffer,
...
void CommandTracker::TrackPostCmdSetViewport(
    VkCommandBuffer                             commandBuffer,
    uint32_t                                    firstViewport,
    uint32_t                                    viewportCount,
    const VkViewport*                           pViewports) {
...
void CommandTracker::TrackPreCmdSetScissor(
    VkCommandBuffer                             commandBuffer,
...
void CommandTracker::TrackPostCmdSetScissor(
    VkCommandBuffer                             commandBuffer,
    uint32_t                                    firstScissor,
    uint32_t                                    scissorCount,
    const VkRect2D*                             pScissors) {
...
void CommandTracker::TrackPreCmdSetLineWidth(
    VkCommandBuffer                             commandBuffer,
    float                                       lineWidth) {
  Command cmd {};
...
void CommandTracker::TrackPostCmdSetLineWidth(
    VkCommandBuffer                             commandBuffer,
    float                                       lineWidth) {
  assert(commands_.back().type == Command::Type::kCmdSetLineWidth);
}

void CommandTracker::TrackPreCmdSetDepthBias(
    VkCommandBuffer                             commandBuffer,
...
void CommandTracker::TrackPostCmdSetDepthBias(
    VkCommandBuffer                             commandBuffer,
    float                                       depthBiasConstantFactor,
    float                                       depthBiasClamp,
    float                                       depthBiasSlopeFactor) {
...
void CommandTracker::TrackPreCmdSetBlendConstants(
    VkCommandBuffer                             commandBuffer,
...
void CommandTracker::TrackPostCmdSetBlendConstants(
    VkCommandBuffer                             commandBuffer,
    const float                                 blendConstants[4]) {
  assert(commands_.back().type == Command::Type::kCmdSetBlendConstants);
}

void CommandTracker::TrackPreCmdSetDepthBounds(
    VkCommandBuffer                             commandBuffer,
...
void CommandTracker::TrackPostCmdSetDepthBounds(
    VkCommandBuffer                             commandBuffer,
    float                                       minDepthBounds,
    float                                       maxDepthBounds) {
...
void CommandTracker::TrackPreCmdSetStencilCompareMask(
    VkCommandBuffer                             commandBuffer,
...
void CommandTracker::TrackPostCmdSetStencilCompareMask(
    VkCommandBuffer                             commandBuffer,
    VkStencilFaceFlags                          faceMask,
    uint32_t                                    compareMask) {
...
void CommandTracker::TrackPreCmdSetStencilWriteMask(
    VkCommandBuffer                             commandBuffer,
    VkStencilFaceFlags                          faceMask,
    uint32_t                                    writeMask) {
  Command cmd {};
...
void CommandTracker::TrackPostCmdSetStencilWriteMask(
    VkCommandBuffer                             commandBuffer,
    VkStencilFaceFlags                          faceMask,
    uint32_t                                    writeMask) {
...
void CommandTracker::TrackPreCmdSetStencilReference(
    VkCommandBuffer                             commandBuffer,
    VkStencilFaceFlags                          faceMask,
    uint32_t                                    reference) {
  Command cmd {};
...
void CommandTracker::TrackPostCmdSetStencilReference(
    VkCommandBuffer                             commandBuffer,
    VkStencilFaceFlags                          faceMask,
    uint32_t                                    reference) {
...
void CommandTracker::TrackPreCmdBindDescriptorSets(
    VkCommandBuffer                             commandBuffer,
    VkPipelineBindPoint                         pipelineBindPoint,
...
void CommandTracker::TrackPostCmdBindDescriptorSets(
    VkCommandBuffer                             commandBuffer,
    VkPipelineBindPoint                         pipelineBindPoint,
    VkPipelineLayout                            layout,
    uint32_t                                    firstSet,
...
void CommandTracker::TrackPreCmdBindIndexBuffer(
    VkCommandBuffer                             commandBuffer,
    VkBuffer                                    buffer,
    VkDeviceSize                                offset,
...
void CommandTracker::TrackPostCmdBindIndexBuffer(
    VkCommandBuffer                             commandBuffer,
    VkBuffer                                    buffer,
    VkDeviceSize                                offset,
    VkIndexType                                 indexType) {
...
void CommandTracker::TrackPreCmdBindVertexBuffers(
    VkCommandBuffer                             commandBuffer,
...
void CommandTracker::TrackPostCmdBindVertexBuffers(
    VkCommandBuffer                             commandBuffer,
    uint32_t                                    firstBinding,
    uint32_t                                    bindingCount,
    const VkBuffer*                             pBuffers,
...
void CommandTracker::TrackPreCmdDraw(
    VkCommandBuffer                             commandBuffer,
...
void CommandTracker::TrackPostCmdDraw(
    VkCommandBuffer                             commandBuffer,
    uint32_t                                    vertexCount,
    uint32_t                                    instanceCount,
    uint32_t                                    firstVertex,
...
void CommandTracker::TrackPreCmdDrawIndexed(
    VkCommandBuffer                             commandBuffer,
    uint32_t                                    indexCount,
    uint32_t                                    instanceCount,
    uint32_t                                    firstIndex,
...
void CommandTracker::TrackPostCmdDrawIndexed(
    VkCommandBuffer                             commandBuffer,
    uint32_t                                    indexCount,
    uint32_t                                    instanceCount,
    uint32_t                                    firstIndex,
...
void CommandTracker::TrackPreCmdDrawIndirect(
    VkCommandBuffer                             commandBuffer,
    VkBuffer                                    buffer,
    VkDeviceSize                                offset,
    uint32_t                                    drawCount,
...
void CommandTracker::TrackPostCmdDrawIndirect(
    VkCommandBuffer                             commandBuffer,
    VkBuffer                                    buffer,
    VkDeviceSize                                offset,
    uint32_t                                    drawCount,
...
void CommandTracker::TrackPreCmdDrawIndexedIndirect(
    VkCommandBuffer                             commandBuffer,
    VkBuffer                                    buffer,
    VkDeviceSize                                offset,
    uint32_t                                    drawCount,
...
void CommandTracker::TrackPostCmdDrawIndexedIndirect(
    VkCommandBuffer                             commandBuffer,
    VkBuffer                                    buffer,
    VkDeviceSize                                offset,
    uint32_t                                    drawCount,
...
void CommandTracker::TrackPreCmdDispatch(
    VkCommandBuffer                             commandBuffer,
...
void CommandTracker::TrackPostCmdDispatch(
    VkCommandBuffer                             commandBuffer,
    uint32_t                                    groupCountX,
    uint32_t                                    groupCountY,
    uint32_t                                    groupCountZ) {
...
void CommandTracker::TrackPreCmdDispatchIndirect(
    VkCommandBuffer                             commandBuffer,
    VkBuffer                                    buffer,
    VkDeviceSize                                offset) {
  Command cmd {};
...
void CommandTracker::TrackPostCmdDispatchIndirect(
    VkCommandBuffer                             commandBuffer,
    VkBuffer                                    buffer,
    VkDeviceSize                                offset) {
...
void CommandTracker::TrackPreCmdCopyBuffer(
    VkCommandBuffer                             commandBuffer,
    VkBuffer                                    srcBuffer,
    VkBuffer                                    dstBuffer,
...
void CommandTracker::TrackPostCmdCopyBuffer(
    VkCommandBuffer                             commandBuffer,
    VkBuffer                                    srcBuffer,
    VkBuffer                                    dstBuffer,
    uint32_t                                    regionCount,
...
void CommandTracker::TrackPreCmdCopyImage(
    VkCommandBuffer                             commandBuffer,
    VkImage                                     srcImage,
...
void CommandTracker::TrackPostCmdCopyImage(
    VkCommandBuffer                             commandBuffer,
    VkImage                                     srcImage,
    VkImageLayout                               srcImageLayout,
    VkImage                                     dstImage,
...
void CommandTracker::TrackPreCmdBlitImage(
    VkCommandBuffer                             commandBuffer,
    VkImage                                     srcImage,
    VkImageLayout                               srcImageLayout,
    VkImage                                     dstImage,
...
void CommandTracker::TrackPostCmdBlitImage(
    VkCommandBuffer                             commandBuffer,
    VkImage                                     srcImage,
    VkImageLayout                               srcImageLayout,
    VkImage                                     dstImage,
...
void CommandTracker::TrackPreCmdCopyBufferToImage(
    VkCommandBuffer                             commandBuffer,
    VkBuffer                                    srcBuffer,
    VkImage                                     dstImage,
    VkImageLayout                               dstImageLayout,
...
void CommandTracker::TrackPostCmdCopyBufferToImage(
    VkCommandBuffer                             commandBuffer,
    VkBuffer                                    srcBuffer,
    VkImage                                     dstImage,
    VkImageLayout                               dstImageLayout,
...
void CommandTracker::TrackPreCmdCopyImageToBuffer(
    VkCommandBuffer                             commandBuffer,
    VkImage                                     srcImage,
    VkImageLayout                               srcImageLayout,
    VkBuffer                                    dstBuffer,
...
void CommandTracker::TrackPostCmdCopyImageToBuffer(
    VkCommandBuffer                             commandBuffer,
    VkImage                                     srcImage,
    VkImageLayout                               srcImageLayout,
    VkBuffer                                    dstBuffer,
...
void CommandTracker::TrackPreCmdUpdateBuffer(
    VkCommandBuffer                             commandBuffer,
    VkBuffer                                    dstBuffer,
...
void CommandTracker::TrackPostCmdUpdateBuffer(
    VkCommandBuffer                             commandBuffer,
    VkBuffer                                    dstBuffer,
    VkDeviceSize                                dstOffset,
    VkDeviceSize                                dataSize,
...
void CommandTracker::TrackPreCmdFillBuffer(
    VkCommandBuffer                             commandBuffer,
    VkBuffer                                    dstBuffer,
    VkDeviceSize                                dstOffset,
    VkDeviceSize                                size,
...
void CommandTracker::TrackPostCmdFillBuffer(
    VkCommandBuffer                             commandBuffer,
    VkBuffer                                    dstBuffer,
    VkDeviceSize                                dstOffset,
    VkDeviceSize                                size,
...
void CommandTracker::TrackPreCmdClearColorImage(
    VkCommandBuffer                             commandBuffer,
    VkImage                                     image,
...
void CommandTracker::TrackPostCmdClearColorImage(
    VkCommandBuffer                             commandBuffer,
    VkImage                                     image,
    VkImageLayout                               imageLayout,
    const VkClearColorValue*                    pColor,
...
void CommandTracker::TrackPreCmdClearDepthStencilImage(
    VkCommandBuffer                             commandBuffer,
    VkImage                                     image,
    VkImageLayout                               imageLayout,
...
void CommandTracker::TrackPostCmdClearDepthStencilImage(
    VkCommandBuffer                             commandBuffer,
    VkImage                                     image,
    VkImageLayout                               imageLayout,
    const VkClearDepthStencilValue*             pDepthStencil,
...
void CommandTracker::TrackPreCmdClearAttachments(
    VkCommandBuffer                             commandBuffer,
...
void CommandTracker::TrackPostCmdClearAttachments(
    VkCommandBuffer                             commandBuffer,
    uint32_t                                    attachmentCount,
    const VkClearAttachment*                    pAttachments,
    uint32_t                                    rectCount,
...
void CommandTracker::TrackPreCmdResolveImage(
    VkCommandBuffer                             commandBuffer,
    VkImage                                     srcImage,
    VkImageLayout                               srcImageLayout,
    VkImage                                     dstImage,
...
void CommandTracker::TrackPostCmdResolveImage(
    VkCommandBuffer                             commandBuffer,
    VkImage                                     srcImage,
    VkImageLayout                               srcImageLayout,
    VkImage                                     dstImage,
...
void CommandTracker::TrackPreCmdSetEvent(
    VkCommandBuffer                             commandBuffer,
    VkEvent                                     event,
...
void CommandTracker::TrackPostCmdSetEvent(
    VkCommandBuffer                             commandBuffer,
    VkEvent                                     event,
    VkPipelineStageFlags                        stageMask) {
...
void CommandTracker::TrackPreCmdResetEvent(
    VkCommandBuffer                             commandBuffer,
    VkEvent                                     event,
    VkPipelineStageFlags                        stageMask) {
  Command cmd {};
...
void CommandTracker::TrackPostCmdResetEvent(
    VkCommandBuffer                             commandBuffer,
    VkEvent                                     event,
    VkPipelineStageFlags                        stageMask) {
...
void CommandTracker::TrackPreCmdWaitEvents(
    VkCommandBuffer                             commandBuffer,
    uint32_t                                    eventCount,
...
void CommandTracker::TrackPostCmdWaitEvents(
    VkCommandBuffer                             commandBuffer,
    uint32_t                                    eventCount,
    const VkEvent*                              pEvents,
    VkPipelineStageFlags                        srcStageMask,
...
void CommandTracker::TrackPreCmdBeginQuery(
    VkCommandBuffer                             commandBuffer,
...
void CommandTracker::TrackPostCmdBeginQuery(
    VkCommandBuffer                             commandBuffer,
    VkQueryPool                                 queryPool,
    uint32_t                                    query,
    VkQueryControlFlags                         flags) {
...
void CommandTracker::TrackPreCmdEndQuery(
    VkCommandBuffer                             commandBuffer,
    VkQueryPool                                 queryPool,
    uint32_t                                    query) {
  Command cmd {};
...
void CommandTracker::TrackPostCmdEndQuery(
    VkCommandBuffer                             commandBuffer,
    VkQueryPool                                 queryPool,
    uint32_t                                    query) {
...
void CommandTracker::TrackPreCmdResetQueryPool(
    VkCommandBuffer                             commandBuffer,
    VkQueryPool                                 queryPool,
    uint32_t                                    firstQuery,
    uint32_t                                    queryCount) {
...
void CommandTracker::TrackPostCmdResetQueryPool(
    VkCommandBuffer                             commandBuffer,
    VkQueryPool                                 queryPool,
    uint32_t                                    firstQuery,
    uint32_t                                    queryCount) {
...
void CommandTracker::TrackPreCmdWriteTimestamp(
    VkCommandBuffer                             commandBuffer,
...
void CommandTracker::TrackPostCmdWriteTimestamp(
    VkCommandBuffer                             commandBuffer,
    VkPipelineStageFlagBits                     pipelineStage,
    VkQueryPool                                 queryPool,
    uint32_t                                    query) {
...
void CommandTracker::TrackPreCmdCopyQueryPoolResults(
    VkCommandBuffer                             commandBuffer,
    VkQueryPool                                 queryPool,
    uint32_t                                    firstQuery,
    uint32_t                                    queryCount,
...
void CommandTracker::TrackPostCmdCopyQueryPoolResults(
    VkCommandBuffer                             commandBuffer,
    VkQueryPool                                 queryPool,
    uint32_t                                    firstQuery,
    uint32_t                                    queryCount,
...
void CommandTracker::TrackPreCmdPushConstants(
    VkCommandBuffer                             commandBuffer,
    VkPipelineLayout                            layout,
...
void CommandTracker::TrackPostCmdPushConstants(
    VkCommandBuffer                             commandBuffer,
    VkPipelineLayout                            layout,
    VkShaderStageFlags                          stageFlags,
    uint32_t                                    offset,
...
void CommandTracker::TrackPreCmdBeginRenderPass(
    VkCommandBuffer                             commandBuffer,
...
void CommandTracker::TrackPostCmdBeginRenderPass(
    VkCommandBuffer                             commandBuffer,
    const VkRenderPassBeginInfo*                pRenderPassBegin,
    VkSubpassContents                           contents) {
...
void CommandTracker::TrackPreCmdNextSubpass(
    VkCommandBuffer                             commandBuffer,
    VkSubpassContents                           contents) {
  Command cmd {};
...
void CommandTracker::TrackPostCmdNextSubpass(
    VkCommandBuffer                             commandBuffer,
    VkSubpassContents                           contents) {
  assert(commands_.back().type == Command::Type::kCmdNextSubpass);
}

void CommandTracker::TrackPreCmdEndRenderPass(
    VkCommandBuffer                             commandBuffer) {
  Command cmd {};
...
void CommandTracker::TrackPostCmdEndRenderPass(
    VkCommandBuffer                             commandBuffer) {
  assert(commands_.back().type == Command::Type::kCmdEndRenderPass);
}

void CommandTracker::TrackPreCmdExecuteCommands(
    VkCommandBuffer                             commandBuffer,
...
void CommandTracker::TrackPostCmdExecuteCommands(
    VkCommandBuffer                             commandBuffer,
    uint32_t                                    commandBufferCount,
    const VkCommandBuffer*                      pCommandBuffers) {
...
void CommandTracker::TrackPreCmdSetDeviceMask(
    VkCommandBuffer                             commandBuffer,
    uint32_t                                    deviceMask) {
  Command cmd {};
...
void CommandTracker::TrackPostCmdSetDeviceMask(
    VkCommandBuffer                             commandBuffer,
    uint32_t                                    deviceMask) {
  assert(commands_.back().type == Command::Type::kCmdSetDeviceMask);
}

void CommandTracker::TrackPreCmdDispatchBase(
    VkCommandBuffer                             commandBuffer,
    uint32_t                                    baseGroupX,
    uint32_t                                    baseGroupY,
    uint32_t                                    baseGroupZ,
...
void CommandTracker::TrackPostCmdDispatchBase(
    VkCommandBuffer                             commandBuffer,
    uint32_t                                    baseGroupX,
    uint32_t                                    baseGroupY,
    uint32_t                                    baseGroupZ,
...
void CommandTracker::TrackPreCmdDrawIndirectCount(
    VkCommandBuffer                             commandBuffer,
    VkBuffer                                    buffer,
    VkDeviceSize                                offset,
...
void CommandTracker::TrackPostCmdDrawIndirectCount(
    VkCommandBuffer                             commandBuffer,
    VkBuffer                                    buffer,
    VkDeviceSize                                offset,
    VkBuffer                                    countBuffer,
...
void CommandTracker::TrackPreCmdDrawIndexedIndirectCount(
    VkCommandBuffer                             commandBuffer,
    VkBuffer                                    buffer,
    VkDeviceSize                                offset,
    VkBuffer                                    countBuffer,
...
void CommandTracker::TrackPostCmdDrawIndexedIndirectCount(
    VkCommandBuffer                             commandBuffer,
    VkBuffer                                    buffer,
    VkDeviceSize                                offset,
    VkBuffer                                    countBuffer,
...
void CommandTracker::TrackPreCmdBeginRenderPass2(
    VkCommandBuffer                             commandBuffer,
    const VkRenderPassBeginInfo*                pRenderPassBegin,
...
void CommandTracker::TrackPostCmdBeginRenderPass2(
    VkCommandBuffer                             commandBuffer,
    const VkRenderPassBeginInfo*                pRenderPassBegin,
    const VkSubpassBeginInfo*                   pSubpassBeginInfo) {
...
void CommandTracker::TrackPreCmdNextSubpass2(
    VkCommandBuffer                             commandBuffer,
    const VkSubpassBeginInfo*                   pSubpassBeginInfo,
...
void CommandTracker::TrackPostCmdNextSubpass2(
    VkCommandBuffer                             commandBuffer,
    const VkSubpassBeginInfo*                   pSubpassBeginInfo,
    const VkSubpassEndInfo*                     pSubpassEndInfo) {
...
void CommandTracker::TrackPreCmdEndRenderPass2(
    VkCommandBuffer                             commandBuffer,
    const VkSubpassEndInfo*                     pSubpassEndInfo) {
  Command cmd {};
...
void CommandTracker::TrackPostCmdEndRenderPass2(
    VkCommandBuffer                             commandBuffer,
    const VkSubpassEndInfo*                     pSubpassEndInfo) {
  assert(commands_.back().type == Command::Type::kCmdEndRenderPass2);
}

void CommandTracker::TrackPreCmdSetEvent2(
    VkCommandBuffer                             commandBuffer,
    VkEvent                                     event,
...
void CommandTracker::TrackPostCmdSetEvent2(
    VkCommandBuffer                             commandBuffer,
    VkEvent                                     event,
    const VkDependencyInfo*                     pDependencyInfo) {
...
void CommandTracker::TrackPreCmdResetEvent2(
    VkCommandBuffer                             commandBuffer,
    VkEvent                                     event,
...
void CommandTracker::TrackPostCmdResetEvent2(
    VkCommandBuffer                             commandBuffer,
    VkEvent                                     event,
    VkPipelineStageFlags2                       stageMask) {
...
void CommandTracker::TrackPreCmdWaitEvents2(
    VkCommandBuffer                             commandBuffer,
    uint32_t                                    eventCount,
    const VkEvent*                              pEvents,
...
void CommandTracker::TrackPostCmdWaitEvents2(
    VkCommandBuffer                             commandBuffer,
    uint32_t                                    eventCount,
    const VkEvent*                              pEvents,
    const VkDependencyInfo*                     pDependencyInfos) {
...
void CommandTracker::TrackPreCmdPipelineBarrier2(
    VkCommandBuffer                             commandBuffer,
    const VkDependencyInfo*                     pDependencyInfo) {
  Command cmd {};
...
void CommandTracker::TrackPostCmdPipelineBarrier2(
    VkCommandBuffer                             commandBuffer,
    const VkDependencyInfo*                     pDependencyInfo) {
  assert(commands_.back().type == Command::Type::kCmdPipelineBarrier2);
}

void CommandTracker::TrackPreCmdWriteTimestamp2(
    VkCommandBuffer                             commandBuffer,
...
void CommandTracker::TrackPostCmdWriteTimestamp2(
    VkCommandBuffer                             commandBuffer,
    VkPipelineStageFlags2                       stage,
    VkQueryPool                                 queryPool,
    uint32_t                                    query) {
...
void CommandTracker::TrackPreCmdCopyBuffer2(
    VkCommandBuffer                             commandBuffer,
...
void CommandTracker::TrackPostCmdCopyBuffer2(
    VkCommandBuffer                             commandBuffer,
    const VkCopyBufferInfo2*                    pCopyBufferInfo) {
  assert(commands_.back().type == Command::Type::kCmdCopyBuffer2);
}

void CommandTracker::TrackPreCmdCopyImage2(
    VkCommandBuffer                             commandBuffer,
...
void CommandTracker::TrackPostCmdCopyImage2(
    VkCommandBuffer                             commandBuffer,
    const VkCopyImageInfo2*                     pCopyImageInfo) {
  assert(commands_.back().type == Command::Type::kCmdCopyImage2);
}

void CommandTracker::TrackPreCmdCopyBufferToImage2(
    VkCommandBuffer                             commandBuffer,
...
void CommandTracker::TrackPostCmdCopyBufferToImage2(
    VkCommandBuffer                             commandBuffer,
    const VkCopyBufferToImageInfo2*             pCopyBufferToImageInfo) {
  assert(commands_.back().type == Command::Type::kCmdCopyBufferToImage2);
}

void CommandTracker::TrackPreCmdCopyImageToBuffer2(
    VkCommandBuffer                             commandBuffer,
...
void CommandTracker::TrackPostCmdCopyImageToBuffer2(
    VkCommandBuffer                             commandBuffer,
    const VkCopyImageToBufferInfo2*             pCopyImageToBufferInfo) {
  assert(commands_.back().type == Command::Type::kCmdCopyImageToBuffer2);
}

void CommandTracker::TrackPreCmdBlitImage2(
    VkCommandBuffer                             commandBuffer,
...
void CommandTracker::TrackPostCmdBlitImage2(
    VkCommandBuffer                             commandBuffer,
    const VkBlitImageInfo2*                     pBlitImageInfo) {
  assert(commands_.back().type == Command::Type::kCmdBlitImage2);
}

void CommandTracker::TrackPreCmdResolveImage2(
    VkCommandBuffer                             commandBuffer,
...
void CommandTracker::TrackPostCmdResolveImage2(
    VkCommandBuffer                             commandBuffer,
    const VkResolveImageInfo2*                  pResolveImageInfo) {
  assert(commands_.back().type == Command::Type::kCmdResolveImage2);
}

void CommandTracker::TrackPreCmdBeginRendering(
    VkCommandBuffer                             commandBuffer,
...
void CommandTracker::TrackPostCmdBeginRendering(
    VkCommandBuffer                             commandBuffer,
    const VkRenderingInfo*                      pRenderingInfo) {
  assert(commands_.back().type == Command::Type::kCmdBeginRendering);
}

void CommandTracker::TrackPreCmdEndRendering(
    VkCommandBuffer                             commandBuffer) {
  Command cmd {};
...
void CommandTracker::TrackPostCmdEndRendering(
    VkCommandBuffer                             commandBuffer) {
  assert(commands_.back().type == Command::Type::kCmdEndRendering);
}

void CommandTracker::TrackPreCmdSetCullMode(
    VkCommandBuffer                             commandBuffer,
...
void CommandTracker::TrackPostCmdSetCullMode(
    VkCommandBuffer                             commandBuffer,
    VkCullModeFlags                             cullMode) {
  assert(commands_.back().type == Command::Type::kCmdSetCullMode);
}

void CommandTracker::TrackPreCmdSetFrontFace(
    VkCommandBuffer                             commandBuffer,
...
void CommandTracker::TrackPostCmdSetFrontFace(
    VkCommandBuffer                             commandBuffer,
    VkFrontFace                                 frontFace) {
  assert(commands_.back().type == Command::Type::kCmdSetFrontFace);
}

void CommandTracker::TrackPreCmdSetPrimitiveTopology(
    VkCommandBuffer                             commandBuffer,
...
void CommandTracker::TrackPostCmdSetPrimitiveTopology(
    VkCommandBuffer                             commandBuffer,
    VkPrimitiveTopology                         primitiveTopology) {
  assert(commands_.back().type == Command::Type::kCmdSetPrimitiveTopology);
}

void CommandTracker::TrackPreCmdSetViewportWithCount(
    VkCommandBuffer                             commandBuffer,
    uint32_t                                    viewportCount,
    const VkViewport*                           pViewports) {
  Command cmd {};
...
void CommandTracker::TrackPostCmdSetViewportWithCount(
    VkCommandBuffer                             commandBuffer,
    uint32_t                                    viewportCount,
    const VkViewport*                           pViewports) {
...
void CommandTracker::TrackPreCmdSetScissorWithCount(
    VkCommandBuffer                             commandBuffer,
    uint32_t                                    scissorCount,
    const VkRect2D*                             pScissors) {
  Command cmd {};
...
void CommandTracker::TrackPostCmdSetScissorWithCount(
    VkCommandBuffer                             commandBuffer,
    uint32_t                                    scissorCount,
    const VkRect2D*                             pScissors) {
...
void CommandTracker::TrackPreCmdBindVertexBuffers2(
    VkCommandBuffer                             commandBuffer,
    uint32_t                                    firstBinding,
    uint32_t                                    bindingCount,
    const VkBuffer*                             pBuffers,
  ...
  cmd.id = static_cast<uint32_t>(commands_.size()) + 1;
  cmd.parameters = recorder_.RecordCmdBindVertexBuffers2(commandBuffer, firstBinding, bindingCount, pBuffers, pOffsets, pSizes, pStrides);
  commands_.push_back(cmd);
}
void CommandTracker::TrackPostCmdBindVertexBuffers2(
    VkCommandBuffer                             commandBuffer,
    uint32_t                                    firstBinding,
    uint32_t                                    bindingCount,
    const VkBuffer*                             pBuffers,
...
void CommandTracker::TrackPreCmdSetDepthTestEnable(
    VkCommandBuffer                             commandBuffer,
...
void CommandTracker::TrackPostCmdSetDepthTestEnable(
    VkCommandBuffer                             commandBuffer,
    VkBool32                                    depthTestEnable) {
  assert(commands_.back().type == Command::Type::kCmdSetDepthTestEnable);
}

void CommandTracker::TrackPreCmdSetDepthWriteEnable(
    VkCommandBuffer                             commandBuffer,
...
void CommandTracker::TrackPostCmdSetDepthWriteEnable(
    VkCommandBuffer                             commandBuffer,
    VkBool32                                    depthWriteEnable) {
  assert(commands_.back().type == Command::Type::kCmdSetDepthWriteEnable);
}

void CommandTracker::TrackPreCmdSetDepthCompareOp(
    VkCommandBuffer                             commandBuffer,
...
void CommandTracker::TrackPostCmdSetDepthCompareOp(
    VkCommandBuffer                             commandBuffer,
    VkCompareOp                                 depthCompareOp) {
  assert(commands_.back().type == Command::Type::kCmdSetDepthCompareOp);
}

void CommandTracker::TrackPreCmdSetDepthBoundsTestEnable(
    VkCommandBuffer                             commandBuffer,
...
void CommandTracker::TrackPostCmdSetDepthBoundsTestEnable(
    VkCommandBuffer                             commandBuffer,
    VkBool32                                    depthBoundsTestEnable) {
  assert(commands_.back().type == Command::Type::kCmdSetDepthBoundsTestEnable);
}

void CommandTracker::TrackPreCmdSetStencilTestEnable(
    VkCommandBuffer                             commandBuffer,
...
void CommandTracker::TrackPostCmdSetStencilTestEnable(
    VkCommandBuffer                             commandBuffer,
    VkBool32                                    stencilTestEnable) {
  assert(commands_.back().type == Command::Type::kCmdSetStencilTestEnable);
}

void CommandTracker::TrackPreCmdSetStencilOp(
    VkCommandBuffer                             commandBuffer,
    VkStencilFaceFlags                          faceMask,
    VkStencilOp                                 failOp,
    VkStencilOp                                 passOp,
...
void CommandTracker::TrackPostCmdSetStencilOp(
    VkCommandBuffer                             commandBuffer,
    VkStencilFaceFlags                          faceMask,
    VkStencilOp                                 failOp,
    VkStencilOp                                 passOp,
...
void CommandTracker::TrackPreCmdSetRasterizerDiscardEnable(
    VkCommandBuffer                             commandBuffer,
...
void CommandTracker::TrackPostCmdSetRasterizerDiscardEnable(
    VkCommandBuffer                             commandBuffer,
    VkBool32                                    rasterizerDiscardEnable) {
  assert(commands_.back().type == Command::Type::kCmdSetRasterizerDiscardEnable);
}

void CommandTracker::TrackPreCmdSetDepthBiasEnable(
    VkCommandBuffer                             commandBuffer,
...
void CommandTracker::TrackPostCmdSetDepthBiasEnable(
    VkCommandBuffer                             commandBuffer,
    VkBool32                                    depthBiasEnable) {
  assert(commands_.back().type == Command::Type::kCmdSetDepthBiasEnable);
}

void CommandTracker::TrackPreCmdSetPrimitiveRestartEnable(
    VkCommandBuffer                             commandBuffer,
...
void CommandTracker::TrackPostCmdSetPrimitiveRestartEnable(
    VkCommandBuffer                             commandBuffer,
    VkBool32                                    primitiveRestartEnable) {
  assert(commands_.back().type == Command::Type::kCmdSetPrimitiveRestartEnable);
}

void CommandTracker::TrackPreCmdBeginVideoCodingKHR(
    VkCommandBuffer                             commandBuffer,
...
void CommandTracker::TrackPostCmdBeginVideoCodingKHR(
    VkCommandBuffer                             commandBuffer,
    const VkVideoBeginCodingInfoKHR*            pBeginInfo) {
  assert(commands_.back().type == Command::Type::kCmdBeginVideoCodingKHR);
}

void CommandTracker::TrackPreCmdEndVideoCodingKHR(
    VkCommandBuffer                             commandBuffer,
...
void CommandTracker::TrackPostCmdEndVideoCodingKHR(
    VkCommandBuffer                             commandBuffer,
    const VkVideoEndCodingInfoKHR*              pEndCodingInfo) {
  assert(commands_.back().type == Command::Type::kCmdEndVideoCodingKHR);
}

void CommandTracker::TrackPreCmdControlVideoCodingKHR(
    VkCommandBuffer                             commandBuffer,
...
void CommandTracker::TrackPostCmdControlVideoCodingKHR(
    VkCommandBuffer                             commandBuffer,
    const VkVideoCodingControlInfoKHR*          pCodingControlInfo) {
  assert(commands_.back().type == Command::Type::kCmdControlVideoCodingKHR);
}

void CommandTracker::TrackPreCmdDecodeVideoKHR(
    VkCommandBuffer                             commandBuffer,
...
void CommandTracker::TrackPostCmdDecodeVideoKHR(
    VkCommandBuffer                             commandBuffer,
    const VkVideoDecodeInfoKHR*                 pDecodeInfo) {
  assert(commands_.back().type == Command::Type::kCmdDecodeVideoKHR);
}

void CommandTracker::TrackPreCmdBeginRenderingKHR(
    VkCommandBuffer                             commandBuffer,
    const VkRenderingInfo*                      pRenderingInfo) {
  Command cmd {};
...
void CommandTracker::TrackPostCmdBeginRenderingKHR(
    VkCommandBuffer                             commandBuffer,
    const VkRenderingInfo*                      pRenderingInfo) {
  assert(commands_.back().type == Command::Type::kCmdBeginRenderingKHR);
}

void CommandTracker::TrackPreCmdEndRenderingKHR(
    VkCommandBuffer                             commandBuffer) {
  Command cmd {};
...
void CommandTracker::TrackPostCmdEndRenderingKHR(
    VkCommandBuffer                             commandBuffer) {
  assert(commands_.back().type == Command::Type::kCmdEndRenderingKHR);
}

void CommandTracker::TrackPreCmdSetDeviceMaskKHR(
    VkCommandBuffer                             commandBuffer,
    uint32_t                                    deviceMask) {
  Command cmd {};
...
void CommandTracker::TrackPostCmdSetDeviceMaskKHR(
    VkCommandBuffer                             commandBuffer,
    uint32_t                                    deviceMask) {
  assert(commands_.back().type == Command::Type::kCmdSetDeviceMaskKHR);
}

void CommandTracker::TrackPreCmdDispatchBaseKHR(
    VkCommandBuffer                             commandBuffer,
    uint32_t                                    baseGroupX,
    uint32_t                                    baseGroupY,
    uint32_t                                    baseGroupZ,
...
void CommandTracker::TrackPostCmdDispatchBaseKHR(
    VkCommandBuffer                             commandBuffer,
    uint32_t                                    baseGroupX,
    uint32_t                                    baseGroupY,
    uint32_t                                    baseGroupZ,
...
void CommandTracker::TrackPreCmdPushDescriptorSetKHR(
    VkCommandBuffer                             commandBuffer,
    VkPipelineBindPoint                         pipelineBindPoint,
    VkPipelineLayout                            layout,
    uint32_t                                    set,
...
void CommandTracker::TrackPostCmdPushDescriptorSetKHR(
    VkCommandBuffer                             commandBuffer,
    VkPipelineBindPoint                         pipelineBindPoint,
    VkPipelineLayout                            layout,
    uint32_t                                    set,
...
void CommandTracker::TrackPreCmdPushDescriptorSetWithTemplateKHR(
    VkCommandBuffer                             commandBuffer,
...
void CommandTracker::TrackPostCmdPushDescriptorSetWithTemplateKHR(
    VkCommandBuffer                             commandBuffer,
    VkDescriptorUpdateTemplate                  descriptorUpdateTemplate,
    VkPipelineLayout                            layout,
    uint32_t                                    set,
...
void CommandTracker::TrackPreCmdBeginRenderPass2KHR(
    VkCommandBuffer                             commandBuffer,
    const VkRenderPassBeginInfo*                pRenderPassBegin,
    const VkSubpassBeginInfo*                   pSubpassBeginInfo) {
  Command cmd {};
...
void CommandTracker::TrackPostCmdBeginRenderPass2KHR(
    VkCommandBuffer                             commandBuffer,
    const VkRenderPassBeginInfo*                pRenderPassBegin,
    const VkSubpassBeginInfo*                   pSubpassBeginInfo) {
...
void CommandTracker::TrackPreCmdNextSubpass2KHR(
    VkCommandBuffer                             commandBuffer,
    const VkSubpassBeginInfo*                   pSubpassBeginInfo,
    const VkSubpassEndInfo*                     pSubpassEndInfo) {
  Command cmd {};
...
void CommandTracker::TrackPostCmdNextSubpass2KHR(
    VkCommandBuffer                             commandBuffer,
    const VkSubpassBeginInfo*                   pSubpassBeginInfo,
    const VkSubpassEndInfo*                     pSubpassEndInfo) {
...
void CommandTracker::TrackPreCmdEndRenderPass2KHR(
    VkCommandBuffer                             commandBuffer,
    const VkSubpassEndInfo*                     pSubpassEndInfo) {
  Command cmd {};
...
void CommandTracker::TrackPostCmdEndRenderPass2KHR(
    VkCommandBuffer                             commandBuffer,
    const VkSubpassEndInfo*                     pSubpassEndInfo) {
  assert(commands_.back().type == Command::Type::kCmdEndRenderPass2KHR);
}

void CommandTracker::TrackPreCmdDrawIndirectCountKHR(
    VkCommandBuffer                             commandBuffer,
    VkBuffer                                    buffer,
    VkDeviceSize                                offset,
    VkBuffer                                    countBuffer,
...
void CommandTracker::TrackPostCmdDrawIndirectCountKHR(
    VkCommandBuffer                             commandBuffer,
    VkBuffer                                    buffer,
    VkDeviceSize                                offset,
    VkBuffer                                    countBuffer,
...
void CommandTracker::TrackPreCmdDrawIndexedIndirectCountKHR(
    VkCommandBuffer                             commandBuffer,
    VkBuffer                                    buffer,
    VkDeviceSize                                offset,
    VkBuffer                                    countBuffer,
...
void CommandTracker::TrackPostCmdDrawIndexedIndirectCountKHR(
    VkCommandBuffer                             commandBuffer,
    VkBuffer                                    buffer,
    VkDeviceSize                                offset,
    VkBuffer                                    countBuffer,
...
void CommandTracker::TrackPreCmdSetFragmentShadingRateKHR(
    VkCommandBuffer                             commandBuffer,
...
void CommandTracker::TrackPostCmdSetFragmentShadingRateKHR(
    VkCommandBuffer                             commandBuffer,
    const VkExtent2D*                           pFragmentSize,
    const VkFragmentShadingRateCombinerOpKHR    combinerOps[2]) {
...
void CommandTracker::TrackPostCmdEncodeVideoKHR(
    VkCommandBuffer                             commandBuffer,
    const VkVideoEncodeInfoKHR*                 pEncodeInfo) {
...
void CommandTracker::TrackPostCmdSetEvent2KHR(
    VkCommandBuffer                             commandBuffer,
    VkEvent                                     event,
    const VkDependencyInfo*                     pDependencyInfo) {
...
void CommandTracker::TrackPreCmdResetEvent2KHR(
    VkCommandBuffer                             commandBuffer,
    VkEvent                                     event,
    VkPipelineStageFlags2                       stageMask) {
  Command cmd {};
...
void CommandTracker::TrackPostCmdResetEvent2KHR(
    VkCommandBuffer                             commandBuffer,
    VkEvent                                     event,
    VkPipelineStageFlags2                       stageMask) {
...
void CommandTracker::TrackPreCmdWaitEvents2KHR(
    VkCommandBuffer                             commandBuffer,
    uint32_t                                    eventCount,
    const VkEvent*                              pEvents,
    const VkDependencyInfo*                     pDependencyInfos) {
...
void CommandTracker::TrackPostCmdWaitEvents2KHR(
    VkCommandBuffer                             commandBuffer,
    uint32_t                                    eventCount,
    const VkEvent*                              pEvents,
    const VkDependencyInfo*                     pDependencyInfos) {
...
void CommandTracker::TrackPreCmdPipelineBarrier2KHR(
    VkCommandBuffer                             commandBuffer,
    const VkDependencyInfo*                     pDependencyInfo) {
  Command cmd {};
...
void CommandTracker::TrackPostCmdPipelineBarrier2KHR(
    VkCommandBuffer                             commandBuffer,
    const VkDependencyInfo*                     pDependencyInfo) {
  assert(commands_.back().type == Command::Type::kCmdPipelineBarrier2KHR);
}

void CommandTracker::TrackPreCmdWriteTimestamp2KHR(
    VkCommandBuffer                             commandBuffer,
    VkPipelineStageFlags2                       stage,
    VkQueryPool                                 queryPool,
    uint32_t                                    query) {
...
void CommandTracker::TrackPostCmdWriteTimestamp2KHR(
    VkCommandBuffer                             commandBuffer,
    VkPipelineStageFlags2                       stage,
    VkQueryPool                                 queryPool,
    uint32_t                                    query) {
...
void CommandTracker::TrackPreCmdWriteBufferMarker2AMD(
    VkCommandBuffer                             commandBuffer,
    VkPipelineStageFlags2                       stage,
    VkBuffer                                    dstBuffer,
    VkDeviceSize                                dstOffset,
...
void CommandTracker::TrackPostCmdWriteBufferMarker2AMD(
    VkCommandBuffer                             commandBuffer,
    VkPipelineStageFlags2                       stage,
    VkBuffer                                    dstBuffer,
    VkDeviceSize                                dstOffset,
...
void CommandTracker::TrackPreCmdCopyBuffer2KHR(
    VkCommandBuffer                             commandBuffer,
    const VkCopyBufferInfo2*                    pCopyBufferInfo) {
  Command cmd {};
...
void CommandTracker::TrackPostCmdCopyBuffer2KHR(
    VkCommandBuffer                             commandBuffer,
    const VkCopyBufferInfo2*                    pCopyBufferInfo) {
  assert(commands_.back().type == Command::Type::kCmdCopyBuffer2KHR);
}

void CommandTracker::TrackPreCmdCopyImage2KHR(
    VkCommandBuffer                             commandBuffer,
    const VkCopyImageInfo2*                     pCopyImageInfo) {
  Command cmd {};
...
void CommandTracker::TrackPostCmdCopyImage2KHR(
    VkCommandBuffer                             commandBuffer,
    const VkCopyImageInfo2*                     pCopyImageInfo) {
  assert(commands_.back().type == Command::Type::kCmdCopyImage2KHR);
}

void CommandTracker::TrackPreCmdCopyBufferToImage2KHR(
    VkCommandBuffer                             commandBuffer,
    const VkCopyBufferToImageInfo2*             pCopyBufferToImageInfo) {
  Command cmd {};
...
void CommandTracker::TrackPostCmdCopyBufferToImage2KHR(
    VkCommandBuffer                             commandBuffer,
    const VkCopyBufferToImageInfo2*             pCopyBufferToImageInfo) {
  assert(commands_.back().type == Command::Type::kCmdCopyBufferToImage2KHR);
}

void CommandTracker::TrackPreCmdCopyImageToBuffer2KHR(
    VkCommandBuffer                             commandBuffer,
    const VkCopyImageToBufferInfo2*             pCopyImageToBufferInfo) {
  Command cmd {};
...
void CommandTracker::TrackPostCmdCopyImageToBuffer2KHR(
    VkCommandBuffer                             commandBuffer,
    const VkCopyImageToBufferInfo2*             pCopyImageToBufferInfo) {
  assert(commands_.back().type == Command::Type::kCmdCopyImageToBuffer2KHR);
}

void CommandTracker::TrackPreCmdBlitImage2KHR(
    VkCommandBuffer                             commandBuffer,
    const VkBlitImageInfo2*                     pBlitImageInfo) {
  Command cmd {};
...
void CommandTracker::TrackPostCmdBlitImage2KHR(
    VkCommandBuffer                             commandBuffer,
    const VkBlitImageInfo2*                     pBlitImageInfo) {
  assert(commands_.back().type == Command::Type::kCmdBlitImage2KHR);
}

void CommandTracker::TrackPreCmdResolveImage2KHR(
    VkCommandBuffer                             commandBuffer,
    const VkResolveImageInfo2*                  pResolveImageInfo) {
  Command cmd {};
...
void CommandTracker::TrackPostCmdResolveImage2KHR(
    VkCommandBuffer                             commandBuffer,
    const VkResolveImageInfo2*                  pResolveImageInfo) {
  assert(commands_.back().type == Command::Type::kCmdResolveImage2KHR);
}

void CommandTracker::TrackPreCmdTraceRaysIndirect2KHR(
    VkCommandBuffer                             commandBuffer,
...
void CommandTracker::TrackPostCmdTraceRaysIndirect2KHR(
    VkCommandBuffer                             commandBuffer,
    VkDeviceAddress                             indirectDeviceAddress) {
...
void CommandTracker::TrackPostCmdDebugMarkerBeginEXT(
    VkCommandBuffer                             commandBuffer,
    const VkDebugMarkerMarkerInfoEXT*           pMarkerInfo) {
  assert(commands_.back().type == Command::Type::kCmdDebugMarkerBeginEXT);
}

void CommandTracker::TrackPreCmdDebugMarkerEndEXT(
    VkCommandBuffer                             commandBuffer) {
  Command cmd {};
...
void CommandTracker::TrackPostCmdDebugMarkerEndEXT(
    VkCommandBuffer                             commandBuffer) {
  assert(commands_.back().type == Command::Type::kCmdDebugMarkerEndEXT);
}

void CommandTracker::TrackPreCmdDebugMarkerInsertEXT(
    VkCommandBuffer                             commandBuffer,
    const VkDebugMarkerMarkerInfoEXT*           pMarkerInfo) {
  Command cmd {};
...
void CommandTracker::TrackPostCmdDebugMarkerInsertEXT(
    VkCommandBuffer                             commandBuffer,
    const VkDebugMarkerMarkerInfoEXT*           pMarkerInfo) {
  assert(commands_.back().type == Command::Type::kCmdDebugMarkerInsertEXT);
}

void CommandTracker::TrackPreCmdBindTransformFeedbackBuffersEXT(
    VkCommandBuffer                             commandBuffer,
    uint32_t                                    firstBinding,
    uint32_t                                    bindingCount,
    const VkBuffer*                             pBuffers,
  ...
  cmd.id = static_cast<uint32_t>(commands_.size()) + 1;
  cmd.parameters = recorder_.RecordCmdBindTransformFeedbackBuffersEXT(commandBuffer, firstBinding, bindingCount, pBuffers, pOffsets, pSizes);
  commands_.push_back(cmd);
}
void CommandTracker::TrackPostCmdBindTransformFeedbackBuffersEXT(
    VkCommandBuffer                             commandBuffer,
    uint32_t                                    firstBinding,
    uint32_t                                    bindingCount,
    const VkBuffer*                             pBuffers,
...
void CommandTracker::TrackPreCmdBeginTransformFeedbackEXT(
    VkCommandBuffer                             commandBuffer,
  ...
  cmd.id = static_cast<uint32_t>(commands_.size()) + 1;
  cmd.parameters = recorder_.RecordCmdBeginTransformFeedbackEXT(commandBuffer, firstCounterBuffer, counterBufferCount, pCounterBuffers, pCounterBufferOffsets);
  commands_.push_back(cmd);
}
void CommandTracker::TrackPostCmdBeginTransformFeedbackEXT(
    VkCommandBuffer                             commandBuffer,
    uint32_t                                    firstCounterBuffer,
    uint32_t                                    counterBufferCount,
    const VkBuffer*                             pCounterBuffers,
...
void CommandTracker::TrackPreCmdEndTransformFeedbackEXT(
    VkCommandBuffer                             commandBuffer,
    uint32_t                                    firstCounterBuffer,
    uint32_t                                    counterBufferCount,
    const VkBuffer*                             pCounterBuffers,
  ...
  cmd.id = static_cast<uint32_t>(commands_.size()) + 1;
  cmd.parameters = recorder_.RecordCmdEndTransformFeedbackEXT(commandBuffer, firstCounterBuffer, counterBufferCount, pCounterBuffers, pCounterBufferOffsets);
  commands_.push_back(cmd);
}
void CommandTracker::TrackPostCmdEndTransformFeedbackEXT(
    VkCommandBuffer                             commandBuffer,
    uint32_t                                    firstCounterBuffer,
    uint32_t                                    counterBufferCount,
    const VkBuffer*                             pCounterBuffers,
...
void CommandTracker::TrackPreCmdBeginQueryIndexedEXT(
    VkCommandBuffer                             commandBuffer,
    VkQueryPool                                 queryPool,
    uint32_t                                    query,
    VkQueryControlFlags                         flags,
...
void CommandTracker::TrackPostCmdBeginQueryIndexedEXT(
    VkCommandBuffer                             commandBuffer,
    VkQueryPool                                 queryPool,
    uint32_t                                    query,
    VkQueryControlFlags                         flags,
...
void CommandTracker::TrackPreCmdEndQueryIndexedEXT(
    VkCommandBuffer                             commandBuffer,
    VkQueryPool                                 queryPool,
    uint32_t                                    query,
    uint32_t                                    index) {
...
void CommandTracker::TrackPostCmdEndQueryIndexedEXT(
    VkCommandBuffer                             commandBuffer,
    VkQueryPool                                 queryPool,
    uint32_t                                    query,
    uint32_t                                    index) {
...
void CommandTracker::TrackPreCmdDrawIndirectByteCountEXT(
    VkCommandBuffer                             commandBuffer,
    uint32_t                                    instanceCount,
    uint32_t                                    firstInstance,
  ...
  cmd.id = static_cast<uint32_t>(commands_.size()) + 1;
  cmd.parameters = recorder_.RecordCmdDrawIndirectByteCountEXT(commandBuffer, instanceCount, firstInstance, counterBuffer, counterBufferOffset, counterOffset, vertexStride);
  commands_.push_back(cmd);
}
void CommandTracker::TrackPostCmdDrawIndirectByteCountEXT(
    VkCommandBuffer                             commandBuffer,
    uint32_t                                    instanceCount,
    uint32_t                                    firstInstance,
    VkBuffer                                    counterBuffer,
...
void CommandTracker::TrackPreCmdCuLaunchKernelNVX(
    VkCommandBuffer                             commandBuffer,
...
void CommandTracker::TrackPostCmdCuLaunchKernelNVX(
    VkCommandBuffer                             commandBuffer,
    const VkCuLaunchInfoNVX*                    pLaunchInfo) {
  assert(commands_.back().type == Command::Type::kCmdCuLaunchKernelNVX);
}

void CommandTracker::TrackPreCmdDrawIndirectCountAMD(
    VkCommandBuffer                             commandBuffer,
    VkBuffer                                    buffer,
    VkDeviceSize                                offset,
    VkBuffer                                    countBuffer,
...
void CommandTracker::TrackPostCmdDrawIndirectCountAMD(
    VkCommandBuffer                             commandBuffer,
    VkBuffer                                    buffer,
    VkDeviceSize                                offset,
    VkBuffer                                    countBuffer,
...
void CommandTracker::TrackPreCmdDrawIndexedIndirectCountAMD(
    VkCommandBuffer                             commandBuffer,
    VkBuffer                                    buffer,
    VkDeviceSize                                offset,
    VkBuffer                                    countBuffer,
...
void CommandTracker::TrackPostCmdDrawIndexedIndirectCountAMD(
    VkCommandBuffer                             commandBuffer,
    VkBuffer                                    buffer,
    VkDeviceSize                                offset,
    VkBuffer                                    countBuffer,
...
void CommandTracker::TrackPreCmdEndConditionalRenderingEXT(
    VkCommandBuffer                             commandBuffer) {
  Command cmd {};
...
void CommandTracker::TrackPostCmdEndConditionalRenderingEXT(
    VkCommandBuffer                             commandBuffer) {
  assert(commands_.back().type == Command::Type::kCmdEndConditionalRenderingEXT);
}

void CommandTracker::TrackPreCmdSetViewportWScalingNV(
    VkCommandBuffer                             commandBuffer,
    uint32_t                                    firstViewport,
    uint32_t                                    viewportCount,
  ...
  cmd.id = static_cast<uint32_t>(commands_.size()) + 1;
  cmd.parameters = recorder_.RecordCmdSetViewportWScalingNV(commandBuffer, firstViewport, viewportCount, pViewportWScalings);
  commands_.push_back(cmd);
}
void CommandTracker::TrackPostCmdSetViewportWScalingNV(
    VkCommandBuffer                             commandBuffer,
    uint32_t                                    firstViewport,
    uint32_t                                    viewportCount,
    const VkViewportWScalingNV*                 pViewportWScalings) {
...
void CommandTracker::TrackPreCmdSetDiscardRectangleEXT(
    VkCommandBuffer                             commandBuffer,
  ...
  cmd.id = static_cast<uint32_t>(commands_.size()) + 1;
  cmd.parameters = recorder_.RecordCmdSetDiscardRectangleEXT(commandBuffer, firstDiscardRectangle, discardRectangleCount, pDiscardRectangles);
  commands_.push_back(cmd);
}
void CommandTracker::TrackPostCmdSetDiscardRectangleEXT(
    VkCommandBuffer                             commandBuffer,
    uint32_t                                    firstDiscardRectangle,
    uint32_t                                    discardRectangleCount,
    const VkRect2D*                             pDiscardRectangles) {
...
void CommandTracker::TrackPreCmdSetDiscardRectangleEnableEXT(
    VkCommandBuffer                             commandBuffer,
...
void CommandTracker::TrackPostCmdSetDiscardRectangleEnableEXT(
    VkCommandBuffer                             commandBuffer,
    VkBool32                                    discardRectangleEnable) {
  assert(commands_.back().type == Command::Type::kCmdSetDiscardRectangleEnableEXT);
}

void CommandTracker::TrackPreCmdSetDiscardRectangleModeEXT(
    VkCommandBuffer                             commandBuffer,
...
void CommandTracker::TrackPostCmdSetDiscardRectangleModeEXT(
    VkCommandBuffer                             commandBuffer,
    VkDiscardRectangleModeEXT                   discardRectangleMode) {
  assert(commands_.back().type == Command::Type::kCmdSetDiscardRectangleModeEXT);
}

void CommandTracker::TrackPreCmdBeginDebugUtilsLabelEXT(
    VkCommandBuffer                             commandBuffer,
...
void CommandTracker::TrackPostCmdBeginDebugUtilsLabelEXT(
    VkCommandBuffer                             commandBuffer,
    const VkDebugUtilsLabelEXT*                 pLabelInfo) {
  assert(commands_.back().type == Command::Type::kCmdBeginDebugUtilsLabelEXT);
}

void CommandTracker::TrackPreCmdEndDebugUtilsLabelEXT(
    VkCommandBuffer                             commandBuffer) {
  Command cmd {};
...
void CommandTracker::TrackPostCmdEndDebugUtilsLabelEXT(
    VkCommandBuffer                             commandBuffer) {
  assert(commands_.back().type == Command::Type::kCmdEndDebugUtilsLabelEXT);
}

void CommandTracker::TrackPreCmdInsertDebugUtilsLabelEXT(
    VkCommandBuffer                             commandBuffer,
    const VkDebugUtilsLabelEXT*                 pLabelInfo) {
  Command cmd {};
...
void CommandTracker::TrackPostCmdInsertDebugUtilsLabelEXT(
    VkCommandBuffer                             commandBuffer,
    const VkDebugUtilsLabelEXT*                 pLabelInfo) {
...
void CommandTracker::TrackPostCmdSetSampleLocationsEXT(
    VkCommandBuffer                             commandBuffer,
    const VkSampleLocationsInfoEXT*             pSampleLocationsInfo) {
  assert(commands_.back().type == Command::Type::kCmdSetSampleLocationsEXT);
}

void CommandTracker::TrackPreCmdBindShadingRateImageNV(
    VkCommandBuffer                             commandBuffer,
...
void CommandTracker::TrackPostCmdBindShadingRateImageNV(
    VkCommandBuffer                             commandBuffer,
    VkImageView                                 imageView,
    VkImageLayout                               imageLayout) {
...
void CommandTracker::TrackPreCmdSetViewportShadingRatePaletteNV(
    VkCommandBuffer                             commandBuffer,
    uint32_t                                    firstViewport,
    uint32_t                                    viewportCount,
  ...
  cmd.id = static_cast<uint32_t>(commands_.size()) + 1;
  cmd.parameters = recorder_.RecordCmdSetViewportShadingRatePaletteNV(commandBuffer, firstViewport, viewportCount, pShadingRatePalettes);
  commands_.push_back(cmd);
}
void CommandTracker::TrackPostCmdSetViewportShadingRatePaletteNV(
    VkCommandBuffer                             commandBuffer,
    uint32_t                                    firstViewport,
    uint32_t                                    viewportCount,
    const VkShadingRatePaletteNV*               pShadingRatePalettes) {
...
void CommandTracker::TrackPreCmdSetCoarseSampleOrderNV(
    VkCommandBuffer                             commandBuffer,
  ...
  cmd.id = static_cast<uint32_t>(commands_.size()) + 1;
  cmd.parameters = recorder_.RecordCmdSetCoarseSampleOrderNV(commandBuffer, sampleOrderType, customSampleOrderCount, pCustomSampleOrders);
  commands_.push_back(cmd);
}
void CommandTracker::TrackPostCmdSetCoarseSampleOrderNV(
    VkCommandBuffer                             commandBuffer,
    VkCoarseSampleOrderTypeNV                   sampleOrderType,
    uint32_t                                    customSampleOrderCount,
    const VkCoarseSampleOrderCustomNV*          pCustomSampleOrders) {
...
void CommandTracker::TrackPreCmdBuildAccelerationStructureNV(
    VkCommandBuffer                             commandBuffer,
  ...
  cmd.id = static_cast<uint32_t>(commands_.size()) + 1;
  cmd.parameters = recorder_.RecordCmdBuildAccelerationStructureNV(commandBuffer, pInfo, instanceData, instanceOffset, update, dst, src, scratch, scratchOffset);
  commands_.push_back(cmd);
}
void CommandTracker::TrackPostCmdBuildAccelerationStructureNV(
    VkCommandBuffer                             commandBuffer,
    const VkAccelerationStructureInfoNV*        pInfo,
    VkBuffer                                    instanceData,
    VkDeviceSize                                instanceOffset,
...
void CommandTracker::TrackPreCmdCopyAccelerationStructureNV(
    VkCommandBuffer                             commandBuffer,
    VkAccelerationStructureNV                   dst,
    VkAccelerationStructureNV                   src,
...
void CommandTracker::TrackPostCmdCopyAccelerationStructureNV(
    VkCommandBuffer                             commandBuffer,
    VkAccelerationStructureNV                   dst,
    VkAccelerationStructureNV                   src,
    VkCopyAccelerationStructureModeKHR          mode) {
...
void CommandTracker::TrackPreCmdTraceRaysNV(
  ...
  cmd.id = static_cast<uint32_t>(commands_.size()) + 1;
  cmd.parameters = recorder_.RecordCmdTraceRaysNV(commandBuffer, raygenShaderBindingTableBuffer, raygenShaderBindingOffset, missShaderBindingTableBuffer, missShaderBindingOffset, missShaderBindingStride, hitShaderBindingTableBuffer, hitShaderBindingOffset, hitShaderBindingStride, callableShaderBindingTableBuffer, callableShaderBindingOffset, callableShaderBindingStride, width, height, depth);
  commands_.push_back(cmd);
}
...
void CommandTracker::TrackPreCmdWriteAccelerationStructuresPropertiesNV(
  ...
  cmd.id = static_cast<uint32_t>(commands_.size()) + 1;
  cmd.parameters = recorder_.RecordCmdWriteAccelerationStructuresPropertiesNV(commandBuffer, accelerationStructureCount, pAccelerationStructures, queryType, queryPool, firstQuery);
  commands_.push_back(cmd);
}
...
void CommandTracker::TrackPreCmdWriteBufferMarkerAMD(
    VkCommandBuffer                             commandBuffer,
    VkPipelineStageFlagBits                     pipelineStage,
    VkBuffer                                    dstBuffer,
    VkDeviceSize                                dstOffset,
...
void CommandTracker::TrackPostCmdWriteBufferMarkerAMD(
    VkCommandBuffer                             commandBuffer,
    VkPipelineStageFlagBits                     pipelineStage,
    VkBuffer                                    dstBuffer,
    VkDeviceSize                                dstOffset,
...
void CommandTracker::TrackPreCmdDrawMeshTasksNV(
    VkCommandBuffer                             commandBuffer,
    uint32_t                                    taskCount,
    uint32_t                                    firstTask) {
  Command cmd {};
...
void CommandTracker::TrackPostCmdDrawMeshTasksNV(
    VkCommandBuffer                             commandBuffer,
    uint32_t                                    taskCount,
    uint32_t                                    firstTask) {
...
void CommandTracker::TrackPreCmdDrawMeshTasksIndirectNV(
    VkCommandBuffer                             commandBuffer,
    VkBuffer                                    buffer,
    VkDeviceSize                                offset,
    uint32_t                                    drawCount,
...
void CommandTracker::TrackPostCmdDrawMeshTasksIndirectNV(
    VkCommandBuffer                             commandBuffer,
    VkBuffer                                    buffer,
    VkDeviceSize                                offset,
    uint32_t                                    drawCount,
...
void CommandTracker::TrackPreCmdDrawMeshTasksIndirectCountNV(
    VkCommandBuffer                             commandBuffer,
    VkBuffer                                    buffer,
    VkDeviceSize                                offset,
    VkBuffer                                    countBuffer,
  ...
  cmd.id = static_cast<uint32_t>(commands_.size()) + 1;
  cmd.parameters = recorder_.RecordCmdDrawMeshTasksIndirectCountNV(commandBuffer, buffer, offset, countBuffer, countBufferOffset, maxDrawCount, stride);
  commands_.push_back(cmd);
}
void CommandTracker::TrackPostCmdDrawMeshTasksIndirectCountNV(
    VkCommandBuffer                             commandBuffer,
    VkBuffer                                    buffer,
    VkDeviceSize                                offset,
    VkBuffer                                    countBuffer,
...
void CommandTracker::TrackPreCmdSetExclusiveScissorEnableNV(
    VkCommandBuffer                             commandBuffer,
  ...
  cmd.id = static_cast<uint32_t>(commands_.size()) + 1;
  cmd.parameters = recorder_.RecordCmdSetExclusiveScissorEnableNV(commandBuffer, firstExclusiveScissor, exclusiveScissorCount, pExclusiveScissorEnables);
  commands_.push_back(cmd);
}
void CommandTracker::TrackPostCmdSetExclusiveScissorEnableNV(
    VkCommandBuffer                             commandBuffer,
    uint32_t                                    firstExclusiveScissor,
    uint32_t                                    exclusiveScissorCount,
    const VkBool32*                             pExclusiveScissorEnables) {
...
void CommandTracker::TrackPreCmdSetExclusiveScissorNV(
    VkCommandBuffer                             commandBuffer,
    uint32_t                                    firstExclusiveScissor,
    uint32_t                                    exclusiveScissorCount,
  ...
  cmd.id = static_cast<uint32_t>(commands_.size()) + 1;
  cmd.parameters = recorder_.RecordCmdSetExclusiveScissorNV(commandBuffer, firstExclusiveScissor, exclusiveScissorCount, pExclusiveScissors);
  commands_.push_back(cmd);
}
void CommandTracker::TrackPostCmdSetExclusiveScissorNV(
    VkCommandBuffer                             commandBuffer,
    uint32_t                                    firstExclusiveScissor,
    uint32_t                                    exclusiveScissorCount,
    const VkRect2D*                             pExclusiveScissors) {
...
void CommandTracker::TrackPreCmdSetCheckpointNV(
    VkCommandBuffer                             commandBuffer,
...
void CommandTracker::TrackPostCmdSetCheckpointNV(
    VkCommandBuffer                             commandBuffer,
    const void*                                 pCheckpointMarker) {
  assert(commands_.back().type == Command::Type::kCmdSetCheckpointNV);
}

void CommandTracker::TrackPreCmdSetPerformanceMarkerINTEL(
    VkCommandBuffer                             commandBuffer,
...
void CommandTracker::TrackPostCmdSetPerformanceMarkerINTEL(
    VkCommandBuffer                             commandBuffer,
    const VkPerformanceMarkerInfoINTEL*         pMarkerInfo) {
  assert(commands_.back().type == Command::Type::kCmdSetPerformanceMarkerINTEL);
}

void CommandTracker::TrackPreCmdSetPerformanceStreamMarkerINTEL(
    VkCommandBuffer                             commandBuffer,
...
void CommandTracker::TrackPreCmdSetPerformanceOverrideINTEL(
    VkCommandBuffer                             commandBuffer,
...
void CommandTracker::TrackPostCmdSetPerformanceOverrideINTEL(
    VkCommandBuffer                             commandBuffer,
    const VkPerformanceOverrideInfoINTEL*       pOverrideInfo) {
  assert(commands_.back().type == Command::Type::kCmdSetPerformanceOverrideINTEL);
}

void CommandTracker::TrackPreCmdSetLineStippleEXT(
    VkCommandBuffer                             commandBuffer,
...
void CommandTracker::TrackPostCmdSetLineStippleEXT(
    VkCommandBuffer                             commandBuffer,
    uint32_t                                    lineStippleFactor,
    uint16_t                                    lineStipplePattern) {
...
void CommandTracker::TrackPreCmdSetCullModeEXT(
    VkCommandBuffer                             commandBuffer,
    VkCullModeFlags                             cullMode) {
  Command cmd {};
...
void CommandTracker::TrackPostCmdSetCullModeEXT(
    VkCommandBuffer                             commandBuffer,
    VkCullModeFlags                             cullMode) {
  assert(commands_.back().type == Command::Type::kCmdSetCullModeEXT);
}

void CommandTracker::TrackPreCmdSetFrontFaceEXT(
    VkCommandBuffer                             commandBuffer,
    VkFrontFace                                 frontFace) {
  Command cmd {};
...
void CommandTracker::TrackPostCmdSetFrontFaceEXT(
    VkCommandBuffer                             commandBuffer,
    VkFrontFace                                 frontFace) {
  assert(commands_.back().type == Command::Type::kCmdSetFrontFaceEXT);
}

void CommandTracker::TrackPreCmdSetPrimitiveTopologyEXT(
    VkCommandBuffer                             commandBuffer,
    VkPrimitiveTopology                         primitiveTopology) {
  Command cmd {};
...
void CommandTracker::TrackPostCmdSetPrimitiveTopologyEXT(
    VkCommandBuffer                             commandBuffer,
    VkPrimitiveTopology                         primitiveTopology) {
  assert(commands_.back().type == Command::Type::kCmdSetPrimitiveTopologyEXT);
}

void CommandTracker::TrackPreCmdSetViewportWithCountEXT(
    VkCommandBuffer                             commandBuffer,
    uint32_t                                    viewportCount,
    const VkViewport*                           pViewports) {
  Command cmd {};
...
void CommandTracker::TrackPostCmdSetViewportWithCountEXT(
    VkCommandBuffer                             commandBuffer,
    uint32_t                                    viewportCount,
    const VkViewport*                           pViewports) {
...
void CommandTracker::TrackPreCmdSetScissorWithCountEXT(
    VkCommandBuffer                             commandBuffer,
    uint32_t                                    scissorCount,
    const VkRect2D*                             pScissors) {
  Command cmd {};
...
void CommandTracker::TrackPostCmdSetScissorWithCountEXT(
    VkCommandBuffer                             commandBuffer,
    uint32_t                                    scissorCount,
    const VkRect2D*                             pScissors) {
...
void CommandTracker::TrackPreCmdBindVertexBuffers2EXT(
    VkCommandBuffer                             commandBuffer,
    uint32_t                                    firstBinding,
    uint32_t                                    bindingCount,
    const VkBuffer*                             pBuffers,
...
void CommandTracker::TrackPostCmdBindVertexBuffers2EXT(
    VkCommandBuffer                             commandBuffer,
    uint32_t                                    firstBinding,
    uint32_t                                    bindingCount,
    const VkBuffer*                             pBuffers,
...
void CommandTracker::TrackPreCmdSetDepthTestEnableEXT(
    VkCommandBuffer                             commandBuffer,
    VkBool32                                    depthTestEnable) {
  Command cmd {};
...
void CommandTracker::TrackPostCmdSetDepthTestEnableEXT(
    VkCommandBuffer                             commandBuffer,
    VkBool32                                    depthTestEnable) {
  assert(commands_.back().type == Command::Type::kCmdSetDepthTestEnableEXT);
}

void CommandTracker::TrackPreCmdSetDepthWriteEnableEXT(
    VkCommandBuffer                             commandBuffer,
    VkBool32                                    depthWriteEnable) {
  Command cmd {};
...
void CommandTracker::TrackPostCmdSetDepthWriteEnableEXT(
    VkCommandBuffer                             commandBuffer,
    VkBool32                                    depthWriteEnable) {
  assert(commands_.back().type == Command::Type::kCmdSetDepthWriteEnableEXT);
}

void CommandTracker::TrackPreCmdSetDepthCompareOpEXT(
    VkCommandBuffer                             commandBuffer,
    VkCompareOp                                 depthCompareOp) {
  Command cmd {};
...
void CommandTracker::TrackPostCmdSetDepthCompareOpEXT(
    VkCommandBuffer                             commandBuffer,
    VkCompareOp                                 depthCompareOp) {
  assert(commands_.back().type == Command::Type::kCmdSetDepthCompareOpEXT);
}

void CommandTracker::TrackPreCmdSetDepthBoundsTestEnableEXT(
    VkCommandBuffer                             commandBuffer,
    VkBool32                                    depthBoundsTestEnable) {
  Command cmd {};
...
void CommandTracker::TrackPostCmdSetDepthBoundsTestEnableEXT(
    VkCommandBuffer                             commandBuffer,
    VkBool32                                    depthBoundsTestEnable) {
  assert(commands_.back().type == Command::Type::kCmdSetDepthBoundsTestEnableEXT);
}

void CommandTracker::TrackPreCmdSetStencilTestEnableEXT(
    VkCommandBuffer                             commandBuffer,
    VkBool32                                    stencilTestEnable) {
  Command cmd {};
...
void CommandTracker::TrackPostCmdSetStencilTestEnableEXT(
    VkCommandBuffer                             commandBuffer,
    VkBool32                                    stencilTestEnable) {
  assert(commands_.back().type == Command::Type::kCmdSetStencilTestEnableEXT);
}

void CommandTracker::TrackPreCmdSetStencilOpEXT(
    VkCommandBuffer                             commandBuffer,
    VkStencilFaceFlags                          faceMask,
    VkStencilOp                                 failOp,
    VkStencilOp                                 passOp,
...
void CommandTracker::TrackPostCmdSetStencilOpEXT(
    VkCommandBuffer                             commandBuffer,
    VkStencilFaceFlags                          faceMask,
    VkStencilOp                                 failOp,
    VkStencilOp                                 passOp,
...
void CommandTracker::TrackPreCmdPreprocessGeneratedCommandsNV(
    VkCommandBuffer                             commandBuffer,
...
void CommandTracker::TrackPreCmdExecuteGeneratedCommandsNV(
    VkCommandBuffer                             commandBuffer,
  ...
  cmd.id = static_cast<uint32_t>(commands_.size()) + 1;
  cmd.parameters = recorder_.RecordCmdExecuteGeneratedCommandsNV(commandBuffer, isPreprocessed, pGeneratedCommandsInfo);
  commands_.push_back(cmd);
}
void CommandTracker::TrackPostCmdExecuteGeneratedCommandsNV(
    VkCommandBuffer                             commandBuffer,
    VkBool32                                    isPreprocessed,
    const VkGeneratedCommandsInfoNV*            pGeneratedCommandsInfo) {
...
void CommandTracker::TrackPreCmdBindPipelineShaderGroupNV(
    VkCommandBuffer                             commandBuffer,
    VkPipelineBindPoint                         pipelineBindPoint,
    VkPipeline                                  pipeline,
    uint32_t                                    groupIndex) {
  ...
  cmd.id = static_cast<uint32_t>(commands_.size()) + 1;
  cmd.parameters = recorder_.RecordCmdBindPipelineShaderGroupNV(commandBuffer, pipelineBindPoint, pipeline, groupIndex);
  commands_.push_back(cmd);
}
void CommandTracker::TrackPostCmdBindPipelineShaderGroupNV(
    VkCommandBuffer                             commandBuffer,
    VkPipelineBindPoint                         pipelineBindPoint,
    VkPipeline                                  pipeline,
    uint32_t                                    groupIndex) {
...
void CommandTracker::TrackPreCmdSetDepthBias2EXT(
    VkCommandBuffer                             commandBuffer,
...
void CommandTracker::TrackPostCmdSetDepthBias2EXT(
    VkCommandBuffer                             commandBuffer,
    const VkDepthBiasInfoEXT*                   pDepthBiasInfo) {
...
void CommandTracker::TrackPostCmdBindDescriptorBuffersEXT(
    VkCommandBuffer                             commandBuffer,
    uint32_t                                    bufferCount,
    const VkDescriptorBufferBindingInfoEXT*     pBindingInfos) {
...
void CommandTracker::TrackPreCmdSetDescriptorBufferOffsetsEXT(
    VkCommandBuffer                             commandBuffer,
    VkPipelineBindPoint                         pipelineBindPoint,
    VkPipelineLayout                            layout,
    uint32_t                                    firstSet,
  ...
  cmd.id = static_cast<uint32_t>(commands_.size()) + 1;
  cmd.parameters = recorder_.RecordCmdSetDescriptorBufferOffsetsEXT(commandBuffer, pipelineBindPoint, layout, firstSet, setCount, pBufferIndices, pOffsets);
  commands_.push_back(cmd);
}
void CommandTracker::TrackPostCmdSetDescriptorBufferOffsetsEXT(
    VkCommandBuffer                             commandBuffer,
    VkPipelineBindPoint                         pipelineBindPoint,
    VkPipelineLayout                            layout,
    uint32_t                                    firstSet,
...
void CommandTracker::TrackPreCmdBindDescriptorBufferEmbeddedSamplersEXT(
    VkCommandBuffer                             commandBuffer,
    VkPipelineBindPoint                         pipelineBindPoint,
    VkPipelineLayout                            layout,
    uint32_t                                    set) {
  ...
  cmd.id = static_cast<uint32_t>(commands_.size()) + 1;
  cmd.parameters = recorder_.RecordCmdBindDescriptorBufferEmbeddedSamplersEXT(commandBuffer, pipelineBindPoint, layout, set);
  commands_.push_back(cmd);
}
void CommandTracker::TrackPostCmdBindDescriptorBufferEmbeddedSamplersEXT(
    VkCommandBuffer                             commandBuffer,
    VkPipelineBindPoint                         pipelineBindPoint,
    VkPipelineLayout                            layout,
    uint32_t                                    set) {
...
void CommandTracker::TrackPreCmdSetFragmentShadingRateEnumNV(
    VkCommandBuffer                             commandBuffer,
...
void CommandTracker::TrackPostCmdSetFragmentShadingRateEnumNV(
    VkCommandBuffer                             commandBuffer,
    VkFragmentShadingRateNV                     shadingRate,
    const VkFragmentShadingRateCombinerOpKHR    combinerOps[2]) {
...
void CommandTracker::TrackPreCmdSubpassShadingHUAWEI(
    VkCommandBuffer                             commandBuffer) {
  Command cmd {};
...
void CommandTracker::TrackPostCmdSubpassShadingHUAWEI(
    VkCommandBuffer                             commandBuffer) {
  assert(commands_.back().type == Command::Type::kCmdSubpassShadingHUAWEI);
}

void CommandTracker::TrackPreCmdBindInvocationMaskHUAWEI(
    VkCommandBuffer                             commandBuffer,
    VkImageView                                 imageView,
    VkImageLayout                               imageLayout) {
  Command cmd {};
...
void CommandTracker::TrackPostCmdBindInvocationMaskHUAWEI(
    VkCommandBuffer                             commandBuffer,
    VkImageView                                 imageView,
    VkImageLayout                               imageLayout) {
...
void CommandTracker::TrackPreCmdSetPatchControlPointsEXT(
    VkCommandBuffer                             commandBuffer,
...
void CommandTracker::TrackPostCmdSetPatchControlPointsEXT(
    VkCommandBuffer                             commandBuffer,
    uint32_t                                    patchControlPoints) {
  assert(commands_.back().type == Command::Type::kCmdSetPatchControlPointsEXT);
}

void CommandTracker::TrackPreCmdSetRasterizerDiscardEnableEXT(
    VkCommandBuffer                             commandBuffer,
    VkBool32                                    rasterizerDiscardEnable) {
  Command cmd {};
...
void CommandTracker::TrackPostCmdSetRasterizerDiscardEnableEXT(
    VkCommandBuffer                             commandBuffer,
    VkBool32                                    rasterizerDiscardEnable) {
  assert(commands_.back().type == Command::Type::kCmdSetRasterizerDiscardEnableEXT);
}

void CommandTracker::TrackPreCmdSetDepthBiasEnableEXT(
    VkCommandBuffer                             commandBuffer,
    VkBool32                                    depthBiasEnable) {
  Command cmd {};
...
void CommandTracker::TrackPostCmdSetDepthBiasEnableEXT(
    VkCommandBuffer                             commandBuffer,
    VkBool32                                    depthBiasEnable) {
  assert(commands_.back().type == Command::Type::kCmdSetDepthBiasEnableEXT);
}

void CommandTracker::TrackPreCmdSetLogicOpEXT(
    VkCommandBuffer                             commandBuffer,
    VkLogicOp                                   logicOp) {
  Command cmd {};
...
void CommandTracker::TrackPostCmdSetLogicOpEXT(
    VkCommandBuffer                             commandBuffer,
    VkLogicOp                                   logicOp) {
  assert(commands_.back().type == Command::Type::kCmdSetLogicOpEXT);
}

void CommandTracker::TrackPreCmdSetPrimitiveRestartEnableEXT(
    VkCommandBuffer                             commandBuffer,
    VkBool32                                    primitiveRestartEnable) {
  Command cmd {};
...
void CommandTracker::TrackPostCmdSetPrimitiveRestartEnableEXT(
    VkCommandBuffer                             commandBuffer,
    VkBool32                                    primitiveRestartEnable) {
  assert(commands_.back().type == Command::Type::kCmdSetPrimitiveRestartEnableEXT);
}

void                                    CommandTracker::TrackPreCmdSetColorWriteEnableEXT(
    VkCommandBuffer                             commandBuffer,
    uint32_t                                    attachmentCount,
...
void                                    CommandTracker::TrackPostCmdSetColorWriteEnableEXT(
    VkCommandBuffer                             commandBuffer,
    uint32_t                                    attachmentCount,
    const VkBool32*                             pColorWriteEnables) {
...
void CommandTracker::TrackPreCmdDrawMultiEXT(
    VkCommandBuffer                             commandBuffer,
    uint32_t                                    drawCount,
...
void CommandTracker::TrackPostCmdDrawMultiEXT(
    VkCommandBuffer                             commandBuffer,
    uint32_t                                    drawCount,
    const VkMultiDrawInfoEXT*                   pVertexInfo,
    uint32_t                                    instanceCount,
...
void CommandTracker::TrackPreCmdDrawMultiIndexedEXT(
    VkCommandBuffer                             commandBuffer,
    uint32_t                                    drawCount,
...
void CommandTracker::TrackPostCmdDrawMultiIndexedEXT(
    VkCommandBuffer                             commandBuffer,
    uint32_t                                    drawCount,
    const VkMultiDrawIndexedInfoEXT*            pIndexInfo,
    uint32_t                                    instanceCount,
...
void CommandTracker::TrackPreCmdBuildMicromapsEXT(
    VkCommandBuffer                             commandBuffer,
    uint32_t                                    infoCount,
...
void CommandTracker::TrackPostCmdBuildMicromapsEXT(
    VkCommandBuffer                             commandBuffer,
    uint32_t                                    infoCount,
    const VkMicromapBuildInfoEXT*               pInfos) {
...
void CommandTracker::TrackPreCmdCopyMicromapEXT(
    VkCommandBuffer                             commandBuffer,
...
void CommandTracker::TrackPostCmdCopyMicromapEXT(
    VkCommandBuffer                             commandBuffer,
    const VkCopyMicromapInfoEXT*                pInfo) {
  assert(commands_.back().type == Command::Type::kCmdCopyMicromapEXT);
}

void CommandTracker::TrackPreCmdCopyMicromapToMemoryEXT(
    VkCommandBuffer                             commandBuffer,
...
void CommandTracker::TrackPostCmdCopyMicromapToMemoryEXT(
    VkCommandBuffer                             commandBuffer,
    const VkCopyMicromapToMemoryInfoEXT*        pInfo) {
  assert(commands_.back().type == Command::Type::kCmdCopyMicromapToMemoryEXT);
}

void CommandTracker::TrackPreCmdCopyMemoryToMicromapEXT(
    VkCommandBuffer                             commandBuffer,
...
void CommandTracker::TrackPostCmdCopyMemoryToMicromapEXT(
    VkCommandBuffer                             commandBuffer,
    const VkCopyMemoryToMicromapInfoEXT*        pInfo) {
  assert(commands_.back().type == Command::Type::kCmdCopyMemoryToMicromapEXT);
}

void CommandTracker::TrackPreCmdWriteMicromapsPropertiesEXT(
    VkCommandBuffer                             commandBuffer,
  ...
  cmd.id = static_cast<uint32_t>(commands_.size()) + 1;
  cmd.parameters = recorder_.RecordCmdWriteMicromapsPropertiesEXT(commandBuffer, micromapCount, pMicromaps, queryType, queryPool, firstQuery);
  commands_.push_back(cmd);
}
void CommandTracker::TrackPostCmdWriteMicromapsPropertiesEXT(
    VkCommandBuffer                             commandBuffer,
    uint32_t                                    micromapCount,
    const VkMicromapEXT*                        pMicromaps,
    VkQueryType                                 queryType,
...
void CommandTracker::TrackPreCmdDrawClusterHUAWEI(
    VkCommandBuffer                             commandBuffer,
    uint32_t                                    groupCountX,
    uint32_t                                    groupCountY,
    uint32_t                                    groupCountZ) {
...
void CommandTracker::TrackPostCmdDrawClusterHUAWEI(
    VkCommandBuffer                             commandBuffer,
    uint32_t                                    groupCountX,
    uint32_t                                    groupCountY,
    uint32_t                                    groupCountZ) {
...
void CommandTracker::TrackPreCmdDrawClusterIndirectHUAWEI(
    VkCommandBuffer                             commandBuffer,
    VkBuffer                                    buffer,
    VkDeviceSize                                offset) {
  Command cmd {};
...
void CommandTracker::TrackPostCmdDrawClusterIndirectHUAWEI(
    VkCommandBuffer                             commandBuffer,
    VkBuffer                                    buffer,
    VkDeviceSize                                offset) {
...
void CommandTracker::TrackPreCmdCopyMemoryIndirectNV(
    VkCommandBuffer                             commandBuffer,
...
void CommandTracker::TrackPostCmdCopyMemoryIndirectNV(
    VkCommandBuffer                             commandBuffer,
    VkDeviceAddress                             copyBufferAddress,
    uint32_t                                    copyCount,
    uint32_t                                    stride) {
...
void CommandTracker::TrackPreCmdCopyMemoryToImageIndirectNV(
    VkCommandBuffer                             commandBuffer,
    VkDeviceAddress                             copyBufferAddress,
    uint32_t                                    copyCount,
    uint32_t                                    stride,
  ...
  cmd.id = static_cast<uint32_t>(commands_.size()) + 1;
  cmd.parameters = recorder_.RecordCmdCopyMemoryToImageIndirectNV(commandBuffer, copyBufferAddress, copyCount, stride, dstImage, dstImageLayout, pImageSubresources);
  commands_.push_back(cmd);
}
void CommandTracker::TrackPostCmdCopyMemoryToImageIndirectNV(
    VkCommandBuffer                             commandBuffer,
    VkDeviceAddress                             copyBufferAddress,
    uint32_t                                    copyCount,
    uint32_t                                    stride,
...
void CommandTracker::TrackPreCmdDecompressMemoryNV(
    VkCommandBuffer                             commandBuffer,
  ...
  cmd.id = static_cast<uint32_t>(commands_.size()) + 1;
  cmd.parameters = recorder_.RecordCmdDecompressMemoryNV(commandBuffer, decompressRegionCount, pDecompressMemoryRegions);
  commands_.push_back(cmd);
}
void CommandTracker::TrackPostCmdDecompressMemoryNV(
    VkCommandBuffer                             commandBuffer,
    uint32_t                                    decompressRegionCount,
    const VkDecompressMemoryRegionNV*           pDecompressMemoryRegions) {
...
void CommandTracker::TrackPreCmdDecompressMemoryIndirectCountNV(
    VkCommandBuffer                             commandBuffer,
  ...
  cmd.id = static_cast<uint32_t>(commands_.size()) + 1;
  cmd.parameters = recorder_.RecordCmdDecompressMemoryIndirectCountNV(commandBuffer, indirectCommandsAddress, indirectCommandsCountAddress, stride);
  commands_.push_back(cmd);
}
void CommandTracker::TrackPostCmdDecompressMemoryIndirectCountNV(
    VkCommandBuffer                             commandBuffer,
    VkDeviceAddress                             indirectCommandsAddress,
    VkDeviceAddress                             indirectCommandsCountAddress,
    uint32_t                                    stride) {
...
void CommandTracker::TrackPreCmdUpdatePipelineIndirectBufferNV(
    VkCommandBuffer                             commandBuffer,
    VkPipelineBindPoint                         pipelineBindPoint,
    VkPipeline                                  pipeline) {
  Command cmd {};
...
void CommandTracker::TrackPostCmdUpdatePipelineIndirectBufferNV(
    VkCommandBuffer                             commandBuffer,
    VkPipelineBindPoint                         pipelineBindPoint,
    VkPipeline                                  pipeline) {
...
void CommandTracker::TrackPostCmdSetDepthClampEnableEXT(
    VkCommandBuffer                             commandBuffer,
    VkBool32                                    depthClampEnable) {
  assert(commands_.back().type == Command::Type::kCmdSetDepthClampEnableEXT);
}

void CommandTracker::TrackPreCmdSetPolygonModeEXT(
    VkCommandBuffer                             commandBuffer,
...
void CommandTracker::TrackPostCmdSetPolygonModeEXT(
    VkCommandBuffer                             commandBuffer,
    VkPolygonMode                               polygonMode) {
  assert(commands_.back().type == Command::Type::kCmdSetPolygonModeEXT);
}

void CommandTracker::TrackPreCmdSetRasterizationSamplesEXT(
    VkCommandBuffer                             commandBuffer,
...
void CommandTracker::TrackPostCmdSetRasterizationSamplesEXT(
    VkCommandBuffer                             commandBuffer,
    VkSampleCountFlagBits                       rasterizationSamples) {
  assert(commands_.back().type == Command::Type::kCmdSetRasterizationSamplesEXT);
}

void CommandTracker::TrackPreCmdSetSampleMaskEXT(
    VkCommandBuffer                             commandBuffer,
...
void CommandTracker::TrackPostCmdSetSampleMaskEXT(
    VkCommandBuffer                             commandBuffer,
    VkSampleCountFlagBits                       samples,
    const VkSampleMask*                         pSampleMask) {
...
void CommandTracker::TrackPreCmdSetAlphaToCoverageEnableEXT(
    VkCommandBuffer                             commandBuffer,
...
void CommandTracker::TrackPostCmdSetAlphaToCoverageEnableEXT(
    VkCommandBuffer                             commandBuffer,
    VkBool32                                    alphaToCoverageEnable) {
  assert(commands_.back().type == Command::Type::kCmdSetAlphaToCoverageEnableEXT);
}

void CommandTracker::TrackPreCmdSetAlphaToOneEnableEXT(
    VkCommandBuffer                             commandBuffer,
...
void CommandTracker::TrackPostCmdSetAlphaToOneEnableEXT(
    VkCommandBuffer                             commandBuffer,
    VkBool32                                    alphaToOneEnable) {
  assert(commands_.back().type == Command::Type::kCmdSetAlphaToOneEnableEXT);
}

void CommandTracker::TrackPreCmdSetLogicOpEnableEXT(
    VkCommandBuffer                             commandBuffer,
...
void CommandTracker::TrackPostCmdSetLogicOpEnableEXT(
    VkCommandBuffer                             commandBuffer,
    VkBool32                                    logicOpEnable) {
  assert(commands_.back().type == Command::Type::kCmdSetLogicOpEnableEXT);
}

void CommandTracker::TrackPreCmdSetColorBlendEnableEXT(
    VkCommandBuffer                             commandBuffer,
  ...
  cmd.id = static_cast<uint32_t>(commands_.size()) + 1;
  cmd.parameters = recorder_.RecordCmdSetColorBlendEnableEXT(commandBuffer, firstAttachment, attachmentCount, pColorBlendEnables);
  commands_.push_back(cmd);
}
void CommandTracker::TrackPostCmdSetColorBlendEnableEXT(
    VkCommandBuffer                             commandBuffer,
    uint32_t                                    firstAttachment,
    uint32_t                                    attachmentCount,
    const VkBool32*                             pColorBlendEnables) {
...
void CommandTracker::TrackPreCmdSetColorBlendEquationEXT(
    VkCommandBuffer                             commandBuffer,
    uint32_t                                    firstAttachment,
    uint32_t                                    attachmentCount,
  ...
  cmd.id = static_cast<uint32_t>(commands_.size()) + 1;
  cmd.parameters = recorder_.RecordCmdSetColorBlendEquationEXT(commandBuffer, firstAttachment, attachmentCount, pColorBlendEquations);
  commands_.push_back(cmd);
}
void CommandTracker::TrackPostCmdSetColorBlendEquationEXT(
    VkCommandBuffer                             commandBuffer,
    uint32_t                                    firstAttachment,
    uint32_t                                    attachmentCount,
    const VkColorBlendEquationEXT*              pColorBlendEquations) {
...
void CommandTracker::TrackPreCmdSetColorWriteMaskEXT(
    VkCommandBuffer                             commandBuffer,
    uint32_t                                    firstAttachment,
    uint32_t                                    attachmentCount,
  ...
  cmd.id = static_cast<uint32_t>(commands_.size()) + 1;
  cmd.parameters = recorder_.RecordCmdSetColorWriteMaskEXT(commandBuffer, firstAttachment, attachmentCount, pColorWriteMasks);
  commands_.push_back(cmd);
}
void CommandTracker::TrackPostCmdSetColorWriteMaskEXT(
    VkCommandBuffer                             commandBuffer,
    uint32_t                                    firstAttachment,
    uint32_t                                    attachmentCount,
    const VkColorComponentFlags*                pColorWriteMasks) {
...
void CommandTracker::TrackPostCmdSetRasterizationStreamEXT(
    VkCommandBuffer                             commandBuffer,
    uint32_t                                    rasterizationStream) {
...
void CommandTracker::TrackPreCmdSetConservativeRasterizationModeEXT(
  ...
  cmd.id = static_cast<uint32_t>(commands_.size()) + 1;
  cmd.parameters = recorder_.RecordCmdSetConservativeRasterizationModeEXT(commandBuffer, conservativeRasterizationMode);
  commands_.push_back(cmd);
}
...
void CommandTracker::TrackPreCmdSetExtraPrimitiveOverestimationSizeEXT(
    VkCommandBuffer                             commandBuffer,
    float                                       extraPrimitiveOverestimationSize) {
  Command cmd {};
  cmd.type = Command::Type::kCmdSetExtraPrimitiveOverestimationSizeEXT;
  cmd.id = static_cast<uint32_t>(commands_.size()) + 1;
  cmd.parameters = recorder_.RecordCmdSetExtraPrimitiveOverestimationSizeEXT(commandBuffer, extraPrimitiveOverestimationSize);
  commands_.push_back(cmd);
}
void CommandTracker::TrackPostCmdSetExtraPrimitiveOverestimationSizeEXT(
    VkCommandBuffer                             commandBuffer,
    float                                       extraPrimitiveOverestimationSize) {
  assert(commands_.back().type == Command::Type::kCmdSetExtraPrimitiveOverestimationSizeEXT);
}

void CommandTracker::TrackPreCmdSetDepthClipEnableEXT(
    VkCommandBuffer                             commandBuffer,
...
void CommandTracker::TrackPostCmdSetDepthClipEnableEXT(
    VkCommandBuffer                             commandBuffer,
    VkBool32                                    depthClipEnable) {
  assert(commands_.back().type == Command::Type::kCmdSetDepthClipEnableEXT);
}

void CommandTracker::TrackPreCmdSetSampleLocationsEnableEXT(
    VkCommandBuffer                             commandBuffer,
...
void CommandTracker::TrackPostCmdSetSampleLocationsEnableEXT(
    VkCommandBuffer                             commandBuffer,
    VkBool32                                    sampleLocationsEnable) {
  assert(commands_.back().type == Command::Type::kCmdSetSampleLocationsEnableEXT);
}

void CommandTracker::TrackPreCmdSetColorBlendAdvancedEXT(
    VkCommandBuffer                             commandBuffer,
    uint32_t                                    firstAttachment,
    uint32_t                                    attachmentCount,
  ...
  cmd.id = static_cast<uint32_t>(commands_.size()) + 1;
  cmd.parameters = recorder_.RecordCmdSetColorBlendAdvancedEXT(commandBuffer, firstAttachment, attachmentCount, pColorBlendAdvanced);
  commands_.push_back(cmd);
}
void CommandTracker::TrackPostCmdSetColorBlendAdvancedEXT(
    VkCommandBuffer                             commandBuffer,
    uint32_t                                    firstAttachment,
    uint32_t                                    attachmentCount,
    const VkColorBlendAdvancedEXT*              pColorBlendAdvanced) {
...
void CommandTracker::TrackPreCmdSetProvokingVertexModeEXT(
    VkCommandBuffer                             commandBuffer,
...
void CommandTracker::TrackPostCmdSetProvokingVertexModeEXT(
    VkCommandBuffer                             commandBuffer,
    VkProvokingVertexModeEXT                    provokingVertexMode) {
  assert(commands_.back().type == Command::Type::kCmdSetProvokingVertexModeEXT);
}

void CommandTracker::TrackPreCmdSetLineRasterizationModeEXT(
    VkCommandBuffer                             commandBuffer,
...
void CommandTracker::TrackPostCmdSetLineRasterizationModeEXT(
    VkCommandBuffer                             commandBuffer,
    VkLineRasterizationModeEXT                  lineRasterizationMode) {
  assert(commands_.back().type == Command::Type::kCmdSetLineRasterizationModeEXT);
}

void CommandTracker::TrackPreCmdSetLineStippleEnableEXT(
    VkCommandBuffer                             commandBuffer,
...
void CommandTracker::TrackPostCmdSetLineStippleEnableEXT(
    VkCommandBuffer                             commandBuffer,
    VkBool32                                    stippledLineEnable) {
  assert(commands_.back().type == Command::Type::kCmdSetLineStippleEnableEXT);
}

void CommandTracker::TrackPreCmdSetDepthClipNegativeOneToOneEXT(
    VkCommandBuffer                             commandBuffer,
...
void CommandTracker::TrackPostCmdSetDepthClipNegativeOneToOneEXT(
    VkCommandBuffer                             commandBuffer,
    VkBool32                                    negativeOneToOne) {
  assert(commands_.back().type == Command::Type::kCmdSetDepthClipNegativeOneToOneEXT);
}

void CommandTracker::TrackPreCmdSetViewportWScalingEnableNV(
    VkCommandBuffer                             commandBuffer,
...
void CommandTracker::TrackPostCmdSetViewportWScalingEnableNV(
    VkCommandBuffer                             commandBuffer,
    VkBool32                                    viewportWScalingEnable) {
  assert(commands_.back().type == Command::Type::kCmdSetViewportWScalingEnableNV);
}

void CommandTracker::TrackPreCmdSetViewportSwizzleNV(
    VkCommandBuffer                             commandBuffer,
    uint32_t                                    firstViewport,
    uint32_t                                    viewportCount,
  ...
  cmd.id = static_cast<uint32_t>(commands_.size()) + 1;
  cmd.parameters = recorder_.RecordCmdSetViewportSwizzleNV(commandBuffer, firstViewport, viewportCount, pViewportSwizzles);
  commands_.push_back(cmd);
}
void CommandTracker::TrackPostCmdSetViewportSwizzleNV(
    VkCommandBuffer                             commandBuffer,
    uint32_t                                    firstViewport,
    uint32_t                                    viewportCount,
    const VkViewportSwizzleNV*                  pViewportSwizzles) {
...
void CommandTracker::TrackPreCmdSetCoverageToColorEnableNV(
    VkCommandBuffer                             commandBuffer,
...
void CommandTracker::TrackPostCmdSetCoverageToColorEnableNV(
    VkCommandBuffer                             commandBuffer,
    VkBool32                                    coverageToColorEnable) {
  assert(commands_.back().type == Command::Type::kCmdSetCoverageToColorEnableNV);
}

void CommandTracker::TrackPreCmdSetCoverageToColorLocationNV(
    VkCommandBuffer                             commandBuffer,
...
void CommandTracker::TrackPostCmdSetCoverageToColorLocationNV(
    VkCommandBuffer                             commandBuffer,
    uint32_t                                    coverageToColorLocation) {
  assert(commands_.back().type == Command::Type::kCmdSetCoverageToColorLocationNV);
}

void CommandTracker::TrackPreCmdSetCoverageModulationModeNV(
    VkCommandBuffer                             commandBuffer,
...
void CommandTracker::TrackPostCmdSetCoverageModulationModeNV(
    VkCommandBuffer                             commandBuffer,
    VkCoverageModulationModeNV                  coverageModulationMode) {
  assert(commands_.back().type == Command::Type::kCmdSetCoverageModulationModeNV);
}

void CommandTracker::TrackPreCmdSetCoverageModulationTableEnableNV(
    VkCommandBuffer                             commandBuffer,
    VkBool32                                    coverageModulationTableEnable) {
  Command cmd {};
  cmd.type = Command::Type::kCmdSetCoverageModulationTableEnableNV;
  cmd.id = static_cast<uint32_t>(commands_.size()) + 1;
  cmd.parameters = recorder_.RecordCmdSetCoverageModulationTableEnableNV(commandBuffer, coverageModulationTableEnable);
  commands_.push_back(cmd);
}
void CommandTracker::TrackPostCmdSetCoverageModulationTableEnableNV(
    VkCommandBuffer                             commandBuffer,
    VkBool32                                    coverageModulationTableEnable) {
  assert(commands_.back().type == Command::Type::kCmdSetCoverageModulationTableEnableNV);
}

void CommandTracker::TrackPreCmdSetCoverageModulationTableNV(
    VkCommandBuffer                             commandBuffer,
  ...
  cmd.id = static_cast<uint32_t>(commands_.size()) + 1;
  cmd.parameters = recorder_.RecordCmdSetCoverageModulationTableNV(commandBuffer, coverageModulationTableCount, pCoverageModulationTable);
  commands_.push_back(cmd);
}
void CommandTracker::TrackPostCmdSetCoverageModulationTableNV(
    VkCommandBuffer                             commandBuffer,
    uint32_t                                    coverageModulationTableCount,
    const float*                                pCoverageModulationTable) {
...
void CommandTracker::TrackPreCmdSetShadingRateImageEnableNV(
    VkCommandBuffer                             commandBuffer,
...
void CommandTracker::TrackPostCmdSetShadingRateImageEnableNV(
    VkCommandBuffer                             commandBuffer,
    VkBool32                                    shadingRateImageEnable) {
  assert(commands_.back().type == Command::Type::kCmdSetShadingRateImageEnableNV);
}

void CommandTracker::TrackPreCmdSetRepresentativeFragmentTestEnableNV(
    VkCommandBuffer                             commandBuffer,
    VkBool32                                    representativeFragmentTestEnable) {
  Command cmd {};
  cmd.type = Command::Type::kCmdSetRepresentativeFragmentTestEnableNV;
  cmd.id = static_cast<uint32_t>(commands_.size()) + 1;
  cmd.parameters = recorder_.RecordCmdSetRepresentativeFragmentTestEnableNV(commandBuffer, representativeFragmentTestEnable);
  commands_.push_back(cmd);
}
void CommandTracker::TrackPostCmdSetRepresentativeFragmentTestEnableNV(
    VkCommandBuffer                             commandBuffer,
    VkBool32                                    representativeFragmentTestEnable) {
  assert(commands_.back().type == Command::Type::kCmdSetRepresentativeFragmentTestEnableNV);
}

void CommandTracker::TrackPreCmdSetCoverageReductionModeNV(
    VkCommandBuffer                             commandBuffer,
...
void CommandTracker::TrackPostCmdSetCoverageReductionModeNV(
    VkCommandBuffer                             commandBuffer,
    VkCoverageReductionModeNV                   coverageReductionMode) {
  assert(commands_.back().type == Command::Type::kCmdSetCoverageReductionModeNV);
}

void CommandTracker::TrackPreCmdOpticalFlowExecuteNV(
    VkCommandBuffer                             commandBuffer,
...
void CommandTracker::TrackPostCmdOpticalFlowExecuteNV(
    VkCommandBuffer                             commandBuffer,
    VkOpticalFlowSessionNV                      session,
    const VkOpticalFlowExecuteInfoNV*           pExecuteInfo) {
...
void CommandTracker::TrackPreCmdBindShadersEXT(
    VkCommandBuffer                             commandBuffer,
    uint32_t                                    stageCount,
...
void CommandTracker::TrackPostCmdBindShadersEXT(
    VkCommandBuffer                             commandBuffer,
    uint32_t                                    stageCount,
    const VkShaderStageFlagBits*                pStages,
    const VkShaderEXT*                          pShaders) {
...
void CommandTracker::TrackPreCmdSetAttachmentFeedbackLoopEnableEXT(
    VkCommandBuffer                             commandBuffer,
...
void CommandTracker::TrackPostCmdSetAttachmentFeedbackLoopEnableEXT(
    VkCommandBuffer                             commandBuffer,
    VkImageAspectFlags                          aspectMask) {
...
void CommandTracker::TrackPreCmdCopyAccelerationStructureKHR(
    VkCommandBuffer                             commandBuffer,
...
void CommandTracker::TrackPostCmdCopyAccelerationStructureKHR(
    VkCommandBuffer                             commandBuffer,
    const VkCopyAccelerationStructureInfoKHR*   pInfo) {
...
void CommandTracker::TrackPreCmdTraceRaysIndirectKHR(
    VkCommandBuffer                             commandBuffer,
    const VkStridedDeviceAddressRegionKHR*      pRaygenShaderBindingTable,
    const VkStridedDeviceAddressRegionKHR*      pMissShaderBindingTable,
    const VkStridedDeviceAddressRegionKHR*      pHitShaderBindingTable,
...
void CommandTracker::TrackPreCmdSetRayTracingPipelineStackSizeKHR(
    VkCommandBuffer                             commandBuffer,
...
void CommandTracker::TrackPostCmdSetRayTracingPipelineStackSizeKHR(
    VkCommandBuffer                             commandBuffer,
    uint32_t                                    pipelineStackSize) {
  assert(commands_.back().type == Command::Type::kCmdSetRayTracingPipelineStackSizeKHR);
}

void CommandTracker::TrackPreCmdDrawMeshTasksEXT(
    VkCommandBuffer                             commandBuffer,
    uint32_t                                    groupCountX,
    uint32_t                                    groupCountY,
    uint32_t                                    groupCountZ) {
...
void CommandTracker::TrackPostCmdDrawMeshTasksEXT(
    VkCommandBuffer                             commandBuffer,
    uint32_t                                    groupCountX,
    uint32_t                                    groupCountY,
    uint32_t                                    groupCountZ) {
...
void CommandTracker::TrackPreCmdDrawMeshTasksIndirectEXT(
    VkCommandBuffer                             commandBuffer,
    VkBuffer                                    buffer,
    VkDeviceSize                                offset,
    uint32_t                                    drawCount,
...
void CommandTracker::TrackPostCmdDrawMeshTasksIndirectEXT(
    VkCommandBuffer                             commandBuffer,
    VkBuffer                                    buffer,
    VkDeviceSize                                offset,
    uint32_t                                    drawCount,
...
void CommandTracker::TrackPreCmdDrawMeshTasksIndirectCountEXT(
    VkCommandBuffer                             commandBuffer,
    VkBuffer                                    buffer,
    VkDeviceSize                                offset,
    VkBuffer                                    countBuffer,
  ...
  cmd.id = static_cast<uint32_t>(commands_.size()) + 1;
  cmd.parameters = recorder_.RecordCmdDrawMeshTasksIndirectCountEXT(commandBuffer, buffer, offset, countBuffer, countBufferOffset, maxDrawCount, stride);
  commands_.push_back(cmd);
}
void CommandTracker::TrackPostCmdDrawMeshTasksIndirectCountEXT(
    VkCommandBuffer                             commandBuffer,
    VkBuffer                                    buffer,
    VkDeviceSize                                offset,
    VkBuffer                                    countBuffer,
