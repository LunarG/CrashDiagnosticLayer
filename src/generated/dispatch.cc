...
void InitInstanceDispatchTable(VkInstance instance,
  ...
  dt->CreateInstance =
    (PFN_vkCreateInstance)pa(instance, "vkCreateInstance");
  dt->DestroyInstance =
  ...
  dt->GetPhysicalDeviceFeatures =
    (PFN_vkGetPhysicalDeviceFeatures)pa(instance, "vkGetPhysicalDeviceFeatures");
  ...
  dt->GetPhysicalDeviceProperties =
    (PFN_vkGetPhysicalDeviceProperties)pa(instance, "vkGetPhysicalDeviceProperties");
  ...
  dt->CreateDevice =
    (PFN_vkCreateDevice)pa(instance, "vkCreateDevice");
  ...
  dt->GetPhysicalDeviceSparseImageFormatProperties =
    (PFN_vkGetPhysicalDeviceSparseImageFormatProperties)pa(instance, "vkGetPhysicalDeviceSparseImageFormatProperties");
  dt->EnumerateInstanceVersion =
    (PFN_vkEnumerateInstanceVersion)pa(instance, "vkEnumerateInstanceVersion");
  dt->EnumeratePhysicalDeviceGroups =
    (PFN_vkEnumeratePhysicalDeviceGroups)pa(instance, "vkEnumeratePhysicalDeviceGroups");
  dt->GetPhysicalDeviceFeatures2 =
    (PFN_vkGetPhysicalDeviceFeatures2)pa(instance, "vkGetPhysicalDeviceFeatures2");
  ...
  dt->GetPhysicalDeviceSparseImageFormatProperties2 =
    (PFN_vkGetPhysicalDeviceSparseImageFormatProperties2)pa(instance, "vkGetPhysicalDeviceSparseImageFormatProperties2");
  ...
  dt->GetPhysicalDeviceExternalSemaphoreProperties =
    (PFN_vkGetPhysicalDeviceExternalSemaphoreProperties)pa(instance, "vkGetPhysicalDeviceExternalSemaphoreProperties");
  ...
  dt->GetDisplayModePropertiesKHR =
    (PFN_vkGetDisplayModePropertiesKHR)pa(instance, "vkGetDisplayModePropertiesKHR");
  ...
  dt->CreateXlibSurfaceKHR =
    (PFN_vkCreateXlibSurfaceKHR)pa(instance, "vkCreateXlibSurfaceKHR");
#endif //VK_USE_PLATFORM_XLIB_KHR
#ifdef VK_USE_PLATFORM_XLIB_KHR
  dt->GetPhysicalDeviceXlibPresentationSupportKHR =
    (PFN_vkGetPhysicalDeviceXlibPresentationSupportKHR)pa(instance, "vkGetPhysicalDeviceXlibPresentationSupportKHR");
#endif //VK_USE_PLATFORM_XLIB_KHR
#ifdef VK_USE_PLATFORM_XCB_KHR
  dt->CreateXcbSurfaceKHR =
    (PFN_vkCreateXcbSurfaceKHR)pa(instance, "vkCreateXcbSurfaceKHR");
  ...
  dt->CreateWaylandSurfaceKHR =
    (PFN_vkCreateWaylandSurfaceKHR)pa(instance, "vkCreateWaylandSurfaceKHR");
#endif //VK_USE_PLATFORM_WAYLAND_KHR
#ifdef VK_USE_PLATFORM_WAYLAND_KHR
  dt->GetPhysicalDeviceWaylandPresentationSupportKHR =
    (PFN_vkGetPhysicalDeviceWaylandPresentationSupportKHR)pa(instance, "vkGetPhysicalDeviceWaylandPresentationSupportKHR");
#endif //VK_USE_PLATFORM_WAYLAND_KHR
#ifdef VK_USE_PLATFORM_ANDROID_KHR
  dt->CreateAndroidSurfaceKHR =
    (PFN_vkCreateAndroidSurfaceKHR)pa(instance, "vkCreateAndroidSurfaceKHR");
#endif //VK_USE_PLATFORM_ANDROID_KHR
#ifdef VK_USE_PLATFORM_WIN32_KHR
  dt->CreateWin32SurfaceKHR =
    (PFN_vkCreateWin32SurfaceKHR)pa(instance, "vkCreateWin32SurfaceKHR");
#endif //VK_USE_PLATFORM_WIN32_KHR
#ifdef VK_USE_PLATFORM_WIN32_KHR
  dt->GetPhysicalDeviceWin32PresentationSupportKHR =
    (PFN_vkGetPhysicalDeviceWin32PresentationSupportKHR)pa(instance, "vkGetPhysicalDeviceWin32PresentationSupportKHR");
#endif //VK_USE_PLATFORM_WIN32_KHR
  ...
  dt->GetPhysicalDeviceSparseImageFormatProperties2KHR =
    (PFN_vkGetPhysicalDeviceSparseImageFormatProperties2KHR)pa(instance, "vkGetPhysicalDeviceSparseImageFormatProperties2KHR");
  ...
  dt->GetPhysicalDeviceExternalBufferPropertiesKHR =
    (PFN_vkGetPhysicalDeviceExternalBufferPropertiesKHR)pa(instance, "vkGetPhysicalDeviceExternalBufferPropertiesKHR");
  dt->GetPhysicalDeviceExternalSemaphorePropertiesKHR =
    (PFN_vkGetPhysicalDeviceExternalSemaphorePropertiesKHR)pa(instance, "vkGetPhysicalDeviceExternalSemaphorePropertiesKHR");
  dt->GetPhysicalDeviceExternalFencePropertiesKHR =
    (PFN_vkGetPhysicalDeviceExternalFencePropertiesKHR)pa(instance, "vkGetPhysicalDeviceExternalFencePropertiesKHR");
  dt->EnumeratePhysicalDeviceQueueFamilyPerformanceQueryCountersKHR =
    (PFN_vkEnumeratePhysicalDeviceQueueFamilyPerformanceQueryCountersKHR)pa(instance, "vkEnumeratePhysicalDeviceQueueFamilyPerformanceQueryCountersKHR");
  dt->GetPhysicalDeviceQueueFamilyPerformanceQueryPassesKHR =
    (PFN_vkGetPhysicalDeviceQueueFamilyPerformanceQueryPassesKHR)pa(instance, "vkGetPhysicalDeviceQueueFamilyPerformanceQueryPassesKHR");
  ...
  dt->GetPhysicalDeviceDisplayPlaneProperties2KHR =
    (PFN_vkGetPhysicalDeviceDisplayPlaneProperties2KHR)pa(instance, "vkGetPhysicalDeviceDisplayPlaneProperties2KHR");
  ...
  dt->GetPhysicalDeviceExternalImageFormatPropertiesNV =
    (PFN_vkGetPhysicalDeviceExternalImageFormatPropertiesNV)pa(instance, "vkGetPhysicalDeviceExternalImageFormatPropertiesNV");
#ifdef VK_USE_PLATFORM_VI_NN
  dt->CreateViSurfaceNN =
    (PFN_vkCreateViSurfaceNN)pa(instance, "vkCreateViSurfaceNN");
#endif //VK_USE_PLATFORM_VI_NN
  dt->ReleaseDisplayEXT =
    (PFN_vkReleaseDisplayEXT)pa(instance, "vkReleaseDisplayEXT");
#ifdef VK_USE_PLATFORM_XLIB_XRANDR_EXT
  dt->AcquireXlibDisplayEXT =
    (PFN_vkAcquireXlibDisplayEXT)pa(instance, "vkAcquireXlibDisplayEXT");
#endif //VK_USE_PLATFORM_XLIB_XRANDR_EXT
#ifdef VK_USE_PLATFORM_XLIB_XRANDR_EXT
  dt->GetRandROutputDisplayEXT =
    (PFN_vkGetRandROutputDisplayEXT)pa(instance, "vkGetRandROutputDisplayEXT");
#endif //VK_USE_PLATFORM_XLIB_XRANDR_EXT
  ...
  dt->CreateIOSSurfaceMVK =
    (PFN_vkCreateIOSSurfaceMVK)pa(instance, "vkCreateIOSSurfaceMVK");
#endif //VK_USE_PLATFORM_IOS_MVK
#ifdef VK_USE_PLATFORM_MACOS_MVK
  dt->CreateMacOSSurfaceMVK =
    (PFN_vkCreateMacOSSurfaceMVK)pa(instance, "vkCreateMacOSSurfaceMVK");
  ...
  dt->SubmitDebugUtilsMessageEXT =
    (PFN_vkSubmitDebugUtilsMessageEXT)pa(instance, "vkSubmitDebugUtilsMessageEXT");
  ...
  dt->GetPhysicalDeviceCalibrateableTimeDomainsEXT =
    (PFN_vkGetPhysicalDeviceCalibrateableTimeDomainsEXT)pa(instance, "vkGetPhysicalDeviceCalibrateableTimeDomainsEXT");
  ...
  dt->CreateMetalSurfaceEXT =
    (PFN_vkCreateMetalSurfaceEXT)pa(instance, "vkCreateMetalSurfaceEXT");
  ...
  dt->GetPhysicalDeviceCooperativeMatrixPropertiesNV =
    (PFN_vkGetPhysicalDeviceCooperativeMatrixPropertiesNV)pa(instance, "vkGetPhysicalDeviceCooperativeMatrixPropertiesNV");
  dt->GetPhysicalDeviceSupportedFramebufferMixedSamplesCombinationsNV =
    (PFN_vkGetPhysicalDeviceSupportedFramebufferMixedSamplesCombinationsNV)pa(instance, "vkGetPhysicalDeviceSupportedFramebufferMixedSamplesCombinationsNV");
#ifdef VK_USE_PLATFORM_WIN32_KHR
...
#ifdef VK_USE_PLATFORM_WIN32_KHR
  dt->AcquireWinrtDisplayNV =
    (PFN_vkAcquireWinrtDisplayNV)pa(instance, "vkAcquireWinrtDisplayNV");
#endif //VK_USE_PLATFORM_WIN32_KHR
#ifdef VK_USE_PLATFORM_WIN32_KHR
  dt->GetWinrtDisplayNV =
    (PFN_vkGetWinrtDisplayNV)pa(instance, "vkGetWinrtDisplayNV");
#endif //VK_USE_PLATFORM_WIN32_KHR
#ifdef VK_USE_PLATFORM_DIRECTFB_EXT
  dt->CreateDirectFBSurfaceEXT =
    (PFN_vkCreateDirectFBSurfaceEXT)pa(instance, "vkCreateDirectFBSurfaceEXT");
#endif //VK_USE_PLATFORM_DIRECTFB_EXT
#ifdef VK_USE_PLATFORM_DIRECTFB_EXT
  dt->GetPhysicalDeviceDirectFBPresentationSupportEXT =
    (PFN_vkGetPhysicalDeviceDirectFBPresentationSupportEXT)pa(instance, "vkGetPhysicalDeviceDirectFBPresentationSupportEXT");
#endif //VK_USE_PLATFORM_DIRECTFB_EXT
#ifdef VK_USE_PLATFORM_SCREEN_QNX
  dt->CreateScreenSurfaceQNX =
    (PFN_vkCreateScreenSurfaceQNX)pa(instance, "vkCreateScreenSurfaceQNX");
#endif //VK_USE_PLATFORM_SCREEN_QNX
#ifdef VK_USE_PLATFORM_SCREEN_QNX
  dt->GetPhysicalDeviceScreenPresentationSupportQNX =
    (PFN_vkGetPhysicalDeviceScreenPresentationSupportQNX)pa(instance, "vkGetPhysicalDeviceScreenPresentationSupportQNX");
#endif //VK_USE_PLATFORM_SCREEN_QNX
...
void InitDeviceDispatchTable(VkDevice device, PFN_vkGetDeviceProcAddr pa,
  ...
  dt->DestroyDevice =
    (PFN_vkDestroyDevice)pa(device, "vkDestroyDevice");
  dt->GetDeviceQueue =
    (PFN_vkGetDeviceQueue)pa(device, "vkGetDeviceQueue");
  dt->QueueSubmit =
    (PFN_vkQueueSubmit)pa(device, "vkQueueSubmit");
  dt->QueueWaitIdle =
    (PFN_vkQueueWaitIdle)pa(device, "vkQueueWaitIdle");
  dt->DeviceWaitIdle =
    (PFN_vkDeviceWaitIdle)pa(device, "vkDeviceWaitIdle");
  dt->AllocateMemory =
    (PFN_vkAllocateMemory)pa(device, "vkAllocateMemory");
  dt->FreeMemory =
    (PFN_vkFreeMemory)pa(device, "vkFreeMemory");
  dt->MapMemory =
    (PFN_vkMapMemory)pa(device, "vkMapMemory");
  dt->UnmapMemory =
    (PFN_vkUnmapMemory)pa(device, "vkUnmapMemory");
  dt->FlushMappedMemoryRanges =
    (PFN_vkFlushMappedMemoryRanges)pa(device, "vkFlushMappedMemoryRanges");
  dt->InvalidateMappedMemoryRanges =
    (PFN_vkInvalidateMappedMemoryRanges)pa(device, "vkInvalidateMappedMemoryRanges");
  ...
  dt->BindImageMemory =
    (PFN_vkBindImageMemory)pa(device, "vkBindImageMemory");
  dt->GetBufferMemoryRequirements =
    (PFN_vkGetBufferMemoryRequirements)pa(device, "vkGetBufferMemoryRequirements");
  dt->GetImageMemoryRequirements =
    (PFN_vkGetImageMemoryRequirements)pa(device, "vkGetImageMemoryRequirements");
  dt->GetImageSparseMemoryRequirements =
    (PFN_vkGetImageSparseMemoryRequirements)pa(device, "vkGetImageSparseMemoryRequirements");
  dt->QueueBindSparse =
    (PFN_vkQueueBindSparse)pa(device, "vkQueueBindSparse");
  dt->CreateFence =
    (PFN_vkCreateFence)pa(device, "vkCreateFence");
  dt->DestroyFence =
    (PFN_vkDestroyFence)pa(device, "vkDestroyFence");
  dt->ResetFences =
    (PFN_vkResetFences)pa(device, "vkResetFences");
  dt->GetFenceStatus =
    (PFN_vkGetFenceStatus)pa(device, "vkGetFenceStatus");
  dt->WaitForFences =
    (PFN_vkWaitForFences)pa(device, "vkWaitForFences");
  dt->CreateSemaphore =
    (PFN_vkCreateSemaphore)pa(device, "vkCreateSemaphore");
  dt->DestroySemaphore =
    (PFN_vkDestroySemaphore)pa(device, "vkDestroySemaphore");
  dt->CreateEvent =
    (PFN_vkCreateEvent)pa(device, "vkCreateEvent");
  dt->DestroyEvent =
    (PFN_vkDestroyEvent)pa(device, "vkDestroyEvent");
  dt->GetEventStatus =
    (PFN_vkGetEventStatus)pa(device, "vkGetEventStatus");
  dt->SetEvent =
    (PFN_vkSetEvent)pa(device, "vkSetEvent");
  dt->ResetEvent =
    (PFN_vkResetEvent)pa(device, "vkResetEvent");
  dt->CreateQueryPool =
    (PFN_vkCreateQueryPool)pa(device, "vkCreateQueryPool");
  dt->DestroyQueryPool =
  ...
  dt->CreateBuffer =
    (PFN_vkCreateBuffer)pa(device, "vkCreateBuffer");
  dt->DestroyBuffer =
    (PFN_vkDestroyBuffer)pa(device, "vkDestroyBuffer");
  dt->CreateBufferView =
  ...
  dt->CreateImage =
    (PFN_vkCreateImage)pa(device, "vkCreateImage");
  dt->DestroyImage =
    (PFN_vkDestroyImage)pa(device, "vkDestroyImage");
  dt->GetImageSubresourceLayout =
    (PFN_vkGetImageSubresourceLayout)pa(device, "vkGetImageSubresourceLayout");
  dt->CreateImageView =
    (PFN_vkCreateImageView)pa(device, "vkCreateImageView");
  dt->DestroyImageView =
  ...
  dt->DestroyPipeline =
    (PFN_vkDestroyPipeline)pa(device, "vkDestroyPipeline");
  ...
  dt->CreateSampler =
    (PFN_vkCreateSampler)pa(device, "vkCreateSampler");
  dt->DestroySampler =
    (PFN_vkDestroySampler)pa(device, "vkDestroySampler");
  dt->CreateDescriptorSetLayout =
    (PFN_vkCreateDescriptorSetLayout)pa(device, "vkCreateDescriptorSetLayout");
  dt->DestroyDescriptorSetLayout =
    (PFN_vkDestroyDescriptorSetLayout)pa(device, "vkDestroyDescriptorSetLayout");
  ...
  dt->CmdBindPipeline =
    (PFN_vkCmdBindPipeline)pa(device, "vkCmdBindPipeline");
  dt->CmdSetViewport =
    (PFN_vkCmdSetViewport)pa(device, "vkCmdSetViewport");
  dt->CmdSetScissor =
    (PFN_vkCmdSetScissor)pa(device, "vkCmdSetScissor");
  dt->CmdSetLineWidth =
    (PFN_vkCmdSetLineWidth)pa(device, "vkCmdSetLineWidth");
  dt->CmdSetDepthBias =
    (PFN_vkCmdSetDepthBias)pa(device, "vkCmdSetDepthBias");
  ...
  dt->CmdDraw =
    (PFN_vkCmdDraw)pa(device, "vkCmdDraw");
  dt->CmdDrawIndexed =
    (PFN_vkCmdDrawIndexed)pa(device, "vkCmdDrawIndexed");
  dt->CmdDrawIndirect =
    (PFN_vkCmdDrawIndirect)pa(device, "vkCmdDrawIndirect");
  dt->CmdDrawIndexedIndirect =
    (PFN_vkCmdDrawIndexedIndirect)pa(device, "vkCmdDrawIndexedIndirect");
  dt->CmdDispatch =
    (PFN_vkCmdDispatch)pa(device, "vkCmdDispatch");
  dt->CmdDispatchIndirect =
    (PFN_vkCmdDispatchIndirect)pa(device, "vkCmdDispatchIndirect");
  dt->CmdCopyBuffer =
    (PFN_vkCmdCopyBuffer)pa(device, "vkCmdCopyBuffer");
  dt->CmdCopyImage =
    (PFN_vkCmdCopyImage)pa(device, "vkCmdCopyImage");
  dt->CmdBlitImage =
    (PFN_vkCmdBlitImage)pa(device, "vkCmdBlitImage");
  ...
  dt->CmdUpdateBuffer =
    (PFN_vkCmdUpdateBuffer)pa(device, "vkCmdUpdateBuffer");
  dt->CmdFillBuffer =
    (PFN_vkCmdFillBuffer)pa(device, "vkCmdFillBuffer");
  ...
  dt->CmdResolveImage =
    (PFN_vkCmdResolveImage)pa(device, "vkCmdResolveImage");
  dt->CmdSetEvent =
    (PFN_vkCmdSetEvent)pa(device, "vkCmdSetEvent");
  dt->CmdResetEvent =
    (PFN_vkCmdResetEvent)pa(device, "vkCmdResetEvent");
  dt->CmdWaitEvents =
    (PFN_vkCmdWaitEvents)pa(device, "vkCmdWaitEvents");
  dt->CmdPipelineBarrier =
    (PFN_vkCmdPipelineBarrier)pa(device, "vkCmdPipelineBarrier");
  dt->CmdBeginQuery =
    (PFN_vkCmdBeginQuery)pa(device, "vkCmdBeginQuery");
  dt->CmdEndQuery =
    (PFN_vkCmdEndQuery)pa(device, "vkCmdEndQuery");
  ...
  dt->CmdNextSubpass =
    (PFN_vkCmdNextSubpass)pa(device, "vkCmdNextSubpass");
  dt->CmdEndRenderPass =
  ...
  dt->CmdDispatchBase =
    (PFN_vkCmdDispatchBase)pa(device, "vkCmdDispatchBase");
  dt->GetImageMemoryRequirements2 =
    (PFN_vkGetImageMemoryRequirements2)pa(device, "vkGetImageMemoryRequirements2");
  dt->GetBufferMemoryRequirements2 =
    (PFN_vkGetBufferMemoryRequirements2)pa(device, "vkGetBufferMemoryRequirements2");
  ...
  dt->TrimCommandPool =
    (PFN_vkTrimCommandPool)pa(device, "vkTrimCommandPool");
  dt->GetDeviceQueue2 =
    (PFN_vkGetDeviceQueue2)pa(device, "vkGetDeviceQueue2");
  dt->CreateSamplerYcbcrConversion =
    (PFN_vkCreateSamplerYcbcrConversion)pa(device, "vkCreateSamplerYcbcrConversion");
  ...
  dt->CmdNextSubpass2 =
    (PFN_vkCmdNextSubpass2)pa(device, "vkCmdNextSubpass2");
  dt->CmdEndRenderPass2 =
    (PFN_vkCmdEndRenderPass2)pa(device, "vkCmdEndRenderPass2");
  dt->ResetQueryPool =
    (PFN_vkResetQueryPool)pa(device, "vkResetQueryPool");
  dt->GetSemaphoreCounterValue =
    (PFN_vkGetSemaphoreCounterValue)pa(device, "vkGetSemaphoreCounterValue");
  dt->WaitSemaphores =
    (PFN_vkWaitSemaphores)pa(device, "vkWaitSemaphores");
  dt->SignalSemaphore =
    (PFN_vkSignalSemaphore)pa(device, "vkSignalSemaphore");
  ...
  dt->CreatePrivateDataSlot =
    (PFN_vkCreatePrivateDataSlot)pa(device, "vkCreatePrivateDataSlot");
  dt->DestroyPrivateDataSlot =
    (PFN_vkDestroyPrivateDataSlot)pa(device, "vkDestroyPrivateDataSlot");
  dt->SetPrivateData =
    (PFN_vkSetPrivateData)pa(device, "vkSetPrivateData");
  dt->GetPrivateData =
    (PFN_vkGetPrivateData)pa(device, "vkGetPrivateData");
  dt->CmdSetEvent2 =
    (PFN_vkCmdSetEvent2)pa(device, "vkCmdSetEvent2");
  dt->CmdResetEvent2 =
    (PFN_vkCmdResetEvent2)pa(device, "vkCmdResetEvent2");
  dt->CmdWaitEvents2 =
    (PFN_vkCmdWaitEvents2)pa(device, "vkCmdWaitEvents2");
  dt->CmdPipelineBarrier2 =
    (PFN_vkCmdPipelineBarrier2)pa(device, "vkCmdPipelineBarrier2");
  dt->CmdWriteTimestamp2 =
    (PFN_vkCmdWriteTimestamp2)pa(device, "vkCmdWriteTimestamp2");
  dt->QueueSubmit2 =
    (PFN_vkQueueSubmit2)pa(device, "vkQueueSubmit2");
  dt->CmdCopyBuffer2 =
    (PFN_vkCmdCopyBuffer2)pa(device, "vkCmdCopyBuffer2");
  dt->CmdCopyImage2 =
    (PFN_vkCmdCopyImage2)pa(device, "vkCmdCopyImage2");
  dt->CmdCopyBufferToImage2 =
    (PFN_vkCmdCopyBufferToImage2)pa(device, "vkCmdCopyBufferToImage2");
  dt->CmdCopyImageToBuffer2 =
    (PFN_vkCmdCopyImageToBuffer2)pa(device, "vkCmdCopyImageToBuffer2");
  dt->CmdBlitImage2 =
    (PFN_vkCmdBlitImage2)pa(device, "vkCmdBlitImage2");
  dt->CmdResolveImage2 =
    (PFN_vkCmdResolveImage2)pa(device, "vkCmdResolveImage2");
  dt->CmdBeginRendering =
    (PFN_vkCmdBeginRendering)pa(device, "vkCmdBeginRendering");
  dt->CmdEndRendering =
    (PFN_vkCmdEndRendering)pa(device, "vkCmdEndRendering");
  dt->CmdSetCullMode =
    (PFN_vkCmdSetCullMode)pa(device, "vkCmdSetCullMode");
  dt->CmdSetFrontFace =
    (PFN_vkCmdSetFrontFace)pa(device, "vkCmdSetFrontFace");
  dt->CmdSetPrimitiveTopology =
    (PFN_vkCmdSetPrimitiveTopology)pa(device, "vkCmdSetPrimitiveTopology");
  dt->CmdSetViewportWithCount =
    (PFN_vkCmdSetViewportWithCount)pa(device, "vkCmdSetViewportWithCount");
  dt->CmdSetScissorWithCount =
    (PFN_vkCmdSetScissorWithCount)pa(device, "vkCmdSetScissorWithCount");
  dt->CmdBindVertexBuffers2 =
    (PFN_vkCmdBindVertexBuffers2)pa(device, "vkCmdBindVertexBuffers2");
  dt->CmdSetDepthTestEnable =
    (PFN_vkCmdSetDepthTestEnable)pa(device, "vkCmdSetDepthTestEnable");
  dt->CmdSetDepthWriteEnable =
    (PFN_vkCmdSetDepthWriteEnable)pa(device, "vkCmdSetDepthWriteEnable");
  dt->CmdSetDepthCompareOp =
    (PFN_vkCmdSetDepthCompareOp)pa(device, "vkCmdSetDepthCompareOp");
  dt->CmdSetDepthBoundsTestEnable =
    (PFN_vkCmdSetDepthBoundsTestEnable)pa(device, "vkCmdSetDepthBoundsTestEnable");
  dt->CmdSetStencilTestEnable =
    (PFN_vkCmdSetStencilTestEnable)pa(device, "vkCmdSetStencilTestEnable");
  dt->CmdSetStencilOp =
    (PFN_vkCmdSetStencilOp)pa(device, "vkCmdSetStencilOp");
  dt->CmdSetRasterizerDiscardEnable =
    (PFN_vkCmdSetRasterizerDiscardEnable)pa(device, "vkCmdSetRasterizerDiscardEnable");
  dt->CmdSetDepthBiasEnable =
    (PFN_vkCmdSetDepthBiasEnable)pa(device, "vkCmdSetDepthBiasEnable");
  dt->CmdSetPrimitiveRestartEnable =
    (PFN_vkCmdSetPrimitiveRestartEnable)pa(device, "vkCmdSetPrimitiveRestartEnable");
  ...
  dt->QueuePresentKHR =
    (PFN_vkQueuePresentKHR)pa(device, "vkQueuePresentKHR");
  ...
  dt->CreateVideoSessionKHR =
    (PFN_vkCreateVideoSessionKHR)pa(device, "vkCreateVideoSessionKHR");
  dt->DestroyVideoSessionKHR =
    (PFN_vkDestroyVideoSessionKHR)pa(device, "vkDestroyVideoSessionKHR");
  ...
  dt->BindVideoSessionMemoryKHR =
    (PFN_vkBindVideoSessionMemoryKHR)pa(device, "vkBindVideoSessionMemoryKHR");
  ...
  dt->CmdBeginVideoCodingKHR =
    (PFN_vkCmdBeginVideoCodingKHR)pa(device, "vkCmdBeginVideoCodingKHR");
  dt->CmdEndVideoCodingKHR =
    (PFN_vkCmdEndVideoCodingKHR)pa(device, "vkCmdEndVideoCodingKHR");
  dt->CmdControlVideoCodingKHR =
    (PFN_vkCmdControlVideoCodingKHR)pa(device, "vkCmdControlVideoCodingKHR");
  dt->CmdDecodeVideoKHR =
    (PFN_vkCmdDecodeVideoKHR)pa(device, "vkCmdDecodeVideoKHR");
  dt->CmdBeginRenderingKHR =
    (PFN_vkCmdBeginRenderingKHR)pa(device, "vkCmdBeginRenderingKHR");
  dt->CmdEndRenderingKHR =
    (PFN_vkCmdEndRenderingKHR)pa(device, "vkCmdEndRenderingKHR");
...
#ifdef VK_USE_PLATFORM_WIN32_KHR
  dt->GetMemoryWin32HandleKHR =
    (PFN_vkGetMemoryWin32HandleKHR)pa(device, "vkGetMemoryWin32HandleKHR");
#endif //VK_USE_PLATFORM_WIN32_KHR
#ifdef VK_USE_PLATFORM_WIN32_KHR
...
#endif //VK_USE_PLATFORM_WIN32_KHR
  dt->GetMemoryFdKHR =
    (PFN_vkGetMemoryFdKHR)pa(device, "vkGetMemoryFdKHR");
...
#endif //VK_USE_PLATFORM_WIN32_KHR
#ifdef VK_USE_PLATFORM_WIN32_KHR
  dt->GetSemaphoreWin32HandleKHR =
    (PFN_vkGetSemaphoreWin32HandleKHR)pa(device, "vkGetSemaphoreWin32HandleKHR");
#endif //VK_USE_PLATFORM_WIN32_KHR
...
#ifdef VK_USE_PLATFORM_WIN32_KHR
  dt->ImportFenceWin32HandleKHR =
    (PFN_vkImportFenceWin32HandleKHR)pa(device, "vkImportFenceWin32HandleKHR");
#endif //VK_USE_PLATFORM_WIN32_KHR
#ifdef VK_USE_PLATFORM_WIN32_KHR
  dt->GetFenceWin32HandleKHR =
    (PFN_vkGetFenceWin32HandleKHR)pa(device, "vkGetFenceWin32HandleKHR");
#endif //VK_USE_PLATFORM_WIN32_KHR
  dt->ImportFenceFdKHR =
    (PFN_vkImportFenceFdKHR)pa(device, "vkImportFenceFdKHR");
  dt->GetFenceFdKHR =
    (PFN_vkGetFenceFdKHR)pa(device, "vkGetFenceFdKHR");
  ...
  dt->GetSemaphoreCounterValueKHR =
    (PFN_vkGetSemaphoreCounterValueKHR)pa(device, "vkGetSemaphoreCounterValueKHR");
  ...
  dt->CreateDeferredOperationKHR =
    (PFN_vkCreateDeferredOperationKHR)pa(device, "vkCreateDeferredOperationKHR");
  dt->DestroyDeferredOperationKHR =
    (PFN_vkDestroyDeferredOperationKHR)pa(device, "vkDestroyDeferredOperationKHR");
  ...
  dt->GetPipelineExecutableInternalRepresentationsKHR =
    (PFN_vkGetPipelineExecutableInternalRepresentationsKHR)pa(device, "vkGetPipelineExecutableInternalRepresentationsKHR");
  dt->MapMemory2KHR =
  ...
  dt->QueueSubmit2KHR =
    (PFN_vkQueueSubmit2KHR)pa(device, "vkQueueSubmit2KHR");
  ...
  dt->CmdTraceRaysIndirect2KHR =
    (PFN_vkCmdTraceRaysIndirect2KHR)pa(device, "vkCmdTraceRaysIndirect2KHR");
  ...
  dt->DebugMarkerSetObjectNameEXT =
    (PFN_vkDebugMarkerSetObjectNameEXT)pa(device, "vkDebugMarkerSetObjectNameEXT");
  ...
  dt->CmdBeginTransformFeedbackEXT =
    (PFN_vkCmdBeginTransformFeedbackEXT)pa(device, "vkCmdBeginTransformFeedbackEXT");
  dt->CmdEndTransformFeedbackEXT =
    (PFN_vkCmdEndTransformFeedbackEXT)pa(device, "vkCmdEndTransformFeedbackEXT");
  dt->CmdBeginQueryIndexedEXT =
    (PFN_vkCmdBeginQueryIndexedEXT)pa(device, "vkCmdBeginQueryIndexedEXT");
  dt->CmdEndQueryIndexedEXT =
    (PFN_vkCmdEndQueryIndexedEXT)pa(device, "vkCmdEndQueryIndexedEXT");
  dt->CmdDrawIndirectByteCountEXT =
    (PFN_vkCmdDrawIndirectByteCountEXT)pa(device, "vkCmdDrawIndirectByteCountEXT");
  dt->CreateCuModuleNVX =
    (PFN_vkCreateCuModuleNVX)pa(device, "vkCreateCuModuleNVX");
  dt->CreateCuFunctionNVX =
    (PFN_vkCreateCuFunctionNVX)pa(device, "vkCreateCuFunctionNVX");
  dt->DestroyCuModuleNVX =
    (PFN_vkDestroyCuModuleNVX)pa(device, "vkDestroyCuModuleNVX");
  dt->DestroyCuFunctionNVX =
    (PFN_vkDestroyCuFunctionNVX)pa(device, "vkDestroyCuFunctionNVX");
  dt->CmdCuLaunchKernelNVX =
    (PFN_vkCmdCuLaunchKernelNVX)pa(device, "vkCmdCuLaunchKernelNVX");
  dt->GetImageViewHandleNVX =
    (PFN_vkGetImageViewHandleNVX)pa(device, "vkGetImageViewHandleNVX");
  dt->GetImageViewAddressNVX =
    (PFN_vkGetImageViewAddressNVX)pa(device, "vkGetImageViewAddressNVX");
...
#ifdef VK_USE_PLATFORM_WIN32_KHR
  dt->GetMemoryWin32HandleNV =
    (PFN_vkGetMemoryWin32HandleNV)pa(device, "vkGetMemoryWin32HandleNV");
#endif //VK_USE_PLATFORM_WIN32_KHR
  ...
  dt->CmdSetViewportWScalingNV =
    (PFN_vkCmdSetViewportWScalingNV)pa(device, "vkCmdSetViewportWScalingNV");
  dt->DisplayPowerControlEXT =
    (PFN_vkDisplayPowerControlEXT)pa(device, "vkDisplayPowerControlEXT");
  dt->RegisterDeviceEventEXT =
    (PFN_vkRegisterDeviceEventEXT)pa(device, "vkRegisterDeviceEventEXT");
  dt->RegisterDisplayEventEXT =
    (PFN_vkRegisterDisplayEventEXT)pa(device, "vkRegisterDisplayEventEXT");
  dt->GetSwapchainCounterEXT =
    (PFN_vkGetSwapchainCounterEXT)pa(device, "vkGetSwapchainCounterEXT");
  ...
  dt->CmdSetDiscardRectangleEXT =
    (PFN_vkCmdSetDiscardRectangleEXT)pa(device, "vkCmdSetDiscardRectangleEXT");
  ...
  dt->SetHdrMetadataEXT =
    (PFN_vkSetHdrMetadataEXT)pa(device, "vkSetHdrMetadataEXT");
  ...
  dt->QueueBeginDebugUtilsLabelEXT =
    (PFN_vkQueueBeginDebugUtilsLabelEXT)pa(device, "vkQueueBeginDebugUtilsLabelEXT");
  dt->QueueEndDebugUtilsLabelEXT =
    (PFN_vkQueueEndDebugUtilsLabelEXT)pa(device, "vkQueueEndDebugUtilsLabelEXT");
  dt->QueueInsertDebugUtilsLabelEXT =
    (PFN_vkQueueInsertDebugUtilsLabelEXT)pa(device, "vkQueueInsertDebugUtilsLabelEXT");
  dt->CmdBeginDebugUtilsLabelEXT =
    (PFN_vkCmdBeginDebugUtilsLabelEXT)pa(device, "vkCmdBeginDebugUtilsLabelEXT");
  dt->CmdEndDebugUtilsLabelEXT =
    (PFN_vkCmdEndDebugUtilsLabelEXT)pa(device, "vkCmdEndDebugUtilsLabelEXT");
  dt->CmdInsertDebugUtilsLabelEXT =
  ...
  dt->CreateValidationCacheEXT =
    (PFN_vkCreateValidationCacheEXT)pa(device, "vkCreateValidationCacheEXT");
  dt->DestroyValidationCacheEXT =
    (PFN_vkDestroyValidationCacheEXT)pa(device, "vkDestroyValidationCacheEXT");
  dt->MergeValidationCachesEXT =
    (PFN_vkMergeValidationCachesEXT)pa(device, "vkMergeValidationCachesEXT");
  dt->GetValidationCacheDataEXT =
    (PFN_vkGetValidationCacheDataEXT)pa(device, "vkGetValidationCacheDataEXT");
  dt->CmdBindShadingRateImageNV =
    (PFN_vkCmdBindShadingRateImageNV)pa(device, "vkCmdBindShadingRateImageNV");
  ...
  dt->CmdSetCoarseSampleOrderNV =
    (PFN_vkCmdSetCoarseSampleOrderNV)pa(device, "vkCmdSetCoarseSampleOrderNV");
  ...
  dt->GetAccelerationStructureMemoryRequirementsNV =
    (PFN_vkGetAccelerationStructureMemoryRequirementsNV)pa(device, "vkGetAccelerationStructureMemoryRequirementsNV");
  ...
  dt->CmdTraceRaysNV =
    (PFN_vkCmdTraceRaysNV)pa(device, "vkCmdTraceRaysNV");
  dt->CreateRayTracingPipelinesNV =
    (PFN_vkCreateRayTracingPipelinesNV)pa(device, "vkCreateRayTracingPipelinesNV");
  ...
  dt->CompileDeferredNV =
    (PFN_vkCompileDeferredNV)pa(device, "vkCompileDeferredNV");
  ...
  dt->GetCalibratedTimestampsEXT =
    (PFN_vkGetCalibratedTimestampsEXT)pa(device, "vkGetCalibratedTimestampsEXT");
  dt->CmdDrawMeshTasksNV =
    (PFN_vkCmdDrawMeshTasksNV)pa(device, "vkCmdDrawMeshTasksNV");
  dt->CmdDrawMeshTasksIndirectNV =
    (PFN_vkCmdDrawMeshTasksIndirectNV)pa(device, "vkCmdDrawMeshTasksIndirectNV");
  ...
  dt->CmdSetExclusiveScissorNV =
    (PFN_vkCmdSetExclusiveScissorNV)pa(device, "vkCmdSetExclusiveScissorNV");
  dt->CmdSetCheckpointNV =
    (PFN_vkCmdSetCheckpointNV)pa(device, "vkCmdSetCheckpointNV");
  dt->GetQueueCheckpointDataNV =
    (PFN_vkGetQueueCheckpointDataNV)pa(device, "vkGetQueueCheckpointDataNV");
  ...
  dt->CmdSetPerformanceMarkerINTEL =
    (PFN_vkCmdSetPerformanceMarkerINTEL)pa(device, "vkCmdSetPerformanceMarkerINTEL");
  ...
  dt->GetPerformanceParameterINTEL =
    (PFN_vkGetPerformanceParameterINTEL)pa(device, "vkGetPerformanceParameterINTEL");
  ...
  dt->CmdSetPrimitiveTopologyEXT =
    (PFN_vkCmdSetPrimitiveTopologyEXT)pa(device, "vkCmdSetPrimitiveTopologyEXT");
  dt->CmdSetViewportWithCountEXT =
    (PFN_vkCmdSetViewportWithCountEXT)pa(device, "vkCmdSetViewportWithCountEXT");
  ...
  dt->CmdSetStencilTestEnableEXT =
    (PFN_vkCmdSetStencilTestEnableEXT)pa(device, "vkCmdSetStencilTestEnableEXT");
  dt->CmdSetStencilOpEXT =
    (PFN_vkCmdSetStencilOpEXT)pa(device, "vkCmdSetStencilOpEXT");
  dt->CopyMemoryToImageEXT =
    (PFN_vkCopyMemoryToImageEXT)pa(device, "vkCopyMemoryToImageEXT");
  dt->CopyImageToMemoryEXT =
    (PFN_vkCopyImageToMemoryEXT)pa(device, "vkCopyImageToMemoryEXT");
  dt->CopyImageToImageEXT =
    (PFN_vkCopyImageToImageEXT)pa(device, "vkCopyImageToImageEXT");
  dt->TransitionImageLayoutEXT =
    (PFN_vkTransitionImageLayoutEXT)pa(device, "vkTransitionImageLayoutEXT");
  dt->GetImageSubresourceLayout2EXT =
    (PFN_vkGetImageSubresourceLayout2EXT)pa(device, "vkGetImageSubresourceLayout2EXT");
  dt->ReleaseSwapchainImagesEXT =
    (PFN_vkReleaseSwapchainImagesEXT)pa(device, "vkReleaseSwapchainImagesEXT");
  ...
  dt->CmdBindPipelineShaderGroupNV =
    (PFN_vkCmdBindPipelineShaderGroupNV)pa(device, "vkCmdBindPipelineShaderGroupNV");
  ...
  dt->CmdSetDepthBias2EXT =
    (PFN_vkCmdSetDepthBias2EXT)pa(device, "vkCmdSetDepthBias2EXT");
  dt->CreatePrivateDataSlotEXT =
    (PFN_vkCreatePrivateDataSlotEXT)pa(device, "vkCreatePrivateDataSlotEXT");
  dt->DestroyPrivateDataSlotEXT =
    (PFN_vkDestroyPrivateDataSlotEXT)pa(device, "vkDestroyPrivateDataSlotEXT");
  dt->SetPrivateDataEXT =
  ...
  dt->GetDescriptorEXT =
    (PFN_vkGetDescriptorEXT)pa(device, "vkGetDescriptorEXT");
  dt->CmdBindDescriptorBuffersEXT =
    (PFN_vkCmdBindDescriptorBuffersEXT)pa(device, "vkCmdBindDescriptorBuffersEXT");
  ...
  dt->GetAccelerationStructureOpaqueCaptureDescriptorDataEXT =
    (PFN_vkGetAccelerationStructureOpaqueCaptureDescriptorDataEXT)pa(device, "vkGetAccelerationStructureOpaqueCaptureDescriptorDataEXT");
  dt->CmdSetFragmentShadingRateEnumNV =
    (PFN_vkCmdSetFragmentShadingRateEnumNV)pa(device, "vkCmdSetFragmentShadingRateEnumNV");
  dt->GetDeviceFaultInfoEXT =
    (PFN_vkGetDeviceFaultInfoEXT)pa(device, "vkGetDeviceFaultInfoEXT");
  dt->CmdSetVertexInputEXT =
    (PFN_vkCmdSetVertexInputEXT)pa(device, "vkCmdSetVertexInputEXT");
#ifdef VK_USE_PLATFORM_FUCHSIA
  dt->GetMemoryZirconHandleFUCHSIA =
    (PFN_vkGetMemoryZirconHandleFUCHSIA)pa(device, "vkGetMemoryZirconHandleFUCHSIA");
#endif //VK_USE_PLATFORM_FUCHSIA
#ifdef VK_USE_PLATFORM_FUCHSIA
...
#endif //VK_USE_PLATFORM_FUCHSIA
  dt->GetDeviceSubpassShadingMaxWorkgroupSizeHUAWEI =
    (PFN_vkGetDeviceSubpassShadingMaxWorkgroupSizeHUAWEI)pa(device, "vkGetDeviceSubpassShadingMaxWorkgroupSizeHUAWEI");
  dt->CmdSubpassShadingHUAWEI =
    (PFN_vkCmdSubpassShadingHUAWEI)pa(device, "vkCmdSubpassShadingHUAWEI");
  dt->CmdBindInvocationMaskHUAWEI =
    (PFN_vkCmdBindInvocationMaskHUAWEI)pa(device, "vkCmdBindInvocationMaskHUAWEI");
  dt->GetMemoryRemoteAddressNV =
    (PFN_vkGetMemoryRemoteAddressNV)pa(device, "vkGetMemoryRemoteAddressNV");
  dt->GetPipelinePropertiesEXT =
    (PFN_vkGetPipelinePropertiesEXT)pa(device, "vkGetPipelinePropertiesEXT");
  dt->CmdSetPatchControlPointsEXT =
    (PFN_vkCmdSetPatchControlPointsEXT)pa(device, "vkCmdSetPatchControlPointsEXT");
  ...
  dt->CmdDrawMultiEXT =
    (PFN_vkCmdDrawMultiEXT)pa(device, "vkCmdDrawMultiEXT");
  dt->CmdDrawMultiIndexedEXT =
    (PFN_vkCmdDrawMultiIndexedEXT)pa(device, "vkCmdDrawMultiIndexedEXT");
  dt->CreateMicromapEXT =
    (PFN_vkCreateMicromapEXT)pa(device, "vkCreateMicromapEXT");
  dt->DestroyMicromapEXT =
    (PFN_vkDestroyMicromapEXT)pa(device, "vkDestroyMicromapEXT");
  dt->CmdBuildMicromapsEXT =
    (PFN_vkCmdBuildMicromapsEXT)pa(device, "vkCmdBuildMicromapsEXT");
  dt->BuildMicromapsEXT =
    (PFN_vkBuildMicromapsEXT)pa(device, "vkBuildMicromapsEXT");
  dt->CopyMicromapEXT =
    (PFN_vkCopyMicromapEXT)pa(device, "vkCopyMicromapEXT");
  dt->CopyMicromapToMemoryEXT =
    (PFN_vkCopyMicromapToMemoryEXT)pa(device, "vkCopyMicromapToMemoryEXT");
  dt->CopyMemoryToMicromapEXT =
    (PFN_vkCopyMemoryToMicromapEXT)pa(device, "vkCopyMemoryToMicromapEXT");
  dt->WriteMicromapsPropertiesEXT =
    (PFN_vkWriteMicromapsPropertiesEXT)pa(device, "vkWriteMicromapsPropertiesEXT");
  dt->CmdCopyMicromapEXT =
    (PFN_vkCmdCopyMicromapEXT)pa(device, "vkCmdCopyMicromapEXT");
  dt->CmdCopyMicromapToMemoryEXT =
    (PFN_vkCmdCopyMicromapToMemoryEXT)pa(device, "vkCmdCopyMicromapToMemoryEXT");
  dt->CmdCopyMemoryToMicromapEXT =
    (PFN_vkCmdCopyMemoryToMicromapEXT)pa(device, "vkCmdCopyMemoryToMicromapEXT");
  ...
  dt->GetMicromapBuildSizesEXT =
    (PFN_vkGetMicromapBuildSizesEXT)pa(device, "vkGetMicromapBuildSizesEXT");
  dt->CmdDrawClusterHUAWEI =
    (PFN_vkCmdDrawClusterHUAWEI)pa(device, "vkCmdDrawClusterHUAWEI");
  dt->CmdDrawClusterIndirectHUAWEI =
    (PFN_vkCmdDrawClusterIndirectHUAWEI)pa(device, "vkCmdDrawClusterIndirectHUAWEI");
  dt->SetDeviceMemoryPriorityEXT =
    (PFN_vkSetDeviceMemoryPriorityEXT)pa(device, "vkSetDeviceMemoryPriorityEXT");
  ...
  dt->CmdCopyMemoryIndirectNV =
    (PFN_vkCmdCopyMemoryIndirectNV)pa(device, "vkCmdCopyMemoryIndirectNV");
  dt->CmdCopyMemoryToImageIndirectNV =
    (PFN_vkCmdCopyMemoryToImageIndirectNV)pa(device, "vkCmdCopyMemoryToImageIndirectNV");
  dt->CmdDecompressMemoryNV =
    (PFN_vkCmdDecompressMemoryNV)pa(device, "vkCmdDecompressMemoryNV");
  ...
  dt->CmdSetPolygonModeEXT =
    (PFN_vkCmdSetPolygonModeEXT)pa(device, "vkCmdSetPolygonModeEXT");
  dt->CmdSetRasterizationSamplesEXT =
    (PFN_vkCmdSetRasterizationSamplesEXT)pa(device, "vkCmdSetRasterizationSamplesEXT");
  dt->CmdSetSampleMaskEXT =
    (PFN_vkCmdSetSampleMaskEXT)pa(device, "vkCmdSetSampleMaskEXT");
  dt->CmdSetAlphaToCoverageEnableEXT =
    (PFN_vkCmdSetAlphaToCoverageEnableEXT)pa(device, "vkCmdSetAlphaToCoverageEnableEXT");
  dt->CmdSetAlphaToOneEnableEXT =
    (PFN_vkCmdSetAlphaToOneEnableEXT)pa(device, "vkCmdSetAlphaToOneEnableEXT");
  dt->CmdSetLogicOpEnableEXT =
    (PFN_vkCmdSetLogicOpEnableEXT)pa(device, "vkCmdSetLogicOpEnableEXT");
  dt->CmdSetColorBlendEnableEXT =
    (PFN_vkCmdSetColorBlendEnableEXT)pa(device, "vkCmdSetColorBlendEnableEXT");
  dt->CmdSetColorBlendEquationEXT =
  ...
  dt->CmdSetDepthClipEnableEXT =
    (PFN_vkCmdSetDepthClipEnableEXT)pa(device, "vkCmdSetDepthClipEnableEXT");
  dt->CmdSetSampleLocationsEnableEXT =
    (PFN_vkCmdSetSampleLocationsEnableEXT)pa(device, "vkCmdSetSampleLocationsEnableEXT");
  dt->CmdSetColorBlendAdvancedEXT =
    (PFN_vkCmdSetColorBlendAdvancedEXT)pa(device, "vkCmdSetColorBlendAdvancedEXT");
  dt->CmdSetProvokingVertexModeEXT =
    (PFN_vkCmdSetProvokingVertexModeEXT)pa(device, "vkCmdSetProvokingVertexModeEXT");
  dt->CmdSetLineRasterizationModeEXT =
    (PFN_vkCmdSetLineRasterizationModeEXT)pa(device, "vkCmdSetLineRasterizationModeEXT");
  dt->CmdSetLineStippleEnableEXT =
    (PFN_vkCmdSetLineStippleEnableEXT)pa(device, "vkCmdSetLineStippleEnableEXT");
  ...
  dt->CmdSetViewportSwizzleNV =
    (PFN_vkCmdSetViewportSwizzleNV)pa(device, "vkCmdSetViewportSwizzleNV");
  ...
  dt->GetShaderModuleIdentifierEXT =
    (PFN_vkGetShaderModuleIdentifierEXT)pa(device, "vkGetShaderModuleIdentifierEXT");
  ...
  dt->CreateOpticalFlowSessionNV =
    (PFN_vkCreateOpticalFlowSessionNV)pa(device, "vkCreateOpticalFlowSessionNV");
  dt->DestroyOpticalFlowSessionNV =
    (PFN_vkDestroyOpticalFlowSessionNV)pa(device, "vkDestroyOpticalFlowSessionNV");
  dt->BindOpticalFlowSessionImageNV =
    (PFN_vkBindOpticalFlowSessionImageNV)pa(device, "vkBindOpticalFlowSessionImageNV");
  dt->CmdOpticalFlowExecuteNV =
    (PFN_vkCmdOpticalFlowExecuteNV)pa(device, "vkCmdOpticalFlowExecuteNV");
  dt->CreateShadersEXT =
    (PFN_vkCreateShadersEXT)pa(device, "vkCreateShadersEXT");
  dt->DestroyShaderEXT =
    (PFN_vkDestroyShaderEXT)pa(device, "vkDestroyShaderEXT");
  dt->GetShaderBinaryDataEXT =
    (PFN_vkGetShaderBinaryDataEXT)pa(device, "vkGetShaderBinaryDataEXT");
  dt->CmdBindShadersEXT =
    (PFN_vkCmdBindShadersEXT)pa(device, "vkCmdBindShadersEXT");
...
#ifdef VK_USE_PLATFORM_SCREEN_QNX
  dt->GetScreenBufferPropertiesQNX =
    (PFN_vkGetScreenBufferPropertiesQNX)pa(device, "vkGetScreenBufferPropertiesQNX");
#endif //VK_USE_PLATFORM_SCREEN_QNX
  ...
  dt->CopyAccelerationStructureKHR =
    (PFN_vkCopyAccelerationStructureKHR)pa(device, "vkCopyAccelerationStructureKHR");
  ...
  dt->GetDeviceAccelerationStructureCompatibilityKHR =
    (PFN_vkGetDeviceAccelerationStructureCompatibilityKHR)pa(device, "vkGetDeviceAccelerationStructureCompatibilityKHR");
  ...
  dt->CmdTraceRaysKHR =
    (PFN_vkCmdTraceRaysKHR)pa(device, "vkCmdTraceRaysKHR");
  dt->CreateRayTracingPipelinesKHR =
    (PFN_vkCreateRayTracingPipelinesKHR)pa(device, "vkCreateRayTracingPipelinesKHR");
  dt->GetRayTracingCaptureReplayShaderGroupHandlesKHR =
    (PFN_vkGetRayTracingCaptureReplayShaderGroupHandlesKHR)pa(device, "vkGetRayTracingCaptureReplayShaderGroupHandlesKHR");
  ...
  dt->CmdDrawMeshTasksEXT =
    (PFN_vkCmdDrawMeshTasksEXT)pa(device, "vkCmdDrawMeshTasksEXT");
