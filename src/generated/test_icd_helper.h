...
static const std::unordered_map<std::string, uint32_t> device_extension_map = {
    ...
    {VK_KHR_SHADER_CONSTANT_DATA_EXTENSION_NAME, VK_KHR_SHADER_CONSTANT_DATA_SPEC_VERSION},
    {VK_KHR_DYNAMIC_RENDERING_LOCAL_READ_EXTENSION_NAME, VK_KHR_DYNAMIC_RENDERING_LOCAL_READ_SPEC_VERSION},
    {VK_KHR_SHADER_ABORT_EXTENSION_NAME, VK_KHR_SHADER_ABORT_SPEC_VERSION},
    ...
    {VK_KHR_DEVICE_FAULT_EXTENSION_NAME, VK_KHR_DEVICE_FAULT_SPEC_VERSION},
    ...
    {VK_KHR_PIPELINE_LIBRARY_GROUP_HANDLES_EXTENSION_NAME, VK_KHR_PIPELINE_LIBRARY_GROUP_HANDLES_SPEC_VERSION},
    ...
    {VK_ARM_DATA_GRAPH_OPTICAL_FLOW_EXTENSION_NAME, VK_ARM_DATA_GRAPH_OPTICAL_FLOW_SPEC_VERSION},
    ...
    {VK_NV_PRIVATE_DATA_BASE_HANDLE_EXTENSION_NAME, VK_NV_PRIVATE_DATA_BASE_HANDLE_SPEC_VERSION},
    {VK_INTEL_DEVICE_INFO_EXTENSION_NAME, VK_INTEL_DEVICE_INFO_SPEC_VERSION},
...
static VKAPI_ATTR void VKAPI_CALL DestroyPipelineCache(VkDevice device, VkPipelineCache pipelineCache,
                                                       const VkAllocationCallbacks* pAllocator);
static VKAPI_ATTR VkResult VKAPI_CALL GetPipelineCacheData(VkDevice device, VkPipelineCache pipelineCache,
                                                           size_t* pDataSize, void* pData);
static VKAPI_ATTR VkResult VKAPI_CALL MergePipelineCaches(VkDevice device, VkPipelineCache dstCache,
...
static VKAPI_ATTR void VKAPI_CALL GetDeviceGroupPeerMemoryFeatures(VkDevice device, uint32_t heapIndex,
...
static VKAPI_ATTR VkResult VKAPI_CALL
CreateSamplerYcbcrConversion(VkDevice device, const VkSamplerYcbcrConversionCreateInfo* pCreateInfo,
                             const VkAllocationCallbacks* pAllocator, VkSamplerYcbcrConversion* pYcbcrConversion);
static VKAPI_ATTR void VKAPI_CALL DestroySamplerYcbcrConversion(VkDevice device,
...
GetDeviceMemoryOpaqueCaptureAddress(VkDevice device, const VkDeviceMemoryOpaqueCaptureAddressInfo* pInfo);
...
static VKAPI_ATTR void VKAPI_CALL GetDeviceImageSubresourceLayout(VkDevice device,
                                                                  const VkDeviceImageSubresourceInfo* pInfo,
                                                                  VkSubresourceLayout2* pLayout);
static VKAPI_ATTR void VKAPI_CALL GetImageSubresourceLayout2(VkDevice device, VkImage image,
                                                             const VkImageSubresource2* pSubresource,
                                                             VkSubresourceLayout2* pLayout);
static VKAPI_ATTR VkResult VKAPI_CALL CopyMemoryToImage(VkDevice device,
                                                        const VkCopyMemoryToImageInfo* pCopyMemoryToImageInfo);
static VKAPI_ATTR VkResult VKAPI_CALL CopyImageToMemory(VkDevice device,
                                                        const VkCopyImageToMemoryInfo* pCopyImageToMemoryInfo);
static VKAPI_ATTR VkResult VKAPI_CALL CopyImageToImage(VkDevice device,
...
static VKAPI_ATTR void VKAPI_CALL CmdPushConstants2(VkCommandBuffer commandBuffer,
...
static VKAPI_ATTR void VKAPI_CALL CmdBindIndexBuffer2(VkCommandBuffer commandBuffer, VkBuffer buffer,
                                                      VkDeviceSize offset, VkDeviceSize size, VkIndexType indexType);
static VKAPI_ATTR void VKAPI_CALL GetRenderingAreaGranularity(VkDevice device,
...
static VKAPI_ATTR VkResult VKAPI_CALL GetPhysicalDevicePresentRectanglesKHR(VkPhysicalDevice physicalDevice,
...
static VKAPI_ATTR VkResult VKAPI_CALL GetDisplayPlaneSupportedDisplaysKHR(VkPhysicalDevice physicalDevice,
...
static VKAPI_ATTR VkResult VKAPI_CALL GetDisplayPlaneCapabilitiesKHR(VkPhysicalDevice physicalDevice,
...
#ifdef VK_USE_PLATFORM_XLIB_KHR
static VKAPI_ATTR VkResult VKAPI_CALL CreateXlibSurfaceKHR(VkInstance instance,
...
#endif  // VK_USE_PLATFORM_XLIB_KHR
#ifdef VK_USE_PLATFORM_XCB_KHR
static VKAPI_ATTR VkResult VKAPI_CALL CreateXcbSurfaceKHR(VkInstance instance,
...
#endif  // VK_USE_PLATFORM_XCB_KHR
#ifdef VK_USE_PLATFORM_WAYLAND_KHR
static VKAPI_ATTR VkResult VKAPI_CALL CreateWaylandSurfaceKHR(VkInstance instance,
...
#endif  // VK_USE_PLATFORM_WAYLAND_KHR
#ifdef VK_USE_PLATFORM_ANDROID_KHR
static VKAPI_ATTR VkResult VKAPI_CALL CreateAndroidSurfaceKHR(VkInstance instance,
                                                              const VkAndroidSurfaceCreateInfoKHR* pCreateInfo,
                                                              const VkAllocationCallbacks* pAllocator,
                                                              VkSurfaceKHR* pSurface);
#endif  // VK_USE_PLATFORM_ANDROID_KHR
#ifdef VK_USE_PLATFORM_WIN32_KHR
static VKAPI_ATTR VkResult VKAPI_CALL CreateWin32SurfaceKHR(VkInstance instance,
...
static VKAPI_ATTR VkResult VKAPI_CALL CreateVideoSessionKHR(VkDevice device,
...
static VKAPI_ATTR void VKAPI_CALL GetPhysicalDeviceProperties2KHR(VkPhysicalDevice physicalDevice,
                                                                  VkPhysicalDeviceProperties2* pProperties);
static VKAPI_ATTR void VKAPI_CALL GetPhysicalDeviceFormatProperties2KHR(VkPhysicalDevice physicalDevice,
                                                                        VkFormat format,
                                                                        VkFormatProperties2* pFormatProperties);
static VKAPI_ATTR VkResult VKAPI_CALL GetPhysicalDeviceImageFormatProperties2KHR(
    ...
    VkImageFormatProperties2* pImageFormatProperties);
static VKAPI_ATTR void VKAPI_CALL
GetPhysicalDeviceQueueFamilyProperties2KHR(VkPhysicalDevice physicalDevice, uint32_t* pQueueFamilyPropertyCount,
                                           VkQueueFamilyProperties2* pQueueFamilyProperties);
...
static VKAPI_ATTR void VKAPI_CALL CmdDispatchBaseKHR(VkCommandBuffer commandBuffer, uint32_t baseGroupX,
                                                     uint32_t baseGroupY, uint32_t baseGroupZ, uint32_t groupCountX,
                                                     uint32_t groupCountY, uint32_t groupCountZ);
static VKAPI_ATTR void VKAPI_CALL TrimCommandPoolKHR(VkDevice device, VkCommandPool commandPool,
                                                     VkCommandPoolTrimFlags flags);
static VKAPI_ATTR VkResult VKAPI_CALL
...
static VKAPI_ATTR VkResult VKAPI_CALL GetMemoryFdPropertiesKHR(VkDevice device,
...
static VKAPI_ATTR VkResult VKAPI_CALL GetSemaphoreFdKHR(VkDevice device, const VkSemaphoreGetFdInfoKHR* pGetFdInfo,
                                                        int* pFd);
static VKAPI_ATTR void VKAPI_CALL CmdPushDescriptorSetKHR(VkCommandBuffer commandBuffer,
...
static VKAPI_ATTR void VKAPI_CALL
UpdateDescriptorSetWithTemplateKHR(VkDevice device, VkDescriptorSet descriptorSet,
...
static VKAPI_ATTR void VKAPI_CALL CmdBeginRenderPass2KHR(VkCommandBuffer commandBuffer,
                                                         const VkRenderPassBeginInfo* pRenderPassBegin,
                                                         const VkSubpassBeginInfo* pSubpassBeginInfo);
static VKAPI_ATTR void VKAPI_CALL CmdNextSubpass2KHR(VkCommandBuffer commandBuffer,
                                                     const VkSubpassBeginInfo* pSubpassBeginInfo,
                                                     const VkSubpassEndInfo* pSubpassEndInfo);
static VKAPI_ATTR void VKAPI_CALL CmdEndRenderPass2KHR(VkCommandBuffer commandBuffer,
                                                       const VkSubpassEndInfo* pSubpassEndInfo);
...
static VKAPI_ATTR VkResult VKAPI_CALL GetFenceWin32HandleKHR(VkDevice device,
                                                             ...
                                                             HANDLE* pHandle);
#endif  // VK_USE_PLATFORM_WIN32_KHR
static VKAPI_ATTR VkResult VKAPI_CALL ImportFenceFdKHR(VkDevice device,
...
static VKAPI_ATTR void VKAPI_CALL GetPhysicalDeviceQueueFamilyPerformanceQueryPassesKHR(
    ...
    uint32_t* pNumPasses);
static VKAPI_ATTR VkResult VKAPI_CALL AcquireProfilingLockKHR(VkDevice device,
...
static VKAPI_ATTR VkResult VKAPI_CALL GetDisplayModeProperties2KHR(VkPhysicalDevice physicalDevice,
...
static VKAPI_ATTR void VKAPI_CALL GetImageMemoryRequirements2KHR(VkDevice device,
                                                                 const VkImageMemoryRequirementsInfo2* pInfo,
                                                                 VkMemoryRequirements2* pMemoryRequirements);
static VKAPI_ATTR void VKAPI_CALL GetBufferMemoryRequirements2KHR(VkDevice device,
                                                                  const VkBufferMemoryRequirementsInfo2* pInfo,
                                                                  VkMemoryRequirements2* pMemoryRequirements);
static VKAPI_ATTR void VKAPI_CALL GetImageSparseMemoryRequirements2KHR(
    ...
    VkSparseImageMemoryRequirements2* pSparseMemoryRequirements);
static VKAPI_ATTR VkResult VKAPI_CALL
CreateSamplerYcbcrConversionKHR(VkDevice device, const VkSamplerYcbcrConversionCreateInfo* pCreateInfo,
                                const VkAllocationCallbacks* pAllocator, VkSamplerYcbcrConversion* pYcbcrConversion);
static VKAPI_ATTR void VKAPI_CALL DestroySamplerYcbcrConversionKHR(VkDevice device,
                                                                   VkSamplerYcbcrConversion ycbcrConversion,
                                                                   const VkAllocationCallbacks* pAllocator);
...
static VKAPI_ATTR void VKAPI_CALL GetDescriptorSetLayoutSupportKHR(VkDevice device,
                                                                   const VkDescriptorSetLayoutCreateInfo* pCreateInfo,
                                                                   VkDescriptorSetLayoutSupport* pSupport);
static VKAPI_ATTR void VKAPI_CALL CmdDrawIndirectCountKHR(VkCommandBuffer commandBuffer, VkBuffer buffer,
                                                          VkDeviceSize offset, VkBuffer countBuffer,
                                                          VkDeviceSize countBufferOffset, uint32_t maxDrawCount,
                                                          uint32_t stride);
static VKAPI_ATTR void VKAPI_CALL CmdDrawIndexedIndirectCountKHR(VkCommandBuffer commandBuffer, VkBuffer buffer,
                                                                 ...
                                                                 VkDeviceSize countBufferOffset, uint32_t maxDrawCount,
                                                                 uint32_t stride);
static VKAPI_ATTR VkResult VKAPI_CALL GetSemaphoreCounterValueKHR(VkDevice device, VkSemaphore semaphore,
                                                                  uint64_t* pValue);
static VKAPI_ATTR VkResult VKAPI_CALL WaitSemaphoresKHR(VkDevice device, const VkSemaphoreWaitInfo* pWaitInfo,
                                                        uint64_t timeout);
...
static VKAPI_ATTR void VKAPI_CALL CmdSetFragmentShadingRateKHR(VkCommandBuffer commandBuffer,
...
static VKAPI_ATTR VkResult VKAPI_CALL WaitForPresentKHR(VkDevice device, VkSwapchainKHR swapchain, uint64_t presentId,
                                                        uint64_t timeout);
static VKAPI_ATTR VkDeviceAddress VKAPI_CALL GetBufferDeviceAddressKHR(VkDevice device,
                                                                       const VkBufferDeviceAddressInfo* pInfo);
static VKAPI_ATTR uint64_t VKAPI_CALL GetBufferOpaqueCaptureAddressKHR(VkDevice device,
                                                                       const VkBufferDeviceAddressInfo* pInfo);
static VKAPI_ATTR uint64_t VKAPI_CALL
GetDeviceMemoryOpaqueCaptureAddressKHR(VkDevice device, const VkDeviceMemoryOpaqueCaptureAddressInfo* pInfo);
static VKAPI_ATTR VkResult VKAPI_CALL CreateDeferredOperationKHR(VkDevice device,
                                                                 const VkAllocationCallbacks* pAllocator,
                                                                 VkDeferredOperationKHR* pDeferredOperation);
static VKAPI_ATTR void VKAPI_CALL DestroyDeferredOperationKHR(VkDevice device, VkDeferredOperationKHR operation,
                                                              const VkAllocationCallbacks* pAllocator);
static VKAPI_ATTR uint32_t VKAPI_CALL GetDeferredOperationMaxConcurrencyKHR(VkDevice device,
...
static VKAPI_ATTR VkResult VKAPI_CALL
GetPipelineExecutablePropertiesKHR(VkDevice device, const VkPipelineInfoKHR* pPipelineInfo, uint32_t* pExecutableCount,
...
static VKAPI_ATTR VkResult VKAPI_CALL MapMemory2KHR(VkDevice device, const VkMemoryMapInfo* pMemoryMapInfo,
                                                    void** ppData);
...
static VKAPI_ATTR void VKAPI_CALL CmdSetEvent2KHR(VkCommandBuffer commandBuffer, VkEvent event,
                                                  const VkDependencyInfo* pDependencyInfo);
static VKAPI_ATTR void VKAPI_CALL CmdResetEvent2KHR(VkCommandBuffer commandBuffer, VkEvent event,
                                                    VkPipelineStageFlags2 stageMask);
static VKAPI_ATTR void VKAPI_CALL CmdWaitEvents2KHR(VkCommandBuffer commandBuffer, uint32_t eventCount,
                                                    const VkEvent* pEvents, const VkDependencyInfo* pDependencyInfos);
static VKAPI_ATTR void VKAPI_CALL CmdPipelineBarrier2KHR(VkCommandBuffer commandBuffer,
                                                         const VkDependencyInfo* pDependencyInfo);
...
static VKAPI_ATTR void VKAPI_CALL CmdBindIndexBuffer3KHR(VkCommandBuffer commandBuffer,
...
static VKAPI_ATTR void VKAPI_CALL CmdDrawIndirect2KHR(VkCommandBuffer commandBuffer,
                                                      const VkDrawIndirect2InfoKHR* pInfo);
static VKAPI_ATTR void VKAPI_CALL CmdDrawIndexedIndirect2KHR(VkCommandBuffer commandBuffer,
                                                             const VkDrawIndirect2InfoKHR* pInfo);
static VKAPI_ATTR void VKAPI_CALL CmdDispatchIndirect2KHR(VkCommandBuffer commandBuffer,
...
static VKAPI_ATTR void VKAPI_CALL CmdCopyImageToMemoryKHR(VkCommandBuffer commandBuffer,
                                                          const VkCopyDeviceMemoryImageInfoKHR* pCopyMemoryInfo);
static VKAPI_ATTR void VKAPI_CALL CmdUpdateMemoryKHR(VkCommandBuffer commandBuffer,
                                                     const VkDeviceAddressRangeKHR* pDstRange,
                                                     VkAddressCommandFlagsKHR dstFlags, VkDeviceSize dataSize,
                                                     const void* pData);
static VKAPI_ATTR void VKAPI_CALL CmdFillMemoryKHR(VkCommandBuffer commandBuffer,
                                                   const VkDeviceAddressRangeKHR* pDstRange,
                                                   VkAddressCommandFlagsKHR dstFlags, uint32_t data);
static VKAPI_ATTR void VKAPI_CALL CmdCopyQueryPoolResultsToMemoryKHR(VkCommandBuffer commandBuffer,
...
static VKAPI_ATTR void VKAPI_CALL
CmdBindTransformFeedbackBuffers2EXT(VkCommandBuffer commandBuffer, uint32_t firstBinding, uint32_t bindingCount,
                                    const VkBindTransformFeedbackBuffer2InfoEXT* pBindingInfos);
static VKAPI_ATTR void VKAPI_CALL
CmdBeginTransformFeedback2EXT(VkCommandBuffer commandBuffer, uint32_t firstCounterRange, uint32_t counterRangeCount,
                              const VkBindTransformFeedbackBuffer2InfoEXT* pCounterInfos);
static VKAPI_ATTR void VKAPI_CALL
CmdEndTransformFeedback2EXT(VkCommandBuffer commandBuffer, uint32_t firstCounterRange, uint32_t counterRangeCount,
                            const VkBindTransformFeedbackBuffer2InfoEXT* pCounterInfos);
static VKAPI_ATTR void VKAPI_CALL CmdDrawIndirectByteCount2EXT(
...
static VKAPI_ATTR void VKAPI_CALL CmdDrawMeshTasksIndirect2EXT(VkCommandBuffer commandBuffer,
                                                               const VkDrawIndirect2InfoKHR* pInfo);
static VKAPI_ATTR void VKAPI_CALL CmdDrawMeshTasksIndirectCount2EXT(VkCommandBuffer commandBuffer,
                                                                    const VkDrawIndirectCount2InfoKHR* pInfo);
static VKAPI_ATTR void VKAPI_CALL CmdWriteMarkerToMemoryAMD(VkCommandBuffer commandBuffer,
                                                            const VkMemoryMarkerInfoAMD* pInfo);
static VKAPI_ATTR VkResult VKAPI_CALL CreateAccelerationStructure2KHR(
...
static VKAPI_ATTR void VKAPI_CALL CmdCopyImageToBuffer2KHR(VkCommandBuffer commandBuffer,
                                                           const VkCopyImageToBufferInfo2* pCopyImageToBufferInfo);
static VKAPI_ATTR void VKAPI_CALL CmdBlitImage2KHR(VkCommandBuffer commandBuffer,
                                                   const VkBlitImageInfo2* pBlitImageInfo);
static VKAPI_ATTR void VKAPI_CALL CmdResolveImage2KHR(VkCommandBuffer commandBuffer,
                                                      const VkResolveImageInfo2* pResolveImageInfo);
...
static VKAPI_ATTR void VKAPI_CALL GetDeviceBufferMemoryRequirementsKHR(VkDevice device,
                                                                       const VkDeviceBufferMemoryRequirements* pInfo,
                                                                       VkMemoryRequirements2* pMemoryRequirements);
static VKAPI_ATTR void VKAPI_CALL GetDeviceImageMemoryRequirementsKHR(VkDevice device,
                                                                      const VkDeviceImageMemoryRequirements* pInfo,
                                                                      VkMemoryRequirements2* pMemoryRequirements);
...
static VKAPI_ATTR void VKAPI_CALL GetRenderingAreaGranularityKHR(VkDevice device,
                                                                 const VkRenderingAreaInfo* pRenderingAreaInfo,
                                                                 VkExtent2D* pGranularity);
static VKAPI_ATTR void VKAPI_CALL GetDeviceImageSubresourceLayoutKHR(VkDevice device,
                                                                     const VkDeviceImageSubresourceInfo* pInfo,
                                                                     VkSubresourceLayout2* pLayout);
...
static VKAPI_ATTR VkResult VKAPI_CALL GetDeviceFaultReportsKHR(VkDevice device, uint64_t timeout,
                                                               uint32_t* pFaultCounts,
                                                               VkDeviceFaultInfoKHR* pFaultInfo);
static VKAPI_ATTR VkResult VKAPI_CALL GetDeviceFaultDebugInfoKHR(VkDevice device,
...
static VKAPI_ATTR void VKAPI_CALL DebugReportMessageEXT(VkInstance instance, VkDebugReportFlagsEXT flags,
                                                        ...
                                                        const char* pMessage);
static VKAPI_ATTR VkResult VKAPI_CALL DebugMarkerSetObjectTagEXT(VkDevice device,
...
static VKAPI_ATTR void VKAPI_CALL CmdDrawIndirectCountAMD(VkCommandBuffer commandBuffer, VkBuffer buffer,
                                                          VkDeviceSize offset, VkBuffer countBuffer,
                                                          VkDeviceSize countBufferOffset, uint32_t maxDrawCount,
                                                          uint32_t stride);
static VKAPI_ATTR void VKAPI_CALL CmdDrawIndexedIndirectCountAMD(VkCommandBuffer commandBuffer, VkBuffer buffer,
                                                                 ...
                                                                 VkDeviceSize countBufferOffset, uint32_t maxDrawCount,
                                                                 uint32_t stride);
static VKAPI_ATTR VkResult VKAPI_CALL GetShaderInfoAMD(VkDevice device, VkPipeline pipeline,
...
#ifdef VK_USE_PLATFORM_XLIB_XRANDR_EXT
static VKAPI_ATTR VkResult VKAPI_CALL AcquireXlibDisplayEXT(VkPhysicalDevice physicalDevice, Display* dpy,
                                                            VkDisplayKHR display);
static VKAPI_ATTR VkResult VKAPI_CALL GetRandROutputDisplayEXT(VkPhysicalDevice physicalDevice, Display* dpy,
...
static VKAPI_ATTR VkResult VKAPI_CALL RegisterDeviceEventEXT(VkDevice device,
...
#ifdef VK_USE_PLATFORM_IOS_MVK
static VKAPI_ATTR VkResult VKAPI_CALL CreateIOSSurfaceMVK(VkInstance instance,
                                                          const VkIOSSurfaceCreateInfoMVK* pCreateInfo,
                                                          const VkAllocationCallbacks* pAllocator,
                                                          VkSurfaceKHR* pSurface);
#endif  // VK_USE_PLATFORM_IOS_MVK
#ifdef VK_USE_PLATFORM_MACOS_MVK
static VKAPI_ATTR VkResult VKAPI_CALL CreateMacOSSurfaceMVK(VkInstance instance,
                                                            const VkMacOSSurfaceCreateInfoMVK* pCreateInfo,
                                                            const VkAllocationCallbacks* pAllocator,
                                                            VkSurfaceKHR* pSurface);
#endif  // VK_USE_PLATFORM_MACOS_MVK
static VKAPI_ATTR VkResult VKAPI_CALL SetDebugUtilsObjectNameEXT(VkDevice device,
                                                                 const VkDebugUtilsObjectNameInfoEXT* pNameInfo);
static VKAPI_ATTR VkResult VKAPI_CALL SetDebugUtilsObjectTagEXT(VkDevice device,
...
static VKAPI_ATTR VkResult VKAPI_CALL
GetExecutionGraphPipelineNodeIndexAMDX(VkDevice device, VkPipeline executionGraph,
...
static VKAPI_ATTR VkResult VKAPI_CALL WriteResourceDescriptorsEXT(VkDevice device, uint32_t resourceCount,
                                                                  ...
                                                                  const VkHostAddressRangeEXT* pDescriptors);
static VKAPI_ATTR void VKAPI_CALL CmdBindSamplerHeapEXT(VkCommandBuffer commandBuffer,
                                                        const VkBindHeapInfoEXT* pBindInfo);
static VKAPI_ATTR void VKAPI_CALL CmdBindResourceHeapEXT(VkCommandBuffer commandBuffer,
                                                         const VkBindHeapInfoEXT* pBindInfo);
static VKAPI_ATTR void VKAPI_CALL CmdPushDataEXT(VkCommandBuffer commandBuffer, const VkPushDataInfoEXT* pPushDataInfo);
static VKAPI_ATTR VkResult VKAPI_CALL GetImageOpaqueCaptureDataEXT(VkDevice device, uint32_t imageCount,
...
static VKAPI_ATTR VkResult VKAPI_CALL
RegisterCustomBorderColorEXT(VkDevice device, const VkSamplerCustomBorderColorCreateInfoEXT* pBorderColor,
...
static VKAPI_ATTR VkResult VKAPI_CALL CreateValidationCacheEXT(VkDevice device,
...
static VKAPI_ATTR void VKAPI_CALL DestroyAccelerationStructureNV(VkDevice device,
...
static VKAPI_ATTR VkResult VKAPI_CALL CreateRayTracingPipelinesNV(VkDevice device, VkPipelineCache pipelineCache,
                                                                  ...
                                                                  const VkAllocationCallbacks* pAllocator,
                                                                  VkPipeline* pPipelines);
static VKAPI_ATTR VkResult VKAPI_CALL GetRayTracingShaderGroupHandlesKHR(VkDevice device, VkPipeline pipeline,
                                                                         uint32_t firstGroup, uint32_t groupCount,
                                                                         size_t dataSize, void* pData);
static VKAPI_ATTR VkResult VKAPI_CALL GetRayTracingShaderGroupHandlesNV(VkDevice device, VkPipeline pipeline,
                                                                        uint32_t firstGroup, uint32_t groupCount,
                                                                        size_t dataSize, void* pData);
...
static VKAPI_ATTR VkResult VKAPI_CALL
ReleasePerformanceConfigurationINTEL(VkDevice device, VkPerformanceConfigurationINTEL configuration);
static VKAPI_ATTR VkResult VKAPI_CALL
QueueSetPerformanceConfigurationINTEL(VkQueue queue, VkPerformanceConfigurationINTEL configuration);
static VKAPI_ATTR VkResult VKAPI_CALL GetPerformanceParameterINTEL(VkDevice device,
                                                                   VkPerformanceParameterTypeINTEL parameter,
                                                                   VkPerformanceValueINTEL* pValue);
static VKAPI_ATTR void VKAPI_CALL SetLocalDimmingAMD(VkDevice device, VkSwapchainKHR swapChain,
...
#endif  // VK_USE_PLATFORM_FUCHSIA
#ifdef VK_USE_PLATFORM_METAL_EXT
static VKAPI_ATTR VkResult VKAPI_CALL CreateMetalSurfaceEXT(VkInstance instance,
...
static VKAPI_ATTR void VKAPI_CALL CmdSetPrimitiveTopologyEXT(VkCommandBuffer commandBuffer,
                                                             VkPrimitiveTopology primitiveTopology);
...
static VKAPI_ATTR void VKAPI_CALL CmdSetDepthBoundsTestEnableEXT(VkCommandBuffer commandBuffer,
                                                                 VkBool32 depthBoundsTestEnable);
static VKAPI_ATTR void VKAPI_CALL CmdSetStencilTestEnableEXT(VkCommandBuffer commandBuffer, VkBool32 stencilTestEnable);
static VKAPI_ATTR void VKAPI_CALL CmdSetStencilOpEXT(VkCommandBuffer commandBuffer, VkStencilFaceFlags faceMask,
                                                     VkStencilOp failOp, VkStencilOp passOp, VkStencilOp depthFailOp,
                                                     VkCompareOp compareOp);
...
static VKAPI_ATTR VkResult VKAPI_CALL CopyImageToMemoryEXT(VkDevice device,
                                                           const VkCopyImageToMemoryInfo* pCopyImageToMemoryInfo);
static VKAPI_ATTR VkResult VKAPI_CALL CopyImageToImageEXT(VkDevice device,
                                                          const VkCopyImageToImageInfo* pCopyImageToImageInfo);
...
static VKAPI_ATTR VkResult VKAPI_CALL ReleaseSwapchainImagesEXT(VkDevice device,
                                                                const VkReleaseSwapchainImagesInfoKHR* pReleaseInfo);
static VKAPI_ATTR void VKAPI_CALL
GetGeneratedCommandsMemoryRequirementsNV(VkDevice device, const VkGeneratedCommandsMemoryRequirementsInfoNV* pInfo,
                                         VkMemoryRequirements2* pMemoryRequirements);
...
static VKAPI_ATTR VkResult VKAPI_CALL AcquireDrmDisplayEXT(VkPhysicalDevice physicalDevice, int32_t drmFd,
                                                           VkDisplayKHR display);
static VKAPI_ATTR VkResult VKAPI_CALL GetDrmDisplayEXT(VkPhysicalDevice physicalDevice, int32_t drmFd,
                                                       uint32_t connectorId, VkDisplayKHR* display);
static VKAPI_ATTR VkResult VKAPI_CALL CreatePrivateDataSlotEXT(VkDevice device,
                                                               const VkPrivateDataSlotCreateInfo* pCreateInfo,
                                                               const VkAllocationCallbacks* pAllocator,
                                                               VkPrivateDataSlot* pPrivateDataSlot);
...
static VKAPI_ATTR VkResult VKAPI_CALL GetCudaModuleCacheNV(VkDevice device, VkCudaModuleNV module, size_t* pCacheSize,
                                                           void* pCacheData);
static VKAPI_ATTR VkResult VKAPI_CALL CreateCudaFunctionNV(VkDevice device,
...
static VKAPI_ATTR void VKAPI_CALL SetLatencySleepModeLegacyNV(VkDevice device, VkBool32 lowLatencyMode,
                                                              VkBool32 lowLatencyBoost, uint32_t minimumIntervalUs);
...
static VKAPI_ATTR void VKAPI_CALL GetDescriptorEXT(VkDevice device, const VkDescriptorGetInfoEXT* pDescriptorInfo,
...
static VKAPI_ATTR VkResult VKAPI_CALL
GetImageOpaqueCaptureDescriptorDataEXT(VkDevice device, const VkImageCaptureDescriptorDataInfoEXT* pInfo, void* pData);
...
static VKAPI_ATTR VkResult VKAPI_CALL
CreateBufferCollectionFUCHSIA(VkDevice device, const VkBufferCollectionCreateInfoFUCHSIA* pCreateInfo,
...
#endif  // VK_USE_PLATFORM_FUCHSIA
static VKAPI_ATTR VkResult VKAPI_CALL GetDeviceSubpassShadingMaxWorkgroupSizeHUAWEI(VkDevice device,
...
static VKAPI_ATTR void VKAPI_CALL CmdSetPrimitiveRestartEnableEXT(VkCommandBuffer commandBuffer,
                                                                  VkBool32 primitiveRestartEnable);
#ifdef VK_USE_PLATFORM_SCREEN_QNX
static VKAPI_ATTR VkResult VKAPI_CALL CreateScreenSurfaceQNX(VkInstance instance,
...
static VKAPI_ATTR void VKAPI_CALL GetMicromapBuildSizesEXT(VkDevice device,
...
static VKAPI_ATTR void VKAPI_CALL GetDescriptorSetHostMappingVALVE(VkDevice device, VkDescriptorSet descriptorSet,
                                                                   void** ppData);
...
#ifdef VK_USE_PLATFORM_OHOS
static VKAPI_ATTR VkResult VKAPI_CALL GetNativeBufferPropertiesOHOS(VkDevice device,
                                                                    const struct OH_NativeBuffer* buffer,
                                                                    VkNativeBufferPropertiesOHOS* pProperties);
static VKAPI_ATTR VkResult VKAPI_CALL GetMemoryNativeBufferOHOS(VkDevice device,
...
static VKAPI_ATTR void VKAPI_CALL DestroyTensorARM(VkDevice device, VkTensorARM tensor,
                                                   const VkAllocationCallbacks* pAllocator);
...
static VKAPI_ATTR void VKAPI_CALL DestroyTensorViewARM(VkDevice device, VkTensorViewARM tensorView,
                                                       const VkAllocationCallbacks* pAllocator);
static VKAPI_ATTR void VKAPI_CALL GetTensorMemoryRequirementsARM(VkDevice device,
...
static VKAPI_ATTR void VKAPI_CALL GetDeviceTensorMemoryRequirementsARM(VkDevice device,
                                                                       ...
                                                                       VkMemoryRequirements2* pMemoryRequirements);
static VKAPI_ATTR void VKAPI_CALL CmdCopyTensorARM(VkCommandBuffer commandBuffer,
...
static VKAPI_ATTR VkResult VKAPI_CALL GetPhysicalDeviceOpticalFlowImageFormatsNV(
    ...
    uint32_t* pFormatCount, VkOpticalFlowImageFormatPropertiesNV* pImageFormatProperties);
...
static VKAPI_ATTR void VKAPI_CALL DestroyShaderEXT(VkDevice device, VkShaderEXT shader,
                                                   const VkAllocationCallbacks* pAllocator);
static VKAPI_ATTR VkResult VKAPI_CALL GetShaderBinaryDataEXT(VkDevice device, VkShaderEXT shader, size_t* pDataSize,
                                                             void* pData);
...
static VKAPI_ATTR VkResult VKAPI_CALL GetDynamicRenderingTilePropertiesQCOM(VkDevice device,
                                                                            const VkRenderingInfo* pRenderingInfo,
                                                                            VkTilePropertiesQCOM* pProperties);
...
static VKAPI_ATTR VkResult VKAPI_CALL
ConvertCooperativeVectorMatrixNV(VkDevice device, const VkConvertCooperativeVectorMatrixInfoNV* pInfo);
...
static VKAPI_ATTR void VKAPI_CALL QueueNotifyOutOfBandNV(VkQueue queue,
                                                         const VkOutOfBandQueueTypeInfoNV* pQueueTypeInfo);
static VKAPI_ATTR VkResult VKAPI_CALL
CreateDataGraphPipelinesARM(VkDevice device, VkDeferredOperationKHR deferredOperation, VkPipelineCache pipelineCache,
                            uint32_t createInfoCount, const VkDataGraphPipelineCreateInfoARM* pCreateInfos,
                            const VkAllocationCallbacks* pAllocator, VkPipeline* pPipelines);
static VKAPI_ATTR VkResult VKAPI_CALL
CreateDataGraphPipelineSessionARM(VkDevice device, const VkDataGraphPipelineSessionCreateInfoARM* pCreateInfo,
...
static VKAPI_ATTR VkResult VKAPI_CALL GetDataGraphPipelineSessionBindPointRequirementsARM(
    ...
    uint32_t* pBindPointRequirementCount, VkDataGraphPipelineSessionBindPointRequirementARM* pBindPointRequirements);
...
static VKAPI_ATTR void VKAPI_CALL DestroyDataGraphPipelineSessionARM(VkDevice device,
                                                                     VkDataGraphPipelineSessionARM session,
                                                                     const VkAllocationCallbacks* pAllocator);
static VKAPI_ATTR void VKAPI_CALL CmdDispatchDataGraphARM(VkCommandBuffer commandBuffer,
                                                          VkDataGraphPipelineSessionARM session,
                                                          const VkDataGraphPipelineDispatchInfoARM* pInfo);
static VKAPI_ATTR VkResult VKAPI_CALL
GetDataGraphPipelineAvailablePropertiesARM(VkDevice device, const VkDataGraphPipelineInfoARM* pPipelineInfo,
                                           uint32_t* pPropertiesCount, VkDataGraphPipelinePropertyARM* pProperties);
static VKAPI_ATTR VkResult VKAPI_CALL
GetDataGraphPipelinePropertiesARM(VkDevice device, const VkDataGraphPipelineInfoARM* pPipelineInfo,
...
static VKAPI_ATTR VkResult VKAPI_CALL
CreateExternalComputeQueueNV(VkDevice device, const VkExternalComputeQueueCreateInfoNV* pCreateInfo,
...
static VKAPI_ATTR void VKAPI_CALL GetExternalComputeQueueDataNV(VkExternalComputeQueueNV externalQueue,
                                                                ...
                                                                void* pData);
static VKAPI_ATTR void VKAPI_CALL
GetClusterAccelerationStructureBuildSizesNV(VkDevice device, const VkClusterAccelerationStructureInputInfoNV* pInfo,
...
static VKAPI_ATTR VkResult VKAPI_CALL EnumeratePhysicalDeviceQueueFamilyPerformanceCountersByRegionARM(
    VkPhysicalDevice physicalDevice, uint32_t queueFamilyIndex, uint32_t* pCounterCount,
    VkPerformanceCounterARM* pCounters, VkPerformanceCounterDescriptionARM* pCounterDescriptions);
static VKAPI_ATTR VkResult VKAPI_CALL
EnumeratePhysicalDeviceShaderInstrumentationMetricsARM(VkPhysicalDevice physicalDevice, uint32_t* pDescriptionCount,
                                                       VkShaderInstrumentationMetricDescriptionARM* pDescriptions);
static VKAPI_ATTR VkResult VKAPI_CALL
CreateShaderInstrumentationARM(VkDevice device, const VkShaderInstrumentationCreateInfoARM* pCreateInfo,
                               const VkAllocationCallbacks* pAllocator, VkShaderInstrumentationARM* pInstrumentation);
static VKAPI_ATTR void VKAPI_CALL DestroyShaderInstrumentationARM(VkDevice device,
...
static VKAPI_ATTR VkResult VKAPI_CALL GetShaderInstrumentationValuesARM(VkDevice device,
                                                                        VkShaderInstrumentationARM instrumentation,
...
#endif  // VK_USE_PLATFORM_UBM_SEC
static VKAPI_ATTR void VKAPI_CALL CmdSetPrimitiveRestartIndexEXT(VkCommandBuffer commandBuffer,
...
static VKAPI_ATTR VkResult VKAPI_CALL CreateAccelerationStructureKHR(
    ...
    VkAccelerationStructureKHR* pAccelerationStructure);
static VKAPI_ATTR void VKAPI_CALL DestroyAccelerationStructureKHR(VkDevice device,
...
BuildAccelerationStructuresKHR(VkDevice device, VkDeferredOperationKHR deferredOperation, uint32_t infoCount,
                               ...
                               const VkAccelerationStructureBuildRangeInfoKHR* const* ppBuildRangeInfos);
static VKAPI_ATTR VkResult VKAPI_CALL CopyAccelerationStructureKHR(VkDevice device,
...
static const std::unordered_map<std::string, void*> name_to_func_ptr_map = {
    ...
    {"vkGetDataGraphPipelineSessionBindPointRequirementsARM",
     (void*)GetDataGraphPipelineSessionBindPointRequirementsARM},
    ...
    {"vkEnumeratePhysicalDeviceShaderInstrumentationMetricsARM",
     (void*)EnumeratePhysicalDeviceShaderInstrumentationMetricsARM},
...
static VKAPI_ATTR void VKAPI_CALL DestroyEvent(VkDevice device, VkEvent event,
                                               const VkAllocationCallbacks* pAllocator) {}
...
static VKAPI_ATTR VkResult VKAPI_CALL MapMemory2(VkDevice device, const VkMemoryMapInfo* pMemoryMapInfo,
                                                 void** ppData) {
    return VK_SUCCESS;
}
...
static VKAPI_ATTR void VKAPI_CALL CmdPushDescriptorSet(VkCommandBuffer commandBuffer,
                                                       ...
                                                       const VkWriteDescriptorSet* pDescriptorWrites) {
    auto* cb = reinterpret_cast<CommandBuffer*>(commandBuffer);
    cb->Tracker().CmdPushDescriptorSet(commandBuffer, pipelineBindPoint, layout, set, descriptorWriteCount,
                                       pDescriptorWrites);
}
...
static VKAPI_ATTR void VKAPI_CALL CmdPushDescriptorSetWithTemplate(VkCommandBuffer commandBuffer,
                                                                   ...
                                                                   const void* pData) {
    auto* cb = reinterpret_cast<CommandBuffer*>(commandBuffer);
    cb->Tracker().CmdPushDescriptorSetWithTemplate(commandBuffer, descriptorUpdateTemplate, layout, set, pData);
}

static VKAPI_ATTR void VKAPI_CALL CmdBindDescriptorSets2(VkCommandBuffer commandBuffer,
                                                         const VkBindDescriptorSetsInfo* pBindDescriptorSetsInfo) {
    auto* cb = reinterpret_cast<CommandBuffer*>(commandBuffer);
    cb->Tracker().CmdBindDescriptorSets2(commandBuffer, pBindDescriptorSetsInfo);
}

static VKAPI_ATTR void VKAPI_CALL CmdPushConstants2(VkCommandBuffer commandBuffer,
                                                    const VkPushConstantsInfo* pPushConstantsInfo) {
    auto* cb = reinterpret_cast<CommandBuffer*>(commandBuffer);
    cb->Tracker().CmdPushConstants2(commandBuffer, pPushConstantsInfo);
}

static VKAPI_ATTR void VKAPI_CALL CmdPushDescriptorSet2(VkCommandBuffer commandBuffer,
                                                        const VkPushDescriptorSetInfo* pPushDescriptorSetInfo) {
    auto* cb = reinterpret_cast<CommandBuffer*>(commandBuffer);
    cb->Tracker().CmdPushDescriptorSet2(commandBuffer, pPushDescriptorSetInfo);
}

static VKAPI_ATTR void VKAPI_CALL CmdPushDescriptorSetWithTemplate2(
    VkCommandBuffer commandBuffer, const VkPushDescriptorSetWithTemplateInfo* pPushDescriptorSetWithTemplateInfo) {
    auto* cb = reinterpret_cast<CommandBuffer*>(commandBuffer);
    cb->Tracker().CmdPushDescriptorSetWithTemplate2(commandBuffer, pPushDescriptorSetWithTemplateInfo);
}

static VKAPI_ATTR void VKAPI_CALL CmdSetLineStipple(VkCommandBuffer commandBuffer, uint32_t lineStippleFactor,
                                                    uint16_t lineStipplePattern) {
    auto* cb = reinterpret_cast<CommandBuffer*>(commandBuffer);
    cb->Tracker().CmdSetLineStipple(commandBuffer, lineStippleFactor, lineStipplePattern);
}

static VKAPI_ATTR void VKAPI_CALL CmdBindIndexBuffer2(VkCommandBuffer commandBuffer, VkBuffer buffer,
                                                      VkDeviceSize offset, VkDeviceSize size, VkIndexType indexType) {
    auto* cb = reinterpret_cast<CommandBuffer*>(commandBuffer);
    cb->Tracker().CmdBindIndexBuffer2(commandBuffer, buffer, offset, size, indexType);
}
...
static VKAPI_ATTR void VKAPI_CALL CmdSetRenderingAttachmentLocations(
    VkCommandBuffer commandBuffer, const VkRenderingAttachmentLocationInfo* pLocationInfo) {
    auto* cb = reinterpret_cast<CommandBuffer*>(commandBuffer);
    cb->Tracker().CmdSetRenderingAttachmentLocations(commandBuffer, pLocationInfo);
}

static VKAPI_ATTR void VKAPI_CALL CmdSetRenderingInputAttachmentIndices(
    VkCommandBuffer commandBuffer, const VkRenderingInputAttachmentIndexInfo* pInputAttachmentIndexInfo) {
    auto* cb = reinterpret_cast<CommandBuffer*>(commandBuffer);
    cb->Tracker().CmdSetRenderingInputAttachmentIndices(commandBuffer, pInputAttachmentIndexInfo);
}
...
static VKAPI_ATTR void VKAPI_CALL CmdBindIndexBuffer3KHR(VkCommandBuffer commandBuffer,
                                                         const VkBindIndexBuffer3InfoKHR* pInfo) {
    auto* cb = reinterpret_cast<CommandBuffer*>(commandBuffer);
    cb->Tracker().CmdBindIndexBuffer3KHR(commandBuffer, pInfo);
}
...
static VKAPI_ATTR void VKAPI_CALL CmdBindVertexBuffers3KHR(VkCommandBuffer commandBuffer, uint32_t firstBinding,
                                                           ...
                                                           const VkBindVertexBuffer3InfoKHR* pBindingInfos) {
    auto* cb = reinterpret_cast<CommandBuffer*>(commandBuffer);
    cb->Tracker().CmdBindVertexBuffers3KHR(commandBuffer, firstBinding, bindingCount, pBindingInfos);
}

static VKAPI_ATTR void VKAPI_CALL CmdDrawIndirect2KHR(VkCommandBuffer commandBuffer,
                                                      const VkDrawIndirect2InfoKHR* pInfo) {
    auto* cb = reinterpret_cast<CommandBuffer*>(commandBuffer);
    cb->Tracker().CmdDrawIndirect2KHR(commandBuffer, pInfo);
}

static VKAPI_ATTR void VKAPI_CALL CmdDrawIndexedIndirect2KHR(VkCommandBuffer commandBuffer,
                                                             const VkDrawIndirect2InfoKHR* pInfo) {
    auto* cb = reinterpret_cast<CommandBuffer*>(commandBuffer);
    cb->Tracker().CmdDrawIndexedIndirect2KHR(commandBuffer, pInfo);
}

static VKAPI_ATTR void VKAPI_CALL CmdDispatchIndirect2KHR(VkCommandBuffer commandBuffer,
                                                          const VkDispatchIndirect2InfoKHR* pInfo) {
    auto* cb = reinterpret_cast<CommandBuffer*>(commandBuffer);
    cb->Tracker().CmdDispatchIndirect2KHR(commandBuffer, pInfo);
}

static VKAPI_ATTR void VKAPI_CALL CmdCopyMemoryKHR(VkCommandBuffer commandBuffer,
                                                   const VkCopyDeviceMemoryInfoKHR* pCopyMemoryInfo) {
    auto* cb = reinterpret_cast<CommandBuffer*>(commandBuffer);
    cb->Tracker().CmdCopyMemoryKHR(commandBuffer, pCopyMemoryInfo);
}

static VKAPI_ATTR void VKAPI_CALL CmdCopyMemoryToImageKHR(VkCommandBuffer commandBuffer,
                                                          const VkCopyDeviceMemoryImageInfoKHR* pCopyMemoryInfo) {
    auto* cb = reinterpret_cast<CommandBuffer*>(commandBuffer);
    cb->Tracker().CmdCopyMemoryToImageKHR(commandBuffer, pCopyMemoryInfo);
}

static VKAPI_ATTR void VKAPI_CALL CmdCopyImageToMemoryKHR(VkCommandBuffer commandBuffer,
                                                          const VkCopyDeviceMemoryImageInfoKHR* pCopyMemoryInfo) {
    auto* cb = reinterpret_cast<CommandBuffer*>(commandBuffer);
    cb->Tracker().CmdCopyImageToMemoryKHR(commandBuffer, pCopyMemoryInfo);
}
...
static VKAPI_ATTR void VKAPI_CALL CmdUpdateMemoryKHR(VkCommandBuffer commandBuffer,
                                                     ...
                                                     const void* pData) {
    auto* cb = reinterpret_cast<CommandBuffer*>(commandBuffer);
    cb->Tracker().CmdUpdateMemoryKHR(commandBuffer, pDstRange, dstFlags, dataSize, pData);
}
...
static VKAPI_ATTR void VKAPI_CALL CmdFillMemoryKHR(VkCommandBuffer commandBuffer,
                                                   ...
                                                   VkAddressCommandFlagsKHR dstFlags, uint32_t data) {
    auto* cb = reinterpret_cast<CommandBuffer*>(commandBuffer);
    cb->Tracker().CmdFillMemoryKHR(commandBuffer, pDstRange, dstFlags, data);
}
...
static VKAPI_ATTR void VKAPI_CALL CmdCopyQueryPoolResultsToMemoryKHR(VkCommandBuffer commandBuffer,
                                                                     ...
                                                                     VkQueryResultFlags queryResultFlags) {
    auto* cb = reinterpret_cast<CommandBuffer*>(commandBuffer);
    cb->Tracker().CmdCopyQueryPoolResultsToMemoryKHR(commandBuffer, queryPool, firstQuery, queryCount, pDstRange,
...
static VKAPI_ATTR void VKAPI_CALL CmdDrawIndirectCount2KHR(VkCommandBuffer commandBuffer,
                                                           const VkDrawIndirectCount2InfoKHR* pInfo) {
    auto* cb = reinterpret_cast<CommandBuffer*>(commandBuffer);
    cb->Tracker().CmdDrawIndirectCount2KHR(commandBuffer, pInfo);
}

static VKAPI_ATTR void VKAPI_CALL CmdDrawIndexedIndirectCount2KHR(VkCommandBuffer commandBuffer,
                                                                  const VkDrawIndirectCount2InfoKHR* pInfo) {
    auto* cb = reinterpret_cast<CommandBuffer*>(commandBuffer);
    cb->Tracker().CmdDrawIndexedIndirectCount2KHR(commandBuffer, pInfo);
}

static VKAPI_ATTR void VKAPI_CALL CmdBeginConditionalRendering2EXT(
    VkCommandBuffer commandBuffer, const VkConditionalRenderingBeginInfo2EXT* pConditionalRenderingBegin) {
    auto* cb = reinterpret_cast<CommandBuffer*>(commandBuffer);
    cb->Tracker().CmdBeginConditionalRendering2EXT(commandBuffer, pConditionalRenderingBegin);
}
...
CmdBindTransformFeedbackBuffers2EXT(VkCommandBuffer commandBuffer, uint32_t firstBinding, uint32_t bindingCount,
                                    const VkBindTransformFeedbackBuffer2InfoEXT* pBindingInfos) {
    auto* cb = reinterpret_cast<CommandBuffer*>(commandBuffer);
    cb->Tracker().CmdBindTransformFeedbackBuffers2EXT(commandBuffer, firstBinding, bindingCount, pBindingInfos);
}
...
CmdBeginTransformFeedback2EXT(VkCommandBuffer commandBuffer, uint32_t firstCounterRange, uint32_t counterRangeCount,
                              const VkBindTransformFeedbackBuffer2InfoEXT* pCounterInfos) {
    auto* cb = reinterpret_cast<CommandBuffer*>(commandBuffer);
    cb->Tracker().CmdBeginTransformFeedback2EXT(commandBuffer, firstCounterRange, counterRangeCount, pCounterInfos);
}
...
CmdEndTransformFeedback2EXT(VkCommandBuffer commandBuffer, uint32_t firstCounterRange, uint32_t counterRangeCount,
                            const VkBindTransformFeedbackBuffer2InfoEXT* pCounterInfos) {
    auto* cb = reinterpret_cast<CommandBuffer*>(commandBuffer);
    cb->Tracker().CmdEndTransformFeedback2EXT(commandBuffer, firstCounterRange, counterRangeCount, pCounterInfos);
}
...
static VKAPI_ATTR void VKAPI_CALL CmdDrawIndirectByteCount2EXT(
    ...
    const VkBindTransformFeedbackBuffer2InfoEXT* pCounterInfo, uint32_t counterOffset, uint32_t vertexStride) {
    auto* cb = reinterpret_cast<CommandBuffer*>(commandBuffer);
    cb->Tracker().CmdDrawIndirectByteCount2EXT(commandBuffer, instanceCount, firstInstance, pCounterInfo, counterOffset,
                                               vertexStride);
}
...
static VKAPI_ATTR void VKAPI_CALL CmdDrawMeshTasksIndirect2EXT(VkCommandBuffer commandBuffer,
                                                               const VkDrawIndirect2InfoKHR* pInfo) {
    auto* cb = reinterpret_cast<CommandBuffer*>(commandBuffer);
    cb->Tracker().CmdDrawMeshTasksIndirect2EXT(commandBuffer, pInfo);
}

static VKAPI_ATTR void VKAPI_CALL CmdDrawMeshTasksIndirectCount2EXT(VkCommandBuffer commandBuffer,
                                                                    const VkDrawIndirectCount2InfoKHR* pInfo) {
    auto* cb = reinterpret_cast<CommandBuffer*>(commandBuffer);
    cb->Tracker().CmdDrawMeshTasksIndirectCount2EXT(commandBuffer, pInfo);
}

static VKAPI_ATTR void VKAPI_CALL CmdWriteMarkerToMemoryAMD(VkCommandBuffer commandBuffer,
                                                            const VkMemoryMarkerInfoAMD* pInfo) {
    auto* cb = reinterpret_cast<CommandBuffer*>(commandBuffer);
    cb->Tracker().CmdWriteMarkerToMemoryAMD(commandBuffer, pInfo);
}
...
static VKAPI_ATTR void VKAPI_CALL CmdEndRendering2KHR(VkCommandBuffer commandBuffer,
                                                      const VkRenderingEndInfoKHR* pRenderingEndInfo) {
    auto* cb = reinterpret_cast<CommandBuffer*>(commandBuffer);
    cb->Tracker().CmdEndRendering2KHR(commandBuffer, pRenderingEndInfo);
}
...
static VKAPI_ATTR void VKAPI_CALL CmdEndDebugUtilsLabelEXT(VkCommandBuffer commandBuffer) {
    auto* cb = reinterpret_cast<CommandBuffer*>(commandBuffer);
    cb->Tracker().CmdEndDebugUtilsLabelEXT(commandBuffer);
}

static VKAPI_ATTR void VKAPI_CALL CmdInsertDebugUtilsLabelEXT(VkCommandBuffer commandBuffer,
                                                              const VkDebugUtilsLabelEXT* pLabelInfo) {
    auto* cb = reinterpret_cast<CommandBuffer*>(commandBuffer);
    cb->Tracker().CmdInsertDebugUtilsLabelEXT(commandBuffer, pLabelInfo);
}
...
static VKAPI_ATTR void VKAPI_CALL CmdInitializeGraphScratchMemoryAMDX(VkCommandBuffer commandBuffer,
                                                                      ...
                                                                      VkDeviceSize scratchSize) {
    auto* cb = reinterpret_cast<CommandBuffer*>(commandBuffer);
    cb->Tracker().CmdInitializeGraphScratchMemoryAMDX(commandBuffer, executionGraph, scratch, scratchSize);
}
...
static VKAPI_ATTR void VKAPI_CALL CmdDispatchGraphAMDX(VkCommandBuffer commandBuffer, VkDeviceAddress scratch,
                                                       ...
                                                       const VkDispatchGraphCountInfoAMDX* pCountInfo) {
    auto* cb = reinterpret_cast<CommandBuffer*>(commandBuffer);
    cb->Tracker().CmdDispatchGraphAMDX(commandBuffer, scratch, scratchSize, pCountInfo);
}
...
static VKAPI_ATTR void VKAPI_CALL CmdDispatchGraphIndirectAMDX(VkCommandBuffer commandBuffer, VkDeviceAddress scratch,
                                                               ...
                                                               const VkDispatchGraphCountInfoAMDX* pCountInfo) {
    auto* cb = reinterpret_cast<CommandBuffer*>(commandBuffer);
    cb->Tracker().CmdDispatchGraphIndirectAMDX(commandBuffer, scratch, scratchSize, pCountInfo);
}
...
static VKAPI_ATTR void VKAPI_CALL CmdDispatchGraphIndirectCountAMDX(VkCommandBuffer commandBuffer,
                                                                    ...
                                                                    VkDeviceAddress countInfo) {
    auto* cb = reinterpret_cast<CommandBuffer*>(commandBuffer);
    cb->Tracker().CmdDispatchGraphIndirectCountAMDX(commandBuffer, scratch, scratchSize, countInfo);
}
...
static VKAPI_ATTR void VKAPI_CALL CmdBindSamplerHeapEXT(VkCommandBuffer commandBuffer,
                                                        const VkBindHeapInfoEXT* pBindInfo) {
    auto* cb = reinterpret_cast<CommandBuffer*>(commandBuffer);
    cb->Tracker().CmdBindSamplerHeapEXT(commandBuffer, pBindInfo);
}

static VKAPI_ATTR void VKAPI_CALL CmdBindResourceHeapEXT(VkCommandBuffer commandBuffer,
                                                         const VkBindHeapInfoEXT* pBindInfo) {
    auto* cb = reinterpret_cast<CommandBuffer*>(commandBuffer);
    cb->Tracker().CmdBindResourceHeapEXT(commandBuffer, pBindInfo);
}

static VKAPI_ATTR void VKAPI_CALL CmdPushDataEXT(VkCommandBuffer commandBuffer,
                                                 const VkPushDataInfoEXT* pPushDataInfo) {
    auto* cb = reinterpret_cast<CommandBuffer*>(commandBuffer);
    cb->Tracker().CmdPushDataEXT(commandBuffer, pPushDataInfo);
}
...
static VKAPI_ATTR void VKAPI_CALL CmdSetStencilTestEnableEXT(VkCommandBuffer commandBuffer,
...
static VKAPI_ATTR void VKAPI_CALL CmdDispatchTileQCOM(VkCommandBuffer commandBuffer,
                                                      const VkDispatchTileInfoQCOM* pDispatchTileInfo) {
    auto* cb = reinterpret_cast<CommandBuffer*>(commandBuffer);
    cb->Tracker().CmdDispatchTileQCOM(commandBuffer, pDispatchTileInfo);
}

static VKAPI_ATTR void VKAPI_CALL CmdBeginPerTileExecutionQCOM(VkCommandBuffer commandBuffer,
                                                               const VkPerTileBeginInfoQCOM* pPerTileBeginInfo) {
    auto* cb = reinterpret_cast<CommandBuffer*>(commandBuffer);
    cb->Tracker().CmdBeginPerTileExecutionQCOM(commandBuffer, pPerTileBeginInfo);
}

static VKAPI_ATTR void VKAPI_CALL CmdEndPerTileExecutionQCOM(VkCommandBuffer commandBuffer,
                                                             const VkPerTileEndInfoQCOM* pPerTileEndInfo) {
    auto* cb = reinterpret_cast<CommandBuffer*>(commandBuffer);
    cb->Tracker().CmdEndPerTileExecutionQCOM(commandBuffer, pPerTileEndInfo);
}
...
static VKAPI_ATTR void VKAPI_CALL CmdSetDispatchParametersARM(VkCommandBuffer commandBuffer,
                                                              const VkDispatchParametersARM* pDispatchParameters) {
    auto* cb = reinterpret_cast<CommandBuffer*>(commandBuffer);
    cb->Tracker().CmdSetDispatchParametersARM(commandBuffer, pDispatchParameters);
}
...
static VKAPI_ATTR void VKAPI_CALL CmdCopyTensorARM(VkCommandBuffer commandBuffer,
                                                   const VkCopyTensorInfoARM* pCopyTensorInfo) {
    auto* cb = reinterpret_cast<CommandBuffer*>(commandBuffer);
    cb->Tracker().CmdCopyTensorARM(commandBuffer, pCopyTensorInfo);
}
...
static VKAPI_ATTR void VKAPI_CALL CmdConvertCooperativeVectorMatrixNV(
    VkCommandBuffer commandBuffer, uint32_t infoCount, const VkConvertCooperativeVectorMatrixInfoNV* pInfos) {
    auto* cb = reinterpret_cast<CommandBuffer*>(commandBuffer);
    cb->Tracker().CmdConvertCooperativeVectorMatrixNV(commandBuffer, infoCount, pInfos);
}
...
static VKAPI_ATTR void VKAPI_CALL CmdDispatchDataGraphARM(VkCommandBuffer commandBuffer,
                                                          ...
                                                          const VkDataGraphPipelineDispatchInfoARM* pInfo) {
    auto* cb = reinterpret_cast<CommandBuffer*>(commandBuffer);
    cb->Tracker().CmdDispatchDataGraphARM(commandBuffer, session, pInfo);
}
...
static VKAPI_ATTR void VKAPI_CALL CmdBindTileMemoryQCOM(VkCommandBuffer commandBuffer,
                                                        const VkTileMemoryBindInfoQCOM* pTileMemoryBindInfo) {
    auto* cb = reinterpret_cast<CommandBuffer*>(commandBuffer);
    cb->Tracker().CmdBindTileMemoryQCOM(commandBuffer, pTileMemoryBindInfo);
}

static VKAPI_ATTR void VKAPI_CALL CmdDecompressMemoryEXT(VkCommandBuffer commandBuffer,
                                                         const VkDecompressMemoryInfoEXT* pDecompressMemoryInfoEXT) {
    auto* cb = reinterpret_cast<CommandBuffer*>(commandBuffer);
    cb->Tracker().CmdDecompressMemoryEXT(commandBuffer, pDecompressMemoryInfoEXT);
}
...
static VKAPI_ATTR void VKAPI_CALL CmdDecompressMemoryIndirectCountEXT(
    ...
    uint32_t maxDecompressionCount, uint32_t stride) {
    auto* cb = reinterpret_cast<CommandBuffer*>(commandBuffer);
    cb->Tracker().CmdDecompressMemoryIndirectCountEXT(commandBuffer, decompressionMethod, indirectCommandsAddress,
...
static VKAPI_ATTR void VKAPI_CALL CmdBuildClusterAccelerationStructureIndirectNV(
    VkCommandBuffer commandBuffer, const VkClusterAccelerationStructureCommandsInfoNV* pCommandInfos) {
    auto* cb = reinterpret_cast<CommandBuffer*>(commandBuffer);
    cb->Tracker().CmdBuildClusterAccelerationStructureIndirectNV(commandBuffer, pCommandInfos);
}
...
static VKAPI_ATTR void VKAPI_CALL CmdBuildPartitionedAccelerationStructuresNV(
    VkCommandBuffer commandBuffer, const VkBuildPartitionedAccelerationStructureInfoNV* pBuildInfo) {
    auto* cb = reinterpret_cast<CommandBuffer*>(commandBuffer);
    cb->Tracker().CmdBuildPartitionedAccelerationStructuresNV(commandBuffer, pBuildInfo);
}
...
static VKAPI_ATTR void VKAPI_CALL CmdBeginShaderInstrumentationARM(VkCommandBuffer commandBuffer,
                                                                   VkShaderInstrumentationARM instrumentation) {
    auto* cb = reinterpret_cast<CommandBuffer*>(commandBuffer);
    cb->Tracker().CmdBeginShaderInstrumentationARM(commandBuffer, instrumentation);
}

static VKAPI_ATTR void VKAPI_CALL CmdEndShaderInstrumentationARM(VkCommandBuffer commandBuffer) {
    auto* cb = reinterpret_cast<CommandBuffer*>(commandBuffer);
    cb->Tracker().CmdEndShaderInstrumentationARM(commandBuffer);
}
...
static VKAPI_ATTR void VKAPI_CALL CmdBeginCustomResolveEXT(VkCommandBuffer commandBuffer,
                                                           const VkBeginCustomResolveInfoEXT* pBeginCustomResolveInfo) {
    auto* cb = reinterpret_cast<CommandBuffer*>(commandBuffer);
    cb->Tracker().CmdBeginCustomResolveEXT(commandBuffer, pBeginCustomResolveInfo);
}
...
static VKAPI_ATTR void VKAPI_CALL CmdSetPrimitiveRestartIndexEXT(VkCommandBuffer commandBuffer,
                                                                 uint32_t primitiveRestartIndex) {
    auto* cb = reinterpret_cast<CommandBuffer*>(commandBuffer);
    cb->Tracker().CmdSetPrimitiveRestartIndexEXT(commandBuffer, primitiveRestartIndex);
}
