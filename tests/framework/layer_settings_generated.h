...
static const char* VL_CRASH_DIAGNOSTIC_DUMP_SEMAPHORES_OFF = "off";
static const char* VL_CRASH_DIAGNOSTIC_DUMP_SEMAPHORES_ON_CRASH = "on_crash";
...
static const char* VL_CRASH_DIAGNOSTIC_DEBUG_ACTION_VK_DBG_LAYER_ACTION_LOG_MSG = "VK_DBG_LAYER_ACTION_LOG_MSG";
static const char* VL_CRASH_DIAGNOSTIC_DEBUG_ACTION_VK_DBG_LAYER_ACTION_LOG_STDOUT = "VK_DBG_LAYER_ACTION_LOG_STDOUT";
static const char* VL_CRASH_DIAGNOSTIC_DEBUG_ACTION_VK_DBG_LAYER_ACTION_LOG_STDERR = "VK_DBG_LAYER_ACTION_LOG_STDERR";
static const char* VL_CRASH_DIAGNOSTIC_DEBUG_ACTION_VK_DBG_LAYER_ACTION_DEBUG_OUTPUT = "VK_DBG_LAYER_ACTION_DEBUG_OUTPUT";
static const char* VL_CRASH_DIAGNOSTIC_DEBUG_ACTION_VK_DBG_LAYER_ACTION_BREAK = "VK_DBG_LAYER_ACTION_BREAK";
...
static const char* VL_CRASH_DIAGNOSTIC_MESSAGE_API_TRACE_COMMON = "common";
static const char* VL_CRASH_DIAGNOSTIC_MESSAGE_API_TRACE_SEMAPHORES = "semaphores";
...
struct LayerSettings {
	...
	std::vector<vk::LayerSettingEXT> info() {
		...
		std::vector<vk::LayerSettingEXT> init{
			...
			{"VK_LAYER_LUNARG_crash_diagnostic", "watchdog_timeout_ms", vk::LayerSettingTypeEXT::eUint32, 1, &this->crash_diagnostic.watchdog_timeout_ms},
