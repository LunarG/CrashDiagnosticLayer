...
TEST_F(GpuCrash, InvalidIndex) { InitInstance();
    InitDevice();

    vk::raii::ShaderModule shader_module = CreateShaderModuleGLSL(kInvalidIndexComp, vk::ShaderStageFlagBits::eCompute);
